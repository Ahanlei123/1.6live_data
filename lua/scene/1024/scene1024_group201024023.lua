...
-- 装置
gadgets = {
	{ config_id = 23001, gadget_id = 70211031, pos = { x = 131.096, y = -92.292, z = -201.133 }, rot = { x = 0.000, y = 269.366, z = 0.000 }, level = 11, drop_tag = "战斗超级蒙德", isOneoff = true, persistent = true }
}
