...
-- 装置
gadgets = {
	{ config_id = 8001, gadget_id = 70350053, pos = { x = 0.038, y = 0.131, z = -0.021 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8002, gadget_id = 70350054, pos = { x = 0.086, y = 0.116, z = 0.001 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
