...
-- 怪物
monsters = {
	{ config_id = 16003, monster_id = 21020101, pos = { x = 77.236, y = 40.070, z = -22.299 }, rot = { x = 0.000, y = 238.164, z = 0.000 }, level = 1 },
	{ config_id = 16012, monster_id = 21020101, pos = { x = 76.856, y = 40.000, z = -35.316 }, rot = { x = 0.000, y = 311.869, z = 0.000 }, level = 1 },
	{ config_id = 16014, monster_id = 22010101, pos = { x = 69.200, y = 40.000, z = -27.862 }, rot = { x = 0.000, y = 111.583, z = 0.000 }, level = 1 }
}
...
-- 装置
gadgets = {
	{ config_id = 16006, gadget_id = 70360001, pos = { x = 76.278, y = 41.019, z = -28.210 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 16015, shape = RegionShape.CUBIC, size = { x = 50.000, y = 40.000, z = 45.000 }, pos = { x = 64.000, y = 40.000, z = -32.200 } }
}
...
function action_EVENT_CHALLENGE_FAIL_16010(context, evt)
	...
	-- 改变指定group组243005001中， configid为1003的gadget的state
