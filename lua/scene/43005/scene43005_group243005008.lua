...
-- 怪物
monsters = {
	{ config_id = 8004, monster_id = 25010701, pos = { x = 106.701, y = 40.065, z = -2.673 }, rot = { x = 0.000, y = 264.698, z = 0.000 }, level = 1 },
	{ config_id = 8005, monster_id = 22010301, pos = { x = 101.860, y = 40.039, z = 3.055 }, rot = { x = 0.000, y = 216.339, z = 0.000 }, level = 1 },
	{ config_id = 8006, monster_id = 25010301, pos = { x = 100.894, y = 40.000, z = -11.361 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8007, monster_id = 25010301, pos = { x = 101.860, y = 40.049, z = 5.764 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8009, monster_id = 25010501, pos = { x = 90.673, y = 40.000, z = -10.321 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8010, monster_id = 25010501, pos = { x = 90.792, y = 40.049, z = 4.826 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8020, monster_id = 20011101, pos = { x = 94.458, y = 39.997, z = -4.664 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8021, monster_id = 25070101, pos = { x = 89.662, y = 40.000, z = -2.821 }, rot = { x = 0.000, y = 89.811, z = 0.000 }, level = 1 }
}
...
-- 装置
gadgets = {
	{ config_id = 8019, gadget_id = 70900205, pos = { x = 107.274, y = 38.035, z = -3.061 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 8011, shape = RegionShape.CUBIC, size = { x = 50.000, y = 40.000, z = 45.000 }, pos = { x = 93.800, y = 40.000, z = -4.600 } },
	{ config_id = 8016, shape = RegionShape.CUBIC, size = { x = 50.000, y = 40.000, z = 45.000 }, pos = { x = 93.800, y = 40.000, z = -4.600 } }
}
...
suites = {
	...
	},
	{
		-- suite_id = 3,
		-- description = ,
		monsters = { 8004, 8006, 8007, 8009, 8010, 8021 },
		gadgets = { },
		regions = { 8016 },
...
function action_EVENT_CHALLENGE_SUCCESS_8013(context, evt)
	-- 改变指定group组243005008中， configid为5000的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 243005008, 5000, GadgetState.GearStart) then
