...
-- 装置
gadgets = {
	{ config_id = 7001, gadget_id = 70360157, pos = { x = 99.739, y = 40.011, z = -2.265 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7002, gadget_id = 70360156, pos = { x = -3.932, y = 40.001, z = -80.584 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7003, gadget_id = 70360158, pos = { x = -36.328, y = 40.000, z = -28.346 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7004, gadget_id = 70360156, pos = { x = 74.600, y = 40.000, z = -71.300 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7005, gadget_id = 70360158, pos = { x = 99.739, y = 40.011, z = -2.265 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7006, gadget_id = 70360157, pos = { x = -3.932, y = 40.001, z = -80.584 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7007, gadget_id = 70360155, pos = { x = -36.328, y = 40.000, z = -28.346 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7008, gadget_id = 70360156, pos = { x = 74.600, y = 40.000, z = -71.300 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7009, gadget_id = 70360156, pos = { x = 99.739, y = 40.011, z = -2.265 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7010, gadget_id = 70360157, pos = { x = -3.932, y = 40.001, z = -80.584 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7011, gadget_id = 70360156, pos = { x = -36.328, y = 40.000, z = -28.346 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7012, gadget_id = 70360158, pos = { x = 74.600, y = 40.000, z = -71.300 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7013, gadget_id = 70360158, pos = { x = 99.739, y = 40.011, z = -2.265 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7014, gadget_id = 70360157, pos = { x = -3.932, y = 40.001, z = -80.584 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7015, gadget_id = 70360155, pos = { x = -36.328, y = 40.000, z = -28.346 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7016, gadget_id = 70360156, pos = { x = 74.600, y = 40.000, z = -71.300 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
-- 变量
variables = {
	{ name = "f1", value = 0, no_refresh = false },
	{ name = "f2", value = 0, no_refresh = false },
	{ name = "f3", value = 0, no_refresh = false },
	{ name = "f4", value = 0, no_refresh = false }
}
...
function action_EVENT_SELECT_OPTION_7021(context, evt)
	...
	-- 删除指定group： 243005001 ；指定config：1003；物件身上指定option：7；
...
function action_EVENT_ENTER_REGION_7053(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "Gflag", 3, defs.group_c1) then
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "Gflag", 5, defs.group_c4) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	    return -1
	end
...
function action_EVENT_ENTER_REGION_7054(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "Gflag", 1, defs.group_c3) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	    return -1
	end
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "Gflag", 2, defs.group_c4) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	    return -1
	end
...
function action_EVENT_ENTER_REGION_7055(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "Gflag", 5, defs.group_c3) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	    return -1
	end
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "Gflag", 4, defs.group_c4) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	    return -1
	end
	  ScriptLib.PrintContextLog(context, "切到了suite3!!!!!!!!")
