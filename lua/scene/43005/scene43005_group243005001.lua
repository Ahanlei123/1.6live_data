...
-- 怪物
monsters = {
	{ config_id = 1004, monster_id = 23010201, pos = { x = 12.612, y = 40.000, z = 1.809 }, rot = { x = 0.000, y = 120.769, z = 0.000 }, level = 1 },
	{ config_id = 1005, monster_id = 23010201, pos = { x = 14.127, y = 39.999, z = -7.570 }, rot = { x = 0.000, y = 21.465, z = 0.000 }, level = 1 },
	{ config_id = 1008, monster_id = 23010401, pos = { x = 21.551, y = 40.017, z = -7.121 }, rot = { x = 0.000, y = 346.531, z = 0.000 }, level = 1 }
}
...
-- 装置
gadgets = {
	{ config_id = 1003, gadget_id = 70360001, pos = { x = 18.463, y = 41.016, z = -2.752 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 1015, shape = RegionShape.CUBIC, size = { x = 70.000, y = 40.000, z = 60.000 }, pos = { x = 17.700, y = 40.000, z = -5.500 } }
}
