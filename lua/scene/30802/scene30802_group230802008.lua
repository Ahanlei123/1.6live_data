...
-- 装置
gadgets = {
	{ config_id = 8001, gadget_id = 70350053, pos = { x = 0.043, y = 0.028, z = -0.031 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8002, gadget_id = 70350054, pos = { x = 0.091, y = 0.013, z = -0.009 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
