...
-- DEFS_MISCS
trap_group={242001013}

tide_group_defs ={
        [1] = {group = 242001003, delay = 30, next_group = 2, buff = {1,2,3},guide_routes={1,2},enter={1001,1003},exit={1004},enter_id={7,8},exit_id={9}},
        [2] = {group = 242001004, delay = 30, next_group = 3, buff = {1,2,3},guide_routes={1,2},enter={1001,1003},exit={1004},enter_id={7,8},exit_id={9}},
        [3] = {group = 242001005, delay = 30, next_group = 4, buff = {1,2,3},guide_routes={1,2},enter={1001,1003},exit={1004},enter_id={7,8},exit_id={9}},
        [4] = {group = 242001006, delay = 30, next_group = 5, buff = {1,2,3},guide_routes={1,2},enter={1001,1003},exit={1004},enter_id={7,8},exit_id={9}},
        [5] = {group = 242001007, delay = 30, next_group = 0, buff = {1,2,3},guide_routes={1,2},enter={1001,1003},exit={1004},enter_id={7,8},exit_id={9}},
...
gadgets = {
	...
	[1002] = { config_id = 1002, gadget_id = 70690001, pos = { x = 14.651, y = 5.361, z = -32.674 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	...
	[1041] = { config_id = 1041, gadget_id = 70690001, pos = { x = 23.253, y = 5.364, z = -32.674 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	[1042] = { config_id = 1042, gadget_id = 70690001, pos = { x = 33.006, y = 5.354, z = -32.674 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 1002, 1005, 1041, 1042, 1043, 1044, 1045, 1046, 1047, 1048, 1049, 1050, 1051, 1052 },
		regions = { },
		triggers = { },
		rand_weight = 100
	}
