...
-- 装置
gadgets = {
	{ config_id = 377001, gadget_id = 71700106, pos = { x = 1613.942, y = 249.612, z = -1607.784 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 15 }
}
...
-- 触发器
triggers = {
	{ name = "QUEST_FINISH_377002", event = EventType.EVENT_QUEST_FINISH, source = "101104", condition = "condition_EVENT_QUEST_FINISH_377002", action = "action_EVENT_QUEST_FINISH_377002", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_377003", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_377003", action = "action_EVENT_GADGET_STATE_CHANGE_377003", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_377005", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_377005", action = "action_EVENT_GADGET_STATE_CHANGE_377005", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_377007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_377007", action = "action_EVENT_GADGET_STATE_CHANGE_377007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_377008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_377008", action = "action_EVENT_GADGET_STATE_CHANGE_377008", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_377009", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_377009", action = "action_EVENT_GADGET_STATE_CHANGE_377009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_377010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_377010", action = "action_EVENT_GADGET_STATE_CHANGE_377010", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_377011", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_377011", action = "action_EVENT_GADGET_STATE_CHANGE_377011", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_377012", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_377012", action = "action_EVENT_GADGET_STATE_CHANGE_377012", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_377013", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_377013", action = "action_EVENT_GADGET_STATE_CHANGE_377013", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_377014", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_377014", action = "action_EVENT_GADGET_STATE_CHANGE_377014", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_377015", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_377015", action = "action_EVENT_GADGET_STATE_CHANGE_377015", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_377016", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_377016", action = "action_EVENT_GADGET_STATE_CHANGE_377016", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_377017", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_377017", action = "action_EVENT_GADGET_STATE_CHANGE_377017", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_377018", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_377018", action = "action_EVENT_GADGET_STATE_CHANGE_377018", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_377019", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_377019", action = "action_EVENT_GADGET_STATE_CHANGE_377019", trigger_count = 0 }
}
