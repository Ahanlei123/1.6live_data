...
-- 变量
variables = {
	{ name = "active_count", value = 0, no_refresh = true },
	{ name = "monster_killed", value = 0, no_refresh = true }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "GADGET_CREATE_647014", "VARIABLE_CHANGE_647015", "GADGET_CREATE_647016", "GADGET_CREATE_647017", "SELECT_OPTION_647018", "GADGET_CREATE_647019", "SELECT_OPTION_647020", "ANY_GADGET_DIE_647022", "SELECT_OPTION_647023", "ANY_GADGET_DIE_647025", "SELECT_OPTION_647026", "VARIABLE_CHANGE_647027" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
