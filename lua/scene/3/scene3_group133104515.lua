...
-- 装置
gadgets = {
	{ config_id = 515004, gadget_id = 70210102, pos = { x = 188.776, y = 245.927, z = 86.985 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 16, drop_tag = "搜刮点解谜通用璃月", area_id = 9 },
	{ config_id = 515005, gadget_id = 70210102, pos = { x = 180.570, y = 245.927, z = 79.401 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 16, drop_tag = "搜刮点解谜通用璃月", area_id = 9 }
}
