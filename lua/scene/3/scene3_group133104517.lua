...
-- 装置
gadgets = {
	{ config_id = 517001, gadget_id = 70360006, pos = { x = 757.589, y = 218.195, z = 857.902 }, rot = { x = 358.865, y = 201.824, z = 355.213 }, level = 19, area_id = 6 },
	{ config_id = 517002, gadget_id = 70211101, pos = { x = 762.023, y = 220.073, z = 859.372 }, rot = { x = 5.126, y = 228.909, z = 349.786 }, level = 16, drop_tag = "解谜低级璃月", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 6 }
}
...
-- 触发器
triggers = {
	{ config_id = 1517003, name = "GADGET_STATE_CHANGE_517003", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_517003", action = "action_EVENT_GADGET_STATE_CHANGE_517003" },
	...
	{ config_id = 1517005, name = "GADGET_STATE_CHANGE_517005", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_517005", action = "action_EVENT_GADGET_STATE_CHANGE_517005", trigger_count = 0 },
	{ config_id = 1517006, name = "GADGET_CREATE_517006", event = EventType.EVENT_GADGET_CREATE, source = "111", condition = "condition_EVENT_GADGET_CREATE_517006", action = "action_EVENT_GADGET_CREATE_517006", trigger_count = 0 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_517005(context, evt)
	-- 将configid为 517002 的物件更改为状态 GadgetState.Action01
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 517002, GadgetState.Action01) then
