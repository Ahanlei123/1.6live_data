...
-- 装置
gadgets = {
	{ config_id = 187001, gadget_id = 70710006, pos = { x = 2680.538, y = 238.252, z = 46.079 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 23, area_id = 4 },
	{ config_id = 187002, gadget_id = 70710010, pos = { x = 2702.482, y = 241.875, z = 20.607 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 23, route_id = 300700127, area_id = 4 },
	{ config_id = 187003, gadget_id = 70710007, pos = { x = 2682.087, y = 238.595, z = 43.515 }, rot = { x = 0.000, y = 140.765, z = 0.000 }, level = 23, area_id = 4 },
	{ config_id = 187004, gadget_id = 70211111, pos = { x = 2682.089, y = 238.420, z = 47.087 }, rot = { x = 0.000, y = 156.836, z = 0.000 }, level = 21, drop_tag = "解谜中级蒙德", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 4 }
}

-- 区域
regions = {
	{ config_id = 187007, shape = RegionShape.SPHERE, radius = 2, pos = { x = 2702.500, y = 242.200, z = 20.600 }, area_id = 4 }
}
