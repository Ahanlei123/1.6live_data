...
-- 怪物
monsters = {
	{ config_id = 827, monster_id = 20010101, pos = { x = 1505.666, y = 209.417, z = -1936.667 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 6 }
}
...
-- 装置
gadgets = {
	{ config_id = 2347, gadget_id = 70220013, pos = { x = 1802.573, y = 203.393, z = -1270.931 }, rot = { x = 0.000, y = 109.118, z = 0.000 }, level = 5 },
	{ config_id = 2348, gadget_id = 70710002, pos = { x = 1803.956, y = 203.377, z = -1272.273 }, rot = { x = 0.000, y = 167.458, z = 0.000 }, level = 5, route_id = 3001176, persistent = true },
	{ config_id = 2349, gadget_id = 70220014, pos = { x = 1961.282, y = 196.825, z = -1163.815 }, rot = { x = 0.000, y = 109.118, z = 0.000 }, level = 5 },
	{ config_id = 2350, gadget_id = 70710002, pos = { x = 1961.593, y = 196.825, z = -1164.492 }, rot = { x = 0.000, y = 167.458, z = 0.000 }, level = 5, route_id = 3001179, persistent = true },
	{ config_id = 2351, gadget_id = 70220014, pos = { x = 2000.814, y = 205.363, z = -1364.405 }, rot = { x = 0.000, y = 109.118, z = 0.000 }, level = 5 },
	{ config_id = 2352, gadget_id = 70710002, pos = { x = 2000.952, y = 205.407, z = -1365.308 }, rot = { x = 0.000, y = 167.458, z = 0.000 }, level = 5, route_id = 3001182, persistent = true }
}

-- 区域
regions = {
	{ config_id = 209, shape = RegionShape.SPHERE, radius = 22.4, pos = { x = 1900.522, y = 205.418, z = -1265.291 } }
}
