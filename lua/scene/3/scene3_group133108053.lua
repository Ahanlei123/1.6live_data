...
-- 装置
gadgets = {
	{ config_id = 53001, gadget_id = 70710006, pos = { x = -387.920, y = 221.540, z = -705.713 }, rot = { x = 0.000, y = 31.288, z = 0.000 }, level = 32, persistent = true, area_id = 7 },
	{ config_id = 53002, gadget_id = 70710010, pos = { x = -366.831, y = 203.724, z = -724.541 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, route_id = 310800018, area_id = 7 },
	{ config_id = 53003, gadget_id = 70710007, pos = { x = -387.604, y = 221.649, z = -705.771 }, rot = { x = 0.000, y = 130.327, z = 0.000 }, level = 32, area_id = 7 },
	{ config_id = 53004, gadget_id = 70211111, pos = { x = -386.546, y = 221.539, z = -707.612 }, rot = { x = 0.000, y = 31.288, z = 0.000 }, level = 26, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 7 }
}

-- 区域
regions = {
	{ config_id = 53007, shape = RegionShape.SPHERE, radius = 4, pos = { x = -366.747, y = 203.355, z = -724.503 }, area_id = 7 }
}
