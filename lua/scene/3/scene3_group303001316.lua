...
-- 怪物
monsters = {
	{ config_id = 1376, monster_id = 20010301, pos = { x = 1929.654, y = 197.061, z = -1259.287 }, rot = { x = 0.000, y = 138.746, z = 0.000 }, level = 10, drop_id = 1000100 },
	{ config_id = 1377, monster_id = 20010301, pos = { x = 1930.417, y = 197.027, z = -1273.390 }, rot = { x = 0.000, y = 358.863, z = 0.000 }, level = 10, drop_id = 1000100 },
	{ config_id = 1378, monster_id = 20010301, pos = { x = 1922.497, y = 196.294, z = -1267.934 }, rot = { x = 0.000, y = 59.368, z = 0.000 }, level = 10, drop_id = 1000100 },
	{ config_id = 1379, monster_id = 20010401, pos = { x = 1922.504, y = 196.770, z = -1260.998 }, rot = { x = 347.411, y = 136.026, z = 337.843 }, level = 10, drop_id = 1000100, affix = { 1007, 1018 } }
}
...
-- 装置
gadgets = {
	{ config_id = 3366, gadget_id = 70210112, pos = { x = 1928.951, y = 197.638, z = -1265.911 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 316001, shape = RegionShape.SPHERE, radius = 26.36, pos = { x = 1928.926, y = 196.877, z = -1266.333 } }
}
