...
monsters = {
	...
	{ config_id = 53010, monster_id = 24010101, pos = { x = 432.500, y = 197.600, z = 258.500 }, rot = { x = 0.000, y = 121.474, z = 0.000 }, level = 15, drop_id = 1000100, pose_id = 100, area_id = 9 },
	{ config_id = 53012, monster_id = 24010101, pos = { x = 420.300, y = 197.300, z = 222.900 }, rot = { x = 0.000, y = 73.209, z = 0.000 }, level = 15, drop_id = 1000100, pose_id = 100, area_id = 9 }
}
...
gadgets = {
	...
	{ config_id = 53019, gadget_id = 70310007, pos = { x = 432.467, y = 197.581, z = 258.503 }, rot = { x = 0.000, y = 121.474, z = 0.000 }, level = 19, persistent = true, area_id = 9 },
	{ config_id = 53020, gadget_id = 70310007, pos = { x = 420.344, y = 197.267, z = 222.939 }, rot = { x = 0.000, y = 73.209, z = 0.000 }, level = 19, persistent = true, area_id = 9 },
	{ config_id = 53021, gadget_id = 70310007, pos = { x = 455.149, y = 196.800, z = 225.072 }, rot = { x = 0.000, y = 323.280, z = 0.000 }, level = 19, persistent = true, area_id = 9 }
}
...
variables = {
	...
	{ name = "Region_Fire", value = 0, no_refresh = true },
	{ name = "Region_Wind", value = 0, no_refresh = true },
	{ name = "Region_Water", value = 0, no_refresh = true },
	{ name = "Region_Thunder", value = 0, no_refresh = true },
	{ name = "Region_Center", value = 0, no_refresh = true },
	{ name = "TurnOffTrigger", value = 99, no_refresh = true },
	{ name = "Temp_GadgetID", value = 0, no_refresh = true },
	{ name = "Unlock_Water", value = 0, no_refresh = true },
	{ name = "AnyGurdianDie", value = 0, no_refresh = true }
}
