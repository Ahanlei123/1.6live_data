...
-- 装置
gadgets = {
	{ config_id = 29001, gadget_id = 70360008, pos = { x = -108.526, y = 204.567, z = -618.572 }, rot = { x = 0.000, y = 268.800, z = 0.000 }, level = 32, area_id = 7 },
	{ config_id = 29002, gadget_id = 70360011, pos = { x = -131.330, y = 200.724, z = -612.562 }, rot = { x = 0.000, y = 302.600, z = 0.000 }, level = 32, mark_flag = 2, area_id = 7 },
	{ config_id = 29003, gadget_id = 70360011, pos = { x = -115.592, y = 209.585, z = -619.408 }, rot = { x = 0.000, y = 240.700, z = 0.000 }, level = 32, mark_flag = 4, area_id = 7 },
	{ config_id = 29004, gadget_id = 70360011, pos = { x = -116.426, y = 215.481, z = -627.330 }, rot = { x = 0.000, y = 136.900, z = 0.000 }, level = 32, mark_flag = 8, area_id = 7 },
	{ config_id = 29005, gadget_id = 70360014, pos = { x = -131.330, y = 200.724, z = -612.562 }, rot = { x = 0.000, y = 187.800, z = 0.000 }, level = 32, route_id = 310800005, area_id = 7 },
	{ config_id = 29006, gadget_id = 70360014, pos = { x = -115.592, y = 209.585, z = -619.308 }, rot = { x = 0.000, y = 287.700, z = 0.000 }, level = 32, route_id = 310800006, area_id = 7 },
	{ config_id = 29007, gadget_id = 70360014, pos = { x = -116.426, y = 215.481, z = -627.330 }, rot = { x = 0.000, y = 299.100, z = 0.000 }, level = 32, route_id = 310800007, area_id = 7 },
	{ config_id = 29008, gadget_id = 70211111, pos = { x = -107.075, y = 204.410, z = -619.752 }, rot = { x = 4.135, y = 359.642, z = 350.115 }, level = 26, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 7 }
}
...
-- 触发器
triggers = {
	{ config_id = 1029009, name = "GADGET_STATE_CHANGE_29009", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "", action = "action_EVENT_GADGET_STATE_CHANGE_29009", trigger_count = 0 },
	...
	{ config_id = 1029011, name = "VARIABLE_CHANGE_29011", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_29011", action = "action_EVENT_VARIABLE_CHANGE_29011" },
	{ config_id = 1029012, name = "GADGET_STATE_CHANGE_29012", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_29012", action = "action_EVENT_GADGET_STATE_CHANGE_29012", trigger_count = 0 },
	{ config_id = 1029013, name = "GADGET_CREATE_29013", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_29013", action = "action_EVENT_GADGET_CREATE_29013", trigger_count = 0 },
	...
	{ config_id = 1029015, name = "GROUP_REFRESH_29015", event = EventType.EVENT_GROUP_REFRESH, source = "", condition = "", action = "action_EVENT_GROUP_REFRESH_29015" },
	{ config_id = 1029016, name = "ANY_GADGET_DIE_29016", event = EventType.EVENT_ANY_GADGET_DIE, source = "", condition = "", action = "action_EVENT_ANY_GADGET_DIE_29016", trigger_count = 0 },
	{ config_id = 1029017, name = "GADGET_CREATE_29017", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_29017", action = "action_EVENT_GADGET_CREATE_29017", trigger_count = 0 }
}
