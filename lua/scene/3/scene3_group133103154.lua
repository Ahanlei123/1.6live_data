...
-- 装置
gadgets = {
	{ config_id = 154001, gadget_id = 70710006, pos = { x = 874.838, y = 230.924, z = 1695.214 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 24, persistent = true, area_id = 6 },
	{ config_id = 154002, gadget_id = 70710010, pos = { x = 930.946, y = 250.761, z = 1636.609 }, rot = { x = 0.000, y = 305.827, z = 0.000 }, level = 24, route_id = 310300039, area_id = 6 },
	{ config_id = 154003, gadget_id = 70710007, pos = { x = 875.028, y = 231.401, z = 1696.334 }, rot = { x = 0.000, y = 119.683, z = 0.000 }, level = 24, area_id = 6 },
	{ config_id = 154004, gadget_id = 70211111, pos = { x = 873.637, y = 230.980, z = 1694.704 }, rot = { x = 3.563, y = 339.530, z = 356.767 }, level = 21, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 6 }
}

-- 区域
regions = {
	{ config_id = 154007, shape = RegionShape.SPHERE, radius = 2, pos = { x = 931.586, y = 250.932, z = 1637.032 }, area_id = 6 }
}
