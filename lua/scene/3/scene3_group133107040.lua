...
-- 怪物
monsters = {
	{ config_id = 40001, monster_id = 24010201, pos = { x = -475.380, y = 418.454, z = 595.475 }, rot = { x = 0.000, y = 280.103, z = 0.000 }, level = 24, drop_tag = "遗迹守卫", disableWander = true, pose_id = 101, area_id = 7 }
}
...
-- 装置
gadgets = {
	{ config_id = 40002, gadget_id = 70211012, pos = { x = -468.700, y = 418.385, z = 595.497 }, rot = { x = 0.000, y = 278.324, z = 0.000 }, level = 21, drop_tag = "战斗中级璃月", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 7 }
}
