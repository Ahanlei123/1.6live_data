...
-- 装置
gadgets = {
	{ config_id = 110002, gadget_id = 70211012, pos = { x = -903.330, y = 180.021, z = 1014.273 }, rot = { x = 12.160, y = 119.149, z = 1.719 }, level = 26, drop_tag = "战斗中级璃月", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 8 }
}
