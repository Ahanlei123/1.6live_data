...
-- 触发器
triggers = {
	{ config_id = 1000198, name = "QUEST_FINISH_198", event = EventType.EVENT_QUEST_FINISH, source = "46204", condition = "condition_EVENT_QUEST_FINISH_198", action = "action_EVENT_QUEST_FINISH_198" }
}
