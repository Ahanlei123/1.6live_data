...
-- 装置
gadgets = {
	{ config_id = 436001, gadget_id = 70211101, pos = { x = 198.607, y = 204.329, z = 843.547 }, rot = { x = 8.455, y = 238.643, z = 10.309 }, level = 16, drop_tag = "解谜低级璃月", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 9 },
