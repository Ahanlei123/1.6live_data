...
-- 区域
regions = {
	{ config_id = 559002, shape = RegionShape.SPHERE, radius = 150, pos = { x = 1016.600, y = 545.600, z = -854.100 }, area_id = 10, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE },
	{ config_id = 559003, shape = RegionShape.SPHERE, radius = 150, pos = { x = 1016.600, y = 545.600, z = -854.100 }, area_id = 10, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE }
}
