...
-- 怪物
monsters = {
	{ config_id = 310001, monster_id = 20010901, pos = { x = 676.354, y = 205.744, z = 614.740 }, rot = { x = 354.014, y = 359.129, z = 16.536 }, level = 19, drop_tag = "史莱姆" }
}
...
-- 装置
gadgets = {
	{ config_id = 310002, gadget_id = 70510013, pos = { x = 676.354, y = 205.744, z = 614.740 }, rot = { x = 5.915, y = 320.662, z = 16.561 }, level = 32, isOneoff = true, persistent = true },
	{ config_id = 310003, gadget_id = 70211101, pos = { x = 676.176, y = 206.000, z = 617.898 }, rot = { x = 353.222, y = 358.754, z = 15.745 }, level = 19, drop_tag = "解谜低级璃月", showcutscene = true, isOneoff = true, persistent = true }
}
