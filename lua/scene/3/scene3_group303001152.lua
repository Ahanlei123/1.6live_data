...
-- 怪物
monsters = {
	{ config_id = 779, monster_id = 20011001, pos = { x = 1839.939, y = 226.298, z = -1103.226 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 3 },
	{ config_id = 780, monster_id = 20011001, pos = { x = 1840.267, y = 226.527, z = -1107.635 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 3 },
	{ config_id = 781, monster_id = 20011001, pos = { x = 1836.412, y = 226.635, z = -1101.103 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 3 },
	{ config_id = 1076, monster_id = 20011101, pos = { x = 1834.778, y = 225.752, z = -1099.379 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 3 }
}
...
-- 区域
regions = {
	{ config_id = 190, shape = RegionShape.SPHERE, radius = 27.7, pos = { x = 1999.754, y = 197.271, z = -1281.554 } },
	{ config_id = 191, shape = RegionShape.SPHERE, radius = 18.4, pos = { x = 2004.913, y = 199.856, z = -1214.684 } },
	{ config_id = 262, shape = RegionShape.SPHERE, radius = 46.3, pos = { x = 1925.659, y = 197.189, z = -1391.112 } },
	{ config_id = 324, shape = RegionShape.SPHERE, radius = 23.1, pos = { x = 1954.803, y = 193.661, z = -1220.576 } }
}
