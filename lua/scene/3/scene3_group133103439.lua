...
-- 怪物
monsters = {
	{ config_id = 439001, monster_id = 20011201, pos = { x = 190.470, y = 215.518, z = 1127.829 }, rot = { x = 0.000, y = 145.990, z = 0.000 }, level = 24, drop_tag = "史莱姆", area_id = 6 },
	{ config_id = 439002, monster_id = 20011301, pos = { x = 193.812, y = 216.050, z = 1124.634 }, rot = { x = 0.000, y = 285.822, z = 0.000 }, level = 24, drop_tag = "大史莱姆", area_id = 6 },
	{ config_id = 439003, monster_id = 20011201, pos = { x = 189.098, y = 215.657, z = 1123.894 }, rot = { x = 0.000, y = 56.393, z = 0.000 }, level = 24, drop_tag = "史莱姆", area_id = 6 }
}
...
-- 区域
regions = {
	{ config_id = 439004, shape = RegionShape.SPHERE, radius = 5, pos = { x = 190.830, y = 216.368, z = 1125.376 }, area_id = 6 }
}
