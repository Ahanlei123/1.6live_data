...
-- 装置
gadgets = {
	{ config_id = 154001, gadget_id = 70360008, pos = { x = 1563.406, y = 224.403, z = 1200.896 }, rot = { x = 0.000, y = 268.800, z = 0.000 }, level = 19, area_id = 5 },
	{ config_id = 154002, gadget_id = 70360011, pos = { x = 1562.253, y = 209.586, z = 1180.264 }, rot = { x = 0.000, y = 302.600, z = 0.000 }, level = 19, mark_flag = 2, area_id = 5 },
	{ config_id = 154003, gadget_id = 70360011, pos = { x = 1572.423, y = 213.023, z = 1188.647 }, rot = { x = 0.000, y = 240.700, z = 0.000 }, level = 19, mark_flag = 4, area_id = 5 },
	{ config_id = 154004, gadget_id = 70360011, pos = { x = 1569.840, y = 211.158, z = 1181.588 }, rot = { x = 0.000, y = 136.900, z = 0.000 }, level = 19, mark_flag = 8, area_id = 5 },
	{ config_id = 154005, gadget_id = 70360014, pos = { x = 1562.253, y = 209.586, z = 1180.264 }, rot = { x = 0.000, y = 187.800, z = 0.000 }, level = 19, route_id = 310100111, area_id = 5 },
	{ config_id = 154006, gadget_id = 70360014, pos = { x = 1572.423, y = 213.023, z = 1188.747 }, rot = { x = 0.000, y = 287.700, z = 0.000 }, level = 19, route_id = 310100112, area_id = 5 },
	{ config_id = 154007, gadget_id = 70360014, pos = { x = 1569.840, y = 211.158, z = 1181.588 }, rot = { x = 0.000, y = 299.100, z = 0.000 }, level = 19, route_id = 310100113, area_id = 5 },
	{ config_id = 154008, gadget_id = 70211111, pos = { x = 1562.261, y = 223.970, z = 1199.456 }, rot = { x = 0.000, y = 351.907, z = 0.000 }, level = 16, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 5 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_154010(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 133101154, suite = 1 }) then
...
function action_EVENT_VARIABLE_CHANGE_154011(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133101154, 2) then
...
function action_EVENT_GADGET_STATE_CHANGE_154012(context, evt)
	...
	-- 删除指定group： 133101154 ；指定config：154001；物件身上指定option：171；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 133101154, 154001, 171) then
...
function action_EVENT_GADGET_CREATE_154013(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 133101154, 154001, {171}) then
