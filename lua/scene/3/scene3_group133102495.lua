...
gadgets = {
	...
	{ config_id = 495004, gadget_id = 70211111, pos = { x = 1682.007, y = 280.408, z = 328.381 }, rot = { x = 3.820, y = 259.064, z = 0.279 }, level = 16, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 5 }
}
