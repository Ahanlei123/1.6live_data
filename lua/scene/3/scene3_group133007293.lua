...
-- 变量
variables = {
	{ name = "sort", value = 0, no_refresh = false },
	{ name = "gear_reset", value = 0, no_refresh = false },
	{ name = "v_error", value = 0, no_refresh = false },
	{ name = "trigger_output", value = 0, no_refresh = false },
	{ name = "fail_count", value = 0, no_refresh = false },
	{ name = "gear_load", value = 0, no_refresh = true },
	{ name = "monster_count", value = 5, no_refresh = false }
}
