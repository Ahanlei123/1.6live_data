...
-- 怪物
monsters = {
	{ config_id = 35001, monster_id = 24010101, pos = { x = -629.075, y = 363.979, z = 544.020 }, rot = { x = 0.000, y = 91.336, z = 0.000 }, level = 24, drop_tag = "遗迹守卫", disableWander = true, pose_id = 101, area_id = 7 }
}
...
-- 装置
gadgets = {
	{ config_id = 35002, gadget_id = 70211012, pos = { x = -622.370, y = 364.121, z = 546.906 }, rot = { x = 0.000, y = 235.223, z = 0.000 }, level = 21, drop_tag = "战斗中级璃月", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 7 }
}
