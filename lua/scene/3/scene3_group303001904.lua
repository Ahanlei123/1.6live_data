...
-- 区域
regions = {
	{ config_id = 446, shape = RegionShape.SPHERE, radius = 30, pos = { x = 1890.250, y = 199.153, z = -1266.767 } },
	{ config_id = 502, shape = RegionShape.SPHERE, radius = 9.8, pos = { x = 1919.542, y = 204.904, z = -1116.243 } }
}
