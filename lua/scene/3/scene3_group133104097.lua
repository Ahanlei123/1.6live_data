...
-- 装置
gadgets = {
	{ config_id = 205, gadget_id = 70211012, pos = { x = 280.116, y = 235.796, z = 938.971 }, rot = { x = 9.531, y = 96.320, z = 7.480 }, level = 16, drop_tag = "战斗中级璃月", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 6 }
}
