...
-- 装置
gadgets = {
	{ config_id = 122, gadget_id = 70900007, pos = { x = 2235.120, y = 254.692, z = -435.656 }, rot = { x = 0.000, y = 359.963, z = 0.000 }, level = 13, persistent = true },
	{ config_id = 145, gadget_id = 70380002, pos = { x = 2239.839, y = 250.000, z = -450.259 }, rot = { x = 0.000, y = 225.612, z = 0.000 }, level = 1, route_id = 3004500 },
	{ config_id = 146, gadget_id = 70380002, pos = { x = 2237.839, y = 250.000, z = -450.259 }, rot = { x = 0.000, y = 283.406, z = 0.000 }, level = 1, route_id = 3004500 },
	{ config_id = 147, gadget_id = 70380002, pos = { x = 2235.839, y = 250.000, z = -450.259 }, rot = { x = 0.000, y = 245.956, z = 0.000 }, level = 1, route_id = 3004500 },
	{ config_id = 148, gadget_id = 70211111, pos = { x = 2236.767, y = 254.565, z = -438.120 }, rot = { x = 352.233, y = 17.400, z = 0.778 }, level = 11, drop_tag = "解谜中级蒙德", isOneoff = true }
}
