...
-- 装置
gadgets = {
	{ config_id = 346001, gadget_id = 70211121, pos = { x = 1387.068, y = 233.768, z = -1514.661 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 11, drop_tag = "解谜高级蒙德", showcutscene = true, isOneoff = true, persistent = true }
}
