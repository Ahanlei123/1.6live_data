...
-- 装置
gadgets = {
	{ config_id = 909001, gadget_id = 70710048, pos = { x = -634.691, y = 220.470, z = 265.324 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, area_id = 7 },
	{ config_id = 909002, gadget_id = 70710048, pos = { x = -634.137, y = 220.470, z = 264.623 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, area_id = 7 },
	{ config_id = 909003, gadget_id = 70710048, pos = { x = -633.500, y = 220.470, z = 264.138 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, area_id = 7 },
	{ config_id = 909004, gadget_id = 70710049, pos = { x = -633.500, y = 220.470, z = 264.138 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, area_id = 7 },
	{ config_id = 909005, gadget_id = 70710049, pos = { x = -634.137, y = 220.470, z = 264.623 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, area_id = 7 },
	{ config_id = 909006, gadget_id = 70710049, pos = { x = -634.691, y = 220.470, z = 265.324 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, area_id = 7 },
	{ config_id = 909007, gadget_id = 70710050, pos = { x = -634.691, y = 220.470, z = 265.324 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, area_id = 7 },
	{ config_id = 909008, gadget_id = 70710050, pos = { x = -634.137, y = 220.470, z = 264.623 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, area_id = 7 },
	{ config_id = 909009, gadget_id = 70710050, pos = { x = -633.500, y = 220.470, z = 264.138 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, area_id = 7 },
	{ config_id = 909022, gadget_id = 70710048, pos = { x = -634.691, y = 220.470, z = 265.324 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, area_id = 7 },
	{ config_id = 909023, gadget_id = 70710048, pos = { x = -634.137, y = 220.470, z = 264.623 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, area_id = 7 },
	{ config_id = 909024, gadget_id = 70710048, pos = { x = -633.500, y = 220.470, z = 264.138 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, area_id = 7 }
}
...
-- 触发器
triggers = {
	{ config_id = 1909010, name = "QUEST_FINISH_909010", event = EventType.EVENT_QUEST_FINISH, source = "2230507", condition = "", action = "action_EVENT_QUEST_FINISH_909010" },
	{ config_id = 1909011, name = "QUEST_FINISH_909011", event = EventType.EVENT_QUEST_FINISH, source = "2230508", condition = "", action = "action_EVENT_QUEST_FINISH_909011" },
	{ config_id = 1909012, name = "QUEST_FINISH_909012", event = EventType.EVENT_QUEST_FINISH, source = "2230509", condition = "", action = "action_EVENT_QUEST_FINISH_909012" },
	{ config_id = 1909013, name = "GADGET_STATE_CHANGE_909013", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_909013", action = "action_EVENT_GADGET_STATE_CHANGE_909013", trigger_count = 0 },
	{ config_id = 1909014, name = "GADGET_STATE_CHANGE_909014", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_909014", action = "action_EVENT_GADGET_STATE_CHANGE_909014", trigger_count = 0 },
	{ config_id = 1909015, name = "GADGET_STATE_CHANGE_909015", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_909015", action = "action_EVENT_GADGET_STATE_CHANGE_909015", trigger_count = 0 },
	{ config_id = 1909016, name = "GADGET_STATE_CHANGE_909016", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_909016", action = "action_EVENT_GADGET_STATE_CHANGE_909016", trigger_count = 0 },
	{ config_id = 1909017, name = "GADGET_STATE_CHANGE_909017", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_909017", action = "action_EVENT_GADGET_STATE_CHANGE_909017", trigger_count = 0 },
	{ config_id = 1909018, name = "GADGET_STATE_CHANGE_909018", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_909018", action = "action_EVENT_GADGET_STATE_CHANGE_909018", trigger_count = 0 },
	{ config_id = 1909019, name = "GADGET_STATE_CHANGE_909019", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_909019", action = "action_EVENT_GADGET_STATE_CHANGE_909019", trigger_count = 0 },
	{ config_id = 1909020, name = "GADGET_STATE_CHANGE_909020", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_909020", action = "action_EVENT_GADGET_STATE_CHANGE_909020", trigger_count = 0 },
	{ config_id = 1909021, name = "GADGET_STATE_CHANGE_909021", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_909021", action = "action_EVENT_GADGET_STATE_CHANGE_909021", trigger_count = 0 }
}
