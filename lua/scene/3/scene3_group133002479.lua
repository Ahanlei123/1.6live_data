...
-- 区域
regions = {
	[479208] = { config_id = 479208, shape = RegionShape.SPHERE, radius = 100, pos = { x = 1792.758, y = 236.040, z = -914.638 }, area_id = 3, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE }
}
