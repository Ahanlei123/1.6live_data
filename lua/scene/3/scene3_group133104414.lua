...
-- 装置
gadgets = {
	{ config_id = 414001, gadget_id = 70710006, pos = { x = -175.873, y = 322.790, z = 128.900 }, rot = { x = 1.630, y = 0.058, z = 359.403 }, level = 18, persistent = true, area_id = 7 },
	{ config_id = 414002, gadget_id = 70710010, pos = { x = -121.071, y = 292.094, z = 107.319 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, route_id = 310400167, area_id = 7 },
	{ config_id = 414003, gadget_id = 70710007, pos = { x = -175.295, y = 322.791, z = 128.681 }, rot = { x = 1.533, y = 123.700, z = 359.994 }, level = 18, area_id = 7 },
	{ config_id = 414004, gadget_id = 70211111, pos = { x = -175.990, y = 322.629, z = 130.262 }, rot = { x = 6.866, y = 0.174, z = 6.064 }, level = 16, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 7 }
}

-- 区域
regions = {
	{ config_id = 414007, shape = RegionShape.SPHERE, radius = 3, pos = { x = -120.925, y = 293.848, z = 107.234 }, area_id = 7 }
}

-- 触发器
triggers = {
	{ config_id = 1414005, name = "PLATFORM_REACH_POINT_414005", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_414005", action = "action_EVENT_PLATFORM_REACH_POINT_414005", trigger_count = 0 },
	{ config_id = 1414006, name = "AVATAR_NEAR_PLATFORM_414006", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_414006", action = "action_EVENT_AVATAR_NEAR_PLATFORM_414006", trigger_count = 0 },
	{ config_id = 1414007, name = "ENTER_REGION_414007", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_414007", action = "action_EVENT_ENTER_REGION_414007", trigger_count = 0 },
	...
	{ config_id = 1414009, name = "GADGET_CREATE_414009", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_414009", action = "action_EVENT_GADGET_CREATE_414009", trigger_count = 0 }
}
