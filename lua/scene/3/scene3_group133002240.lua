...
-- 怪物
monsters = {
	{ config_id = 797, monster_id = 20011501, pos = { x = 2055.564, y = 222.594, z = -703.500 }, rot = { x = 0.000, y = 138.245, z = 0.000 }, level = 11, drop_tag = "史莱姆", disableWander = true, affix = { 1001 }, isElite = true }
}
...
-- 区域
regions = {
	{ config_id = 286, shape = RegionShape.SPHERE, radius = 8.9, pos = { x = 2075.850, y = 202.525, z = -729.927 } }
}
...
function action_EVENT_ENTER_REGION_286(context, evt)
	...
	if 0 ~= ScriptLib.SetMonsterBattleByGroup(context, 797, 133002240) then
	  return -1
	end
