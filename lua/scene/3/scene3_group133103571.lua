...
-- 变量
variables = {
	{ name = "group1", value = 0, no_refresh = false },
	{ name = "group2", value = 0, no_refresh = false },
	{ name = "group3", value = 0, no_refresh = false },
	{ name = "bridge1", value = 0, no_refresh = false },
	{ name = "group4", value = 0, no_refresh = false },
	{ name = "groupfin", value = 0, no_refresh = false }
}
