...
regions = {
	...
	{ config_id = 487022, shape = RegionShape.CUBIC, size = { x = 60.000, y = 150.000, z = 200.000 }, pos = { x = 1134.605, y = 533.825, z = -898.545 }, area_id = 10, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE },
	{ config_id = 487023, shape = RegionShape.CUBIC, size = { x = 200.000, y = 150.000, z = 110.000 }, pos = { x = 1004.906, y = 533.190, z = -939.319 }, area_id = 10, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE },
	{ config_id = 487024, shape = RegionShape.CUBIC, size = { x = 170.000, y = 150.000, z = 80.000 }, pos = { x = 1079.816, y = 533.825, z = -765.138 }, area_id = 10, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE },
	{ config_id = 487025, shape = RegionShape.CUBIC, size = { x = 85.000, y = 150.000, z = 160.000 }, pos = { x = 954.006, y = 530.658, z = -804.543 }, area_id = 10, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE }
}
