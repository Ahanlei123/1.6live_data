...
-- 怪物
monsters = {
	{ config_id = 334001, monster_id = 20011401, pos = { x = 1675.614, y = 202.442, z = 55.612 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 15, drop_tag = "史莱姆", area_id = 5 },
	{ config_id = 334002, monster_id = 20011401, pos = { x = 1677.090, y = 202.502, z = 54.005 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 15, drop_tag = "史莱姆", area_id = 5 }
}
...
-- 区域
regions = {
	{ config_id = 334010, shape = RegionShape.SPHERE, radius = 4, pos = { x = 1676.559, y = 202.514, z = 55.304 }, area_id = 5 }
}
