...
-- 装置
gadgets = {
	{ config_id = 160001, gadget_id = 70710006, pos = { x = 740.234, y = 312.359, z = 1744.539 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, persistent = true, area_id = 6 },
	{ config_id = 160002, gadget_id = 70710010, pos = { x = 691.484, y = 247.293, z = 1746.053 }, rot = { x = 0.000, y = 86.994, z = 0.000 }, level = 32, route_id = 310300043, area_id = 6 },
	{ config_id = 160003, gadget_id = 70710007, pos = { x = 738.254, y = 312.707, z = 1743.749 }, rot = { x = 0.000, y = 257.880, z = 0.000 }, level = 32, area_id = 6 },
	{ config_id = 160004, gadget_id = 70211111, pos = { x = 739.129, y = 312.367, z = 1744.494 }, rot = { x = 351.011, y = 359.707, z = 3.727 }, level = 21, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 6 }
}

-- 区域
regions = {
	{ config_id = 160007, shape = RegionShape.SPHERE, radius = 5, pos = { x = 690.366, y = 244.701, z = 1745.227 }, area_id = 6 }
}
...
triggers = {
	...
	{ config_id = 1160009, name = "GADGET_CREATE_160009", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_160009", action = "action_EVENT_GADGET_CREATE_160009" }
}
...
suites = {
	{
		...
		regions = { 160007 },
		triggers = { "PLATFORM_REACH_POINT_160005", "AVATAR_NEAR_PLATFORM_160006", "ENTER_REGION_160007", "GADGET_STATE_CHANGE_160008" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ENTER_REGION_160007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 160002, 310300044) then
...
function action_EVENT_GADGET_STATE_CHANGE_160008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133103160, 2) then
