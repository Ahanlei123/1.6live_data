...
-- 装置
gadgets = {
	{ config_id = 246001, gadget_id = 70360001, pos = { x = 1809.114, y = 195.133, z = -1408.713 }, rot = { x = 0.000, y = 175.400, z = 0.000 }, level = 5, isOneoff = true, persistent = true },
	{ config_id = 246002, gadget_id = 70211111, pos = { x = 1809.090, y = 194.699, z = -1408.742 }, rot = { x = 0.000, y = 80.300, z = 0.000 }, level = 1, drop_tag = "解谜中级蒙德", showcutscene = true, isOneoff = true, persistent = true }
}
...
triggers = {
	...
	{ name = "GADGET_STATE_CHANGE_246005", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_246005", action = "action_EVENT_GADGET_STATE_CHANGE_246005", trigger_count = 0 }
}
