...
-- 区域
regions = {
	{ config_id = 186, shape = RegionShape.SPHERE, radius = 56.8, pos = { x = 1377.414, y = 234.022, z = -1562.365 } },
	{ config_id = 217, shape = RegionShape.SPHERE, radius = 4, pos = { x = 1372.815, y = 236.045, z = -1570.076 } }
}

-- 触发器
triggers = {
	{ name = "ENTER_REGION_186", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_186", action = "", trigger_count = 0 },
