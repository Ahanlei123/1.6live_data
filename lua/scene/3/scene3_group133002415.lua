...
variables = {
	...
	{ name = "MonsterTideCheck", value = 0, no_refresh = false },
	...
	{ name = "415012_Hit_Uid", value = 0, no_refresh = true },
	{ name = "415013_Hit_Uid", value = 0, no_refresh = true },
	{ name = "415014_Hit_Uid", value = 0, no_refresh = true },
