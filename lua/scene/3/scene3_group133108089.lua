...
-- 怪物
monsters = {
	{ config_id = 89001, monster_id = 28050201, pos = { x = -171.484, y = 251.634, z = -33.520 }, rot = { x = 0.000, y = 29.457, z = 0.000 }, level = 32, drop_tag = "魔法生物", area_id = 7 },
	{ config_id = 89002, monster_id = 28050201, pos = { x = -152.497, y = 249.748, z = -36.725 }, rot = { x = 337.019, y = 27.368, z = 9.575 }, level = 32, drop_tag = "魔法生物", pose_id = 3, area_id = 7 }
}
...
-- 装置
gadgets = {
	{ config_id = 89003, gadget_id = 70360027, pos = { x = -152.580, y = 249.702, z = -36.683 }, rot = { x = 1.235, y = 103.797, z = 344.131 }, level = 32, mark_flag = 3, area_id = 7 },
	{ config_id = 89004, gadget_id = 70360015, pos = { x = -171.190, y = 251.473, z = -33.405 }, rot = { x = 344.219, y = 16.220, z = 351.932 }, level = 32, mark_flag = 2, area_id = 7 }
}
...
-- 触发器
triggers = {
	{ config_id = 1089005, name = "ANY_MONSTER_DIE_89005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_89005", action = "action_EVENT_ANY_MONSTER_DIE_89005" },
	{ config_id = 1089006, name = "SELECT_OPTION_89006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_89006", action = "action_EVENT_SELECT_OPTION_89006", trigger_count = 0 },
	...
	{ config_id = 1089009, name = "GROUP_LOAD_89009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_89009", action = "action_EVENT_GROUP_LOAD_89009", trigger_count = 0 },
	{ config_id = 1089010, name = "GROUP_LOAD_89010", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_89010", action = "action_EVENT_GROUP_LOAD_89010", trigger_count = 0 }
}
...
suites = {
	{
		...
		gadgets = { 89003, 89004 },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_89005", "SELECT_OPTION_89006", "GADGET_STATE_CHANGE_89007", "GADGET_STATE_CHANGE_89008", "GROUP_LOAD_89009", "GROUP_LOAD_89010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_89009(context, evt)
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_89010(context, evt)
...
-- 触发操作
function action_EVENT_GROUP_LOAD_89010(context, evt)
	-- 将configid为 89004 的物件更改为状态 GadgetState.GearAction1
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 89004, GadgetState.GearAction1) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
