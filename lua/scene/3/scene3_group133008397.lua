...
gadgets = {
	...
	{ config_id = 397003, gadget_id = 70290047, pos = { x = 1169.039, y = 267.082, z = -532.549 }, rot = { x = 18.491, y = 99.595, z = 337.162 }, level = 30, persistent = true, area_id = 10 },
...
-- 变量
variables = {
	{ name = "progress", value = 0, no_refresh = true }
}
