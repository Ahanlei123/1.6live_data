...
-- 怪物
monsters = {
	{ config_id = 538001, monster_id = 28050201, pos = { x = 403.666, y = 228.916, z = 1005.078 }, rot = { x = 0.000, y = 29.457, z = 0.000 }, level = 32, drop_tag = "魔法生物", area_id = 6 },
	{ config_id = 538002, monster_id = 28050201, pos = { x = 387.412, y = 228.748, z = 1000.267 }, rot = { x = 0.000, y = 29.457, z = 0.000 }, level = 32, drop_tag = "魔法生物", pose_id = 3, area_id = 6 }
}
...
-- 装置
gadgets = {
	{ config_id = 538003, gadget_id = 70360027, pos = { x = 387.162, y = 228.647, z = 1000.723 }, rot = { x = 0.000, y = 104.100, z = 0.000 }, level = 32, mark_flag = 3, area_id = 6 },
	{ config_id = 538004, gadget_id = 70360015, pos = { x = 403.960, y = 228.932, z = 1005.193 }, rot = { x = 0.000, y = 15.100, z = 0.000 }, level = 32, mark_flag = 2, area_id = 6 }
}
...
-- 触发器
triggers = {
	{ config_id = 1538005, name = "ANY_MONSTER_DIE_538005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_538005", action = "action_EVENT_ANY_MONSTER_DIE_538005" },
	{ config_id = 1538006, name = "SELECT_OPTION_538006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_538006", action = "action_EVENT_SELECT_OPTION_538006", trigger_count = 0 },
	...
	{ config_id = 1538009, name = "GROUP_LOAD_538009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_538009", action = "action_EVENT_GROUP_LOAD_538009", trigger_count = 0 },
	{ config_id = 1538010, name = "GROUP_LOAD_538010", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_538010", action = "action_EVENT_GROUP_LOAD_538010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_538005", "SELECT_OPTION_538006", "GADGET_STATE_CHANGE_538007", "GADGET_STATE_CHANGE_538008", "GROUP_LOAD_538009", "GROUP_LOAD_538010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_538009(context, evt)
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_538010(context, evt)
...
-- 触发操作
function action_EVENT_GROUP_LOAD_538010(context, evt)
	-- 将configid为 538004 的物件更改为状态 GadgetState.GearAction1
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 538004, GadgetState.GearAction1) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
	...
	-- 将configid为 538003 的物件更改为状态 GadgetState.Default
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 538003, GadgetState.Default) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
