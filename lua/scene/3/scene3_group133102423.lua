...
-- 怪物
monsters = {
	{ config_id = 423001, monster_id = 26010201, pos = { x = 1755.144, y = 217.088, z = 852.943 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, drop_tag = "骗骗花", area_id = 5 }
}
...
-- 装置
gadgets = {
	{ config_id = 423002, gadget_id = 70510013, pos = { x = 1755.042, y = 216.595, z = 852.943 }, rot = { x = 0.000, y = 319.800, z = 0.000 }, level = 32, persistent = true, area_id = 5 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_423003(context, evt)
	-- 添加suite2的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133102423, 2)
...
function action_EVENT_GADGET_CREATE_423005(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 133102423, 423002, {173}) then
...
function action_EVENT_SELECT_OPTION_423006(context, evt)
	...
	-- 删除指定group： 133102423 ；指定config：423002；物件身上指定option：173；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 133102423, 423002, 173) then
