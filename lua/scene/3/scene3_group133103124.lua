...
-- 怪物
monsters = {
	{ config_id = 124001, monster_id = 26010201, pos = { x = 541.504, y = 181.634, z = 1159.350 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 24, drop_tag = "骗骗花", area_id = 6 }
}
...
-- 装置
gadgets = {
	{ config_id = 124002, gadget_id = 70510013, pos = { x = 541.504, y = 181.634, z = 1159.350 }, rot = { x = 0.000, y = 319.800, z = 0.000 }, level = 32, persistent = true, area_id = 6 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_124003(context, evt)
	-- 添加suite2的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133103124, 2)
