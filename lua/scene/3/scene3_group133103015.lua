...
variables = {
	...
	{ name = "gears", value = 0, no_refresh = true },
	{ name = "waterlevel", value = 0, no_refresh = true },
	{ name = "waterlevel2", value = 0, no_refresh = true },
	{ name = "statue1", value = 0, no_refresh = true },
	{ name = "statue2", value = 0, no_refresh = true },
	{ name = "statue3", value = 0, no_refresh = true }
}
