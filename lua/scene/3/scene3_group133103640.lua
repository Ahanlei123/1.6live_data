...
-- 变量
variables = {
	{ name = "talk", value = 0, no_refresh = true },
	{ name = "current_idx", value = 0, no_refresh = true },
	{ name = "killed", value = 0, no_refresh = true },
	{ name = "quest_finished", value = 0, no_refresh = true },
	{ name = "quest_accept", value = 0, no_refresh = true },
	{ name = "explore", value = 0, no_refresh = true },
	{ name = "talk_see_monster", value = 0, no_refresh = true }
}
