...
-- 区域
regions = {
	{ config_id = 69, shape = RegionShape.SPHERE, radius = 46.23, pos = { x = 2176.841, y = 210.575, z = -881.578 }, area_id = 1 },
	{ config_id = 70, shape = RegionShape.SPHERE, radius = 6.35, pos = { x = 2442.183, y = 199.949, z = -1169.836 }, area_id = 1 },
	{ config_id = 71, shape = RegionShape.SPHERE, radius = 10.51, pos = { x = 2421.934, y = 200.853, z = -1162.341 }, area_id = 1 }
}
...
triggers = {
	...
	{ config_id = 1000071, name = "ENTER_REGION_71", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_71", action = "action_EVENT_ENTER_REGION_71" }
}
