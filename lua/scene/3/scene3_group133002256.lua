...
gadgets = {
	...
	{ config_id = 2172, gadget_id = 70300083, pos = { x = 1955.355, y = 220.153, z = -541.243 }, rot = { x = 358.296, y = 5.031, z = 353.099 }, level = 28, area_id = 3 },
...
-- 变量
variables = {
	{ name = "isall", value = 0, no_refresh = false },
	{ name = "2174", value = 0, no_refresh = false },
	{ name = "2173", value = 0, no_refresh = false },
	{ name = "iskill", value = 0, no_refresh = false }
}
