...
-- 装置
gadgets = {
	{ config_id = 627001, gadget_id = 70360007, pos = { x = 2031.598, y = 210.729, z = 676.953 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, persistent = true },
	{ config_id = 627002, gadget_id = 70360007, pos = { x = 2012.083, y = 210.700, z = 677.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, persistent = true },
	{ config_id = 627004, gadget_id = 70211111, pos = { x = 2021.616, y = 215.980, z = 671.758 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 16, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, type = GadgetType.GADGET_WORLD_CHECT }
}
