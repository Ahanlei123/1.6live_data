...
-- 装置
gadgets = {
	{ config_id = 341001, gadget_id = 70710006, pos = { x = 1325.657, y = 282.277, z = -1784.180 }, rot = { x = 2.494, y = 71.253, z = 356.682 }, level = 15, area_id = 2 },
	{ config_id = 341002, gadget_id = 70710010, pos = { x = 1321.328, y = 275.488, z = -1735.501 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 15, route_id = 300100223, area_id = 2 },
	{ config_id = 341003, gadget_id = 70710007, pos = { x = 1325.796, y = 282.327, z = -1782.823 }, rot = { x = 0.000, y = 13.210, z = 0.000 }, level = 15, area_id = 2 }
}

-- 区域
regions = {
	{ config_id = 341007, shape = RegionShape.SPHERE, radius = 5, pos = { x = 1322.828, y = 275.488, z = -1735.401 }, area_id = 2 }
}

-- 触发器
triggers = {
	{ config_id = 1341005, name = "PLATFORM_REACH_POINT_341005", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_341005", action = "action_EVENT_PLATFORM_REACH_POINT_341005", trigger_count = 0 },
	{ config_id = 1341006, name = "AVATAR_NEAR_PLATFORM_341006", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_341006", action = "action_EVENT_AVATAR_NEAR_PLATFORM_341006", trigger_count = 0 },
	{ config_id = 1341007, name = "ENTER_REGION_341007", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_341007", action = "action_EVENT_ENTER_REGION_341007", trigger_count = 0 },
	{ config_id = 1341008, name = "GADGET_STATE_CHANGE_341008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_341008", action = "action_EVENT_GADGET_STATE_CHANGE_341008" },
	{ config_id = 1341009, name = "GADGET_CREATE_341009", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_341009", action = "action_EVENT_GADGET_CREATE_341009", trigger_count = 0 }
}
