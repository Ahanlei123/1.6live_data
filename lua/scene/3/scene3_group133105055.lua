...
gadgets = {
	...
	{ config_id = 397, gadget_id = 70211101, pos = { x = 265.859, y = 199.412, z = -284.926 }, rot = { x = 7.985, y = 62.099, z = 18.333 }, level = 16, drop_tag = "解谜低级璃月", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 9 },
