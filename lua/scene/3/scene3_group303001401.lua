...
-- 怪物
monsters = {
	{ config_id = 401001, monster_id = 26010101, pos = { x = 1380.615, y = 317.967, z = -1319.711 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 10 }
}
...
-- 装置
gadgets = {
	{ config_id = 401002, gadget_id = 70510014, pos = { x = 1380.643, y = 317.980, z = -1319.697 }, rot = { x = 0.000, y = 319.800, z = 0.000 }, level = 10, isOneoff = true, persistent = true }
}
...
-- 触发器
triggers = {
	{ name = "GADGET_STATE_CHANGE_401003", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_401003", action = "action_EVENT_GADGET_STATE_CHANGE_401003", trigger_count = 0 },
	{ name = "ANY_MONSTER_DIE_401004", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_401004", action = "action_EVENT_ANY_MONSTER_DIE_401004" },
	{ name = "GADGET_CREATE_401005", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_401005", action = "action_EVENT_GADGET_CREATE_401005", trigger_count = 0 },
	{ name = "SELECT_OPTION_401006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_401006", action = "action_EVENT_SELECT_OPTION_401006", trigger_count = 0 }
}
