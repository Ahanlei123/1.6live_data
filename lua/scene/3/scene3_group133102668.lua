...
-- 怪物
monsters = {
	{ config_id = 668001, monster_id = 21010201, pos = { x = 81.005, y = 4.000, z = -604.640 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "丘丘人", disableWander = true, pose_id = 0 }
}
...
-- 装置
gadgets = {
	{ config_id = 668002, gadget_id = 70211012, pos = { x = 80.791, y = 4.000, z = -601.359 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "战斗中级璃月", state = GadgetState.ChestLocked, isOneoff = true, persistent = true }
}
