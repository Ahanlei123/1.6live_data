...
-- 装置
gadgets = {
	{ config_id = 916001, gadget_id = 70710122, pos = { x = 1144.004, y = 350.218, z = 1571.233 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 24, interact_id = 10, area_id = 6 }
}
...
function condition_EVENT_GADGET_STATE_CHANGE_916002(context, evt)
	if 916001 ~= evt.param2 or GadgetState.GearStart ~= evt.param1 then
		return false
	end
...
function action_EVENT_GADGET_STATE_CHANGE_916002(context, evt)
	...
	if 0 ~= ScriptLib.AddQuestProgress(context, "133101916") then
