...
-- 怪物
monsters = {
	{ config_id = 147001, monster_id = 26010201, pos = { x = -157.075, y = 252.797, z = -28.054 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 18, drop_tag = "骗骗花", area_id = 7 }
}
...
-- 装置
gadgets = {
	{ config_id = 147002, gadget_id = 70510013, pos = { x = -157.075, y = 252.797, z = -28.054 }, rot = { x = 0.000, y = 319.800, z = 0.000 }, level = 18, persistent = true, area_id = 7 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_147003(context, evt)
	-- 添加suite2的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133108147, 2)
...
function action_EVENT_GADGET_CREATE_147005(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 133108147, 147002, {173}) then
...
function action_EVENT_SELECT_OPTION_147006(context, evt)
	...
	-- 删除指定group： 133108147 ；指定config：147002；物件身上指定option：173；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 133108147, 147002, 173) then
