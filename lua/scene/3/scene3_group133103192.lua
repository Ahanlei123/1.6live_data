...
-- 装置
gadgets = {
	{ config_id = 192001, gadget_id = 70360007, pos = { x = 784.113, y = 332.778, z = 1641.958 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 24, area_id = 6 },
	{ config_id = 192002, gadget_id = 70211111, pos = { x = 771.639, y = 318.690, z = 1574.271 }, rot = { x = 0.000, y = 356.193, z = 0.000 }, level = 21, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, autopick = true, explore = { name = "chest", exp = 1 }, area_id = 6 }
}
