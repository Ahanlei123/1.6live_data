...
-- 变量
variables = {
	{ name = "currentPointIndex", value = -1, no_refresh = true },
	{ name = "lastRefreshTime", value = -1, no_refresh = true },
	{ name = "currentHiliPosition", value = 0, no_refresh = true },
	{ name = "isFirstLoad", value = 0, no_refresh = true },
	{ name = "isDead", value = 0, no_refresh = true }
}
...
function action_EVENT_GROUP_REFRESH_406002(context, evt)
	...
	newIdx=math.random(#defs.bornPoints)
	until (idx~=newIdx)
	idx=newIdx
