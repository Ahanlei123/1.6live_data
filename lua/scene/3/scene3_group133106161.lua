...
-- 怪物
monsters = {
	{ config_id = 161001, monster_id = 28050201, pos = { x = -378.764, y = 227.102, z = 1108.174 }, rot = { x = 0.000, y = 29.457, z = 0.000 }, level = 32, drop_tag = "魔法生物", area_id = 8 },
	{ config_id = 161002, monster_id = 28050201, pos = { x = -378.225, y = 225.966, z = 1119.994 }, rot = { x = 0.000, y = 29.457, z = 0.000 }, level = 32, drop_tag = "魔法生物", pose_id = 3, area_id = 8 }
}
