...
variables = {
	...
	{ name = "isObstacle4_1Available", value = 1, no_refresh = false },
	{ name = "isObstacle4_2Available", value = 1, no_refresh = false },
	{ name = "isObstacle5Available", value = 1, no_refresh = false },
	{ name = "isObstacle6Available", value = 1, no_refresh = false },
	...
	{ name = "hasReachedObstacle6", value = 0, no_refresh = false },
	{ name = "deadTrapMonsters", value = 0, no_refresh = false }
}
