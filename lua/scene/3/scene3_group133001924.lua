...
-- 怪物
monsters = {
	{ config_id = 924001, monster_id = 28020305, pos = { x = 1088.316, y = 347.891, z = -1061.978 }, rot = { x = 0.000, y = 126.303, z = 0.000 }, level = 1, drop_id = 1000100, ban_excel_drop = true, climate_area_id = 1, area_id = 10 }
}
