...
-- 怪物
monsters = {
	{ config_id = 123, monster_id = 24010101, pos = { x = 1557.183, y = 243.803, z = -595.115 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, drop_tag = "遗迹守卫", disableWander = true, pose_id = 100 }
}
