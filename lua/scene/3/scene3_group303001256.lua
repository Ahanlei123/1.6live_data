...
-- 装置
gadgets = {
	{ config_id = 256001, gadget_id = 70710006, pos = { x = 1663.476, y = 266.510, z = -1294.355 }, rot = { x = 0.000, y = 66.616, z = 0.000 }, level = 10 },
	{ config_id = 256002, gadget_id = 70710010, pos = { x = 1636.138, y = 247.626, z = -1296.091 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 10, route_id = 300100235 },
	{ config_id = 256003, gadget_id = 70710007, pos = { x = 1662.546, y = 266.538, z = -1294.557 }, rot = { x = 0.000, y = 273.565, z = 0.000 }, level = 10 },
	{ config_id = 256004, gadget_id = 70211111, pos = { x = 1665.207, y = 266.466, z = -1293.300 }, rot = { x = 359.031, y = 52.654, z = 351.008 }, level = 6, drop_tag = "解谜中级蒙德", showcutscene = true, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 256007, shape = RegionShape.SPHERE, radius = 4, pos = { x = 1636.343, y = 247.616, z = -1294.651 } }
}
