...
-- 怪物
monsters = {
	{ config_id = 338001, monster_id = 20011201, pos = { x = 1985.141, y = 221.123, z = -1570.709 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 7 },
	{ config_id = 338002, monster_id = 20010601, pos = { x = 1986.628, y = 221.123, z = -1571.934 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 7 },
	{ config_id = 338003, monster_id = 20010601, pos = { x = 1983.658, y = 221.123, z = -1571.842 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 7 }
}
...
-- 区域
regions = {
	{ config_id = 338004, shape = RegionShape.SPHERE, radius = 5, pos = { x = 1984.955, y = 220.983, z = -1572.224 } }
}
