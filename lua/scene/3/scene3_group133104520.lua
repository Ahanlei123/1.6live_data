...
-- 装置
gadgets = {
	{ config_id = 520001, gadget_id = 70360001, pos = { x = 842.496, y = 245.412, z = 1011.316 }, rot = { x = 0.000, y = 175.400, z = 0.000 }, level = 24, isOneoff = true, persistent = true },
	{ config_id = 520002, gadget_id = 70211111, pos = { x = 842.419, y = 245.109, z = 1011.337 }, rot = { x = 0.000, y = 80.300, z = 0.000 }, level = 21, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true }
}
