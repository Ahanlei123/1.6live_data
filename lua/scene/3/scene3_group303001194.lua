...
-- 装置
gadgets = {
	{ config_id = 194001, gadget_id = 70620001, pos = { x = 1603.123, y = 341.450, z = -2100.270 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 15, isOneoff = true, persistent = true },
	{ config_id = 194002, gadget_id = 70211121, pos = { x = 1603.301, y = 341.109, z = -2100.194 }, rot = { x = 0.000, y = 299.089, z = 0.000 }, level = 11, drop_tag = "解谜高级蒙德", state = GadgetState.ChestLocked, isOneoff = true, persistent = true }
}
...
triggers = {
	...
	{ name = "GADGET_STATE_CHANGE_194004", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_194004", action = "action_EVENT_GADGET_STATE_CHANGE_194004" },
