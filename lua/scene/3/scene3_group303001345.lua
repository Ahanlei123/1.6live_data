...
-- 装置
gadgets = {
	{ config_id = 345001, gadget_id = 70710006, pos = { x = 1387.072, y = 233.821, z = -1511.942 }, rot = { x = 0.000, y = 177.602, z = 0.000 }, level = 15 },
	{ config_id = 345002, gadget_id = 70710010, pos = { x = 1401.219, y = 244.566, z = -1481.550 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 15, route_id = 300100229 },
	{ config_id = 345003, gadget_id = 70710007, pos = { x = 1387.350, y = 233.842, z = -1510.833 }, rot = { x = 0.000, y = 28.829, z = 0.000 }, level = 15 }
}

-- 区域
regions = {
	{ config_id = 345007, shape = RegionShape.SPHERE, radius = 3, pos = { x = 1402.745, y = 244.474, z = -1480.337 } }
}
