...
-- 怪物
monsters = {
	{ config_id = 908002, monster_id = 28020403, pos = { x = -681.526, y = 220.583, z = 257.413 }, rot = { x = 0.000, y = 270.596, z = 0.000 }, level = 18, drop_tag = "走兽", disableWander = true, pose_id = 2, area_id = 7 },
	{ config_id = 908003, monster_id = 28020403, pos = { x = -683.907, y = 220.583, z = 254.991 }, rot = { x = 0.000, y = 10.109, z = 0.000 }, level = 18, drop_tag = "走兽", disableWander = true, pose_id = 3, area_id = 7 },
	{ config_id = 908004, monster_id = 28020403, pos = { x = -683.297, y = 220.583, z = 257.960 }, rot = { x = 0.000, y = 176.737, z = 0.000 }, level = 18, drop_tag = "走兽", disableWander = true, pose_id = 2, area_id = 7 }
}
