...
-- 怪物
monsters = {
	{ config_id = 94001, monster_id = 23030101, pos = { x = -198.860, y = 240.537, z = 1248.190 }, rot = { x = 0.000, y = 54.236, z = 0.000 }, level = 30, drop_tag = "召唤师", disableWander = true, area_id = 8 }
}
...
-- 装置
gadgets = {
	{ config_id = 94002, gadget_id = 70211012, pos = { x = -196.853, y = 240.527, z = 1249.849 }, rot = { x = 0.360, y = 219.895, z = 0.098 }, level = 26, drop_tag = "战斗中级璃月", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 8 }
}
