...
-- 怪物
monsters = {
	{ config_id = 400001, monster_id = 26010101, pos = { x = 1560.495, y = 295.136, z = -1214.473 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 10 }
}
...
-- 装置
gadgets = {
	{ config_id = 400002, gadget_id = 70510014, pos = { x = 1560.411, y = 295.149, z = -1214.707 }, rot = { x = 0.000, y = 319.800, z = 0.000 }, level = 10, isOneoff = true, persistent = true }
}
...
-- 触发器
triggers = {
	{ name = "GADGET_STATE_CHANGE_400003", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_400003", action = "action_EVENT_GADGET_STATE_CHANGE_400003", trigger_count = 0 },
	{ name = "ANY_MONSTER_DIE_400004", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_400004", action = "action_EVENT_ANY_MONSTER_DIE_400004" },
	{ name = "GADGET_CREATE_400005", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_400005", action = "action_EVENT_GADGET_CREATE_400005", trigger_count = 0 },
	{ name = "SELECT_OPTION_400006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_400006", action = "action_EVENT_SELECT_OPTION_400006", trigger_count = 0 }
}
