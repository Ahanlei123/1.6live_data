...
-- 怪物
monsters = {
	{ config_id = 402001, monster_id = 26010101, pos = { x = 1757.563, y = 254.209, z = -1195.636 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 10, drop_tag = "骗骗花", area_id = 2 }
}
...
-- 装置
gadgets = {
	{ config_id = 402002, gadget_id = 70510014, pos = { x = 1757.488, y = 254.244, z = -1195.720 }, rot = { x = 0.000, y = 319.800, z = 0.000 }, level = 10, isOneoff = true, persistent = true, area_id = 2 }
}
...
-- 触发器
triggers = {
	{ config_id = 1402003, name = "GADGET_STATE_CHANGE_402003", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_402003", action = "action_EVENT_GADGET_STATE_CHANGE_402003", trigger_count = 0 },
	...
	{ config_id = 1402005, name = "GADGET_CREATE_402005", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_402005", action = "action_EVENT_GADGET_CREATE_402005", trigger_count = 0 },
	{ config_id = 1402006, name = "SELECT_OPTION_402006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_402006", action = "action_EVENT_SELECT_OPTION_402006", trigger_count = 0 }
}
