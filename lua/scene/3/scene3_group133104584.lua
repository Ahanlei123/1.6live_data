...
triggers = {
	...
	{ config_id = 1584004, name = "QUEST_FINISH_584004", event = EventType.EVENT_QUEST_FINISH, source = "7100320", condition = "", action = "action_EVENT_QUEST_FINISH_584004" },
...
-- 变量
variables = {
	{ name = "questStart", value = 0, no_refresh = true },
	{ name = "uniqueColorCount", value = 0, no_refresh = true },
	{ name = "curColor01", value = 0, no_refresh = true },
	{ name = "curColor02", value = 0, no_refresh = true },
	{ name = "curColor03", value = 0, no_refresh = true },
	{ name = "curColor04", value = 0, no_refresh = true },
	{ name = "curColor05", value = 0, no_refresh = true },
	{ name = "curColor06", value = 0, no_refresh = true },
...
-- 触发操作
function action_EVENT_QUEST_FINISH_584004(context, evt)
	-- group调整group进度,只对非randSuite有效
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133104584, 10) then
