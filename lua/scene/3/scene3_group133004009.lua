...
-- 区域
regions = {
	[9062] = { config_id = 9062, shape = RegionShape.SPHERE, radius = 200, pos = { x = 965.180, y = 286.748, z = -938.496 }, area_id = 10, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE },
	[9063] = { config_id = 9063, shape = RegionShape.SPHERE, radius = 80, pos = { x = 967.883, y = 329.957, z = -945.988 }, area_id = 10, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE }
}
