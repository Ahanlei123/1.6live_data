...
-- 装置
gadgets = {
	{ config_id = 316003, gadget_id = 70211101, pos = { x = 1670.535, y = 225.382, z = -40.492 }, rot = { x = 356.203, y = 359.725, z = 8.285 }, level = 16, drop_tag = "解谜低级璃月", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 5 }
}
