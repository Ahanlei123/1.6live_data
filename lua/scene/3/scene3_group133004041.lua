...
-- 怪物
monsters = {
	{ config_id = 98, monster_id = 20011201, pos = { x = 2455.520, y = 305.687, z = -333.399 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 14, drop_id = 1000100 },
	{ config_id = 99, monster_id = 20011301, pos = { x = 2450.482, y = 305.657, z = -333.964 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 14, drop_id = 1000100 },
	{ config_id = 100, monster_id = 20011201, pos = { x = 2453.234, y = 305.616, z = -338.679 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 14, drop_id = 1000100 }
}
...
-- 装置
gadgets = {
	{ config_id = 165, gadget_id = 70900007, pos = { x = 2452.768, y = 305.689, z = -335.450 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 20, persistent = true },
	{ config_id = 166, gadget_id = 70211111, pos = { x = 2452.691, y = 305.775, z = -332.681 }, rot = { x = 0.000, y = 91.349, z = 355.771 }, level = 20, drop_tag = "解谜中级蒙德", showcutscene = true, isOneoff = true }
}
