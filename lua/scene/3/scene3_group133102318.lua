...
-- 触发器
triggers = {
	{ config_id = 1318006, name = "GATHER_318006", event = EventType.EVENT_GATHER, source = "", condition = "condition_EVENT_GATHER_318006", action = "action_EVENT_GATHER_318006" },
	{ config_id = 1318007, name = "GATHER_318007", event = EventType.EVENT_GATHER, source = "", condition = "condition_EVENT_GATHER_318007", action = "action_EVENT_GATHER_318007" },
	{ config_id = 1318008, name = "GATHER_318008", event = EventType.EVENT_GATHER, source = "", condition = "condition_EVENT_GATHER_318008", action = "action_EVENT_GATHER_318008" },
	{ config_id = 1318009, name = "GATHER_318009", event = EventType.EVENT_GATHER, source = "", condition = "condition_EVENT_GATHER_318009", action = "action_EVENT_GATHER_318009" },
	{ config_id = 1318010, name = "VARIABLE_CHANGE_318010", event = EventType.EVENT_VARIABLE_CHANGE, source = "None", condition = "condition_EVENT_VARIABLE_CHANGE_318010", action = "action_EVENT_VARIABLE_CHANGE_318010" }
}
