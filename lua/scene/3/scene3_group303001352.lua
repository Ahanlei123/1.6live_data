...
-- 装置
gadgets = {
	{ config_id = 352001, gadget_id = 70211101, pos = { x = 1460.800, y = 241.998, z = -1536.076 }, rot = { x = 349.646, y = 292.531, z = 356.080 }, level = 11, drop_tag = "解谜低级蒙德", state = GadgetState.ChestLocked, isOneoff = true, persistent = true },
	{ config_id = 352002, gadget_id = 70220021, pos = { x = 1459.076, y = 241.984, z = -1535.723 }, rot = { x = 6.069, y = 76.779, z = 358.249 }, level = 15, isOneoff = true, persistent = true }
}
