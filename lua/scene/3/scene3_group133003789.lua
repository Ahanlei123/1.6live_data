...
-- 区域
regions = {
	[789158] = { config_id = 789158, shape = RegionShape.SPHERE, radius = 100, pos = { x = 2237.821, y = 243.634, z = -1579.171 }, area_id = 1, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE }
}
