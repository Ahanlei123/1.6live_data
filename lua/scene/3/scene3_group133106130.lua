...
monsters = {
	...
	{ config_id = 130014, monster_id = 20010201, pos = { x = -207.421, y = 280.471, z = 1361.608 }, rot = { x = 0.000, y = 181.345, z = 0.000 }, level = 32, drop_tag = "大史莱姆", pose_id = 201, area_id = 8 },
	...
	{ config_id = 130018, monster_id = 20010101, pos = { x = -899.466, y = 213.453, z = 1610.024 }, rot = { x = 0.000, y = 132.803, z = 0.000 }, level = 32, drop_tag = "史莱姆", pose_id = 201 },
	{ config_id = 130019, monster_id = 20010101, pos = { x = -1.273, y = 279.855, z = 1425.884 }, rot = { x = 0.000, y = 79.664, z = 0.000 }, level = 24, drop_tag = "史莱姆", pose_id = 201, area_id = 6 },
	...
	{ config_id = 130025, monster_id = 20010101, pos = { x = -460.969, y = 241.750, z = 1590.965 }, rot = { x = 0.000, y = 266.898, z = 0.000 }, level = 32, drop_tag = "史莱姆", pose_id = 201 },
...
suites = {
	{
		-- suite_id = 1,
		-- description = ,
		monsters = { 130001, 130002, 130003, 130007, 130008, 130009, 130010, 130011, 130012, 130013, 130014, 130015, 130016, 130018, 130019, 130020, 130022, 130023, 130024, 130025, 130026 },
		gadgets = { },
		regions = { },
		triggers = { },
		rand_weight = 100
