...
-- 装置
gadgets = {
	{ config_id = 602001, gadget_id = 70360001, pos = { x = 1814.630, y = 205.914, z = 857.787 }, rot = { x = 0.000, y = 175.400, z = 0.000 }, level = 18, isOneoff = true, persistent = true, area_id = 5 },
	{ config_id = 602002, gadget_id = 70211111, pos = { x = 1814.631, y = 205.781, z = 857.581 }, rot = { x = 359.682, y = 80.347, z = 352.827 }, level = 16, drop_tag = "解谜中级璃月", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 5 }
}
...
triggers = {
	...
	{ config_id = 1602005, name = "GADGET_STATE_CHANGE_602005", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_602005", action = "action_EVENT_GADGET_STATE_CHANGE_602005", trigger_count = 0 }
}
...
function condition_EVENT_GADGET_STATE_CHANGE_602005(context, evt)
	if 602002 ~= evt.param2 or GadgetState.ChestOpened ~= evt.param1 then
		return false
	end
