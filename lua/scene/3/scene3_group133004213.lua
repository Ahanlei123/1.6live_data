...
gadgets = {
	...
	{ config_id = 1188, gadget_id = 70500000, pos = { x = 2630.906, y = 261.882, z = -385.500 }, rot = { x = 0.000, y = 234.085, z = 0.000 }, level = 20, point_type = 4001001, isOneoff = true, area_id = 4 }
}
