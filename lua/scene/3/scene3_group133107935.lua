...
-- 怪物
monsters = {
	{ config_id = 935004, monster_id = 28030401, pos = { x = -469.412, y = 230.362, z = 456.461 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "鸟类", disableWander = true, pose_id = 2, area_id = 7 },
	{ config_id = 935005, monster_id = 28030401, pos = { x = -467.015, y = 230.362, z = 457.467 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "鸟类", disableWander = true, pose_id = 2, area_id = 7 },
	{ config_id = 935006, monster_id = 28030402, pos = { x = -468.236, y = 230.358, z = 455.457 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "鸟类", disableWander = true, pose_id = 2, area_id = 7 },
	{ config_id = 935007, monster_id = 28030404, pos = { x = -468.835, y = 230.367, z = 458.916 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "鸟类", disableWander = true, pose_id = 2, area_id = 7 },
	{ config_id = 935008, monster_id = 28030403, pos = { x = -466.920, y = 230.359, z = 456.344 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "鸟类", disableWander = true, pose_id = 2, area_id = 7 }
}
...
function condition_EVENT_ENTER_REGION_935010(context, evt)
	if ScriptLib.GetEntityType(evt.target_eid) == EntityType.AVATAR and ScriptLib.GetQuestState(context, evt.target_eid, 7180903) == QuestState.UNFINISHED and evt.param1 == defs.gadget_2 then
		return true
	end
	return false
end
...
function condition_EVENT_ENTER_REGION_935011(context, evt)
	if ScriptLib.GetEntityType(evt.target_eid) == EntityType.AVATAR and ScriptLib.GetQuestState(context, evt.target_eid, 7180904) == QuestState.UNFINISHED and evt.param1 == defs.gadget_3 then
		return true
	end
	return false
end
