...
-- 怪物
monsters = {
	{ config_id = 548, monster_id = 20011501, pos = { x = 2493.705, y = 253.709, z = -334.589 }, rot = { x = 0.000, y = 101.188, z = 0.000 }, level = 12, drop_tag = "史莱姆" },
	{ config_id = 549, monster_id = 20011401, pos = { x = 2492.532, y = 254.010, z = -332.626 }, rot = { x = 0.000, y = 98.511, z = 0.000 }, level = 12, drop_tag = "史莱姆" },
	{ config_id = 550, monster_id = 20011401, pos = { x = 2491.515, y = 254.051, z = -336.028 }, rot = { x = 0.000, y = 80.865, z = 0.000 }, level = 12, drop_tag = "史莱姆" }
}
...
-- 装置
gadgets = {
	{ config_id = 1186, gadget_id = 70211012, pos = { x = 2492.125, y = 254.018, z = -334.232 }, rot = { x = 8.291, y = 108.112, z = 1.945 }, level = 20, drop_tag = "战斗中级蒙德", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, type = GadgetType.GADGET_WORLD_CHECT }
}

-- 区域
regions = {
	{ config_id = 227, shape = RegionShape.SPHERE, radius = 5, pos = { x = 2492.084, y = 254.726, z = -334.036 } }
}
