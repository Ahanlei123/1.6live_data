...
-- 装置
gadgets = {
	{ config_id = 353001, gadget_id = 70211101, pos = { x = 1662.737, y = 238.617, z = -1219.552 }, rot = { x = 2.089, y = 280.607, z = 358.571 }, level = 6, drop_tag = "解谜低级蒙德", state = GadgetState.ChestLocked, isOneoff = true, persistent = true },
	{ config_id = 353002, gadget_id = 70220021, pos = { x = 1662.150, y = 238.097, z = -1220.643 }, rot = { x = 0.000, y = 69.480, z = 0.000 }, level = 10, isOneoff = true, persistent = true }
}
