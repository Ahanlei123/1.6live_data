...
-- 怪物
monsters = {
	{ config_id = 818, monster_id = 20010501, pos = { x = 1839.395, y = 225.662, z = -1103.620 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 4 },
	{ config_id = 819, monster_id = 20010601, pos = { x = 1839.723, y = 225.855, z = -1108.029 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 4 },
	{ config_id = 820, monster_id = 20010501, pos = { x = 1835.868, y = 225.815, z = -1101.497 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 4 }
}
...
-- 区域
regions = {
	{ config_id = 192, shape = RegionShape.SPHERE, radius = 18.4, pos = { x = 1854.705, y = 228.858, z = -1104.124 } },
	{ config_id = 194, shape = RegionShape.SPHERE, radius = 18.4, pos = { x = 1999.210, y = 197.243, z = -1281.948 } },
	{ config_id = 195, shape = RegionShape.SPHERE, radius = 18.4, pos = { x = 2051.559, y = 199.907, z = -1207.692 } },
	{ config_id = 235, shape = RegionShape.SPHERE, radius = 18.4, pos = { x = 1600.378, y = 288.234, z = -1166.656 } },
	{ config_id = 236, shape = RegionShape.SPHERE, radius = 18.4, pos = { x = 1599.357, y = 288.069, z = -1221.863 } },
	{ config_id = 237, shape = RegionShape.SPHERE, radius = 18.4, pos = { x = 1469.641, y = 295.309, z = -1219.013 } },
	{ config_id = 238, shape = RegionShape.SPHERE, radius = 18.4, pos = { x = 1490.012, y = 303.372, z = -1158.811 } }
}
