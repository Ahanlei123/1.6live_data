...
-- 装置
gadgets = {
	{ config_id = 286001, gadget_id = 70710006, pos = { x = 2405.525, y = 283.187, z = -377.982 }, rot = { x = 6.789, y = 153.503, z = 343.795 }, level = 15, area_id = 3 },
	{ config_id = 286002, gadget_id = 70710010, pos = { x = 2347.163, y = 277.790, z = -383.505 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 20, route_id = 300400612, area_id = 3 },
	{ config_id = 286003, gadget_id = 70710007, pos = { x = 2404.970, y = 282.963, z = -378.439 }, rot = { x = 0.000, y = 258.519, z = 0.000 }, level = 15, area_id = 3 }
}

-- 区域
regions = {
	{ config_id = 286007, shape = RegionShape.SPHERE, radius = 3, pos = { x = 2347.127, y = 277.417, z = -383.925 }, area_id = 3 }
}
