...
-- 装置
gadgets = {
	{ config_id = 385001, gadget_id = 70360006, pos = { x = 291.705, y = 197.579, z = 1444.859 }, rot = { x = 2.932, y = 359.965, z = 358.620 }, level = 24, persistent = true },
	{ config_id = 385002, gadget_id = 70360006, pos = { x = 285.643, y = 193.036, z = 1449.560 }, rot = { x = 15.408, y = 0.356, z = 2.634 }, level = 24, persistent = true },
	{ config_id = 385004, gadget_id = 70211111, pos = { x = 291.872, y = 197.713, z = 1442.189 }, rot = { x = 2.932, y = 359.965, z = 358.620 }, level = 21, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, type = GadgetType.GADGET_WORLD_CHECT }
}
