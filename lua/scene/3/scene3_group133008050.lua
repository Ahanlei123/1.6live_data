...
-- 变量
variables = {
	{ name = "reach_point_count", value = 0, no_refresh = true },
	{ name = "option_50015_active", value = 0, no_refresh = true },
	{ name = "option_50016_active", value = 0, no_refresh = true },
	{ name = "option_50017_active", value = 0, no_refresh = true },
	{ name = "reach_point_count_option_50015", value = 0, no_refresh = true },
	{ name = "reach_point_count_option_50016", value = 0, no_refresh = true },
	{ name = "reach_point_count_option_50017", value = 0, no_refresh = true }
}
