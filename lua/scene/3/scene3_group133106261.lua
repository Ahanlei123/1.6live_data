...
-- 怪物
monsters = {
	{ config_id = 261001, monster_id = 28050201, pos = { x = -774.926, y = 173.261, z = 1036.311 }, rot = { x = 0.000, y = 290.498, z = 0.000 }, level = 32, drop_tag = "魔法生物", area_id = 8 },
	{ config_id = 261002, monster_id = 28050201, pos = { x = -784.252, y = 172.803, z = 1040.941 }, rot = { x = 0.000, y = 288.103, z = 0.000 }, level = 32, drop_tag = "魔法生物", pose_id = 3, area_id = 8 }
}
