...
-- 区域
regions = {
	{ config_id = 526002, shape = RegionShape.CUBIC, size = { x = 140.000, y = 30.000, z = 110.000 }, pos = { x = 972.177, y = 296.740, z = -947.870 }, area_id = 10, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE }
}
