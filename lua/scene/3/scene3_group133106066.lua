...
-- 装置
gadgets = {
	{ config_id = 66001, gadget_id = 70710006, pos = { x = -875.480, y = 203.770, z = 1270.273 }, rot = { x = 0.000, y = 91.509, z = 0.000 }, level = 32, area_id = 8 },
	{ config_id = 66002, gadget_id = 70710010, pos = { x = -860.891, y = 201.335, z = 1299.175 }, rot = { x = 0.000, y = 178.339, z = 0.000 }, level = 32, route_id = 310600023, area_id = 8 },
	{ config_id = 66003, gadget_id = 70710007, pos = { x = -875.421, y = 204.086, z = 1270.406 }, rot = { x = 0.000, y = 28.857, z = 0.000 }, level = 32, area_id = 8 },
	{ config_id = 66004, gadget_id = 70211111, pos = { x = -875.325, y = 203.828, z = 1268.919 }, rot = { x = 0.000, y = 178.339, z = 0.000 }, level = 26, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 8 }
}

-- 区域
regions = {
	{ config_id = 66007, shape = RegionShape.SPHERE, radius = 2.8, pos = { x = -861.002, y = 201.342, z = 1299.506 }, area_id = 8 }
}
