...
-- 装置
gadgets = {
	{ config_id = 176001, gadget_id = 70211121, pos = { x = -450.130, y = 203.733, z = -813.199 }, rot = { x = 0.037, y = 245.620, z = 351.119 }, level = 26, drop_tag = "解谜高级璃月", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 7 },
...
-- 变量
variables = {
	{ name = "fin", value = 0, no_refresh = true },
	{ name = "dig", value = 0, no_refresh = true }
}
