...
gadgets = {
	...
	{ config_id = 592010, gadget_id = 70211101, pos = { x = 826.298, y = 247.878, z = 975.505 }, rot = { x = 19.077, y = 72.631, z = 0.348 }, level = 21, drop_tag = "解谜低级璃月", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 6 },
