...
-- 怪物
monsters = {
	{ config_id = 416001, monster_id = 20010901, pos = { x = 150.609, y = 201.971, z = 1430.942 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 24, drop_tag = "史莱姆" }
}
...
-- 装置
gadgets = {
	{ config_id = 416002, gadget_id = 70510013, pos = { x = 150.609, y = 201.971, z = 1430.942 }, rot = { x = 0.000, y = 319.800, z = 0.000 }, level = 32, isOneoff = true, persistent = true },
	{ config_id = 416003, gadget_id = 70211101, pos = { x = 152.747, y = 200.694, z = 1428.351 }, rot = { x = 348.971, y = 0.199, z = 357.941 }, level = 21, drop_tag = "解谜低级璃月", showcutscene = true, isOneoff = true, persistent = true }
}
