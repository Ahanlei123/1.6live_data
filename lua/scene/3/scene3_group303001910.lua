...
-- 装置
gadgets = {
	{ config_id = 910001, gadget_id = 70300119, pos = { x = 1894.553, y = 202.519, z = -1255.419 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 5, persistent = true }
}
...
-- 触发器
triggers = {
	{ name = "QUEST_FINISH_910002", event = EventType.EVENT_QUEST_FINISH, source = "39607", condition = "condition_EVENT_QUEST_FINISH_910002", action = "action_EVENT_QUEST_FINISH_910002", trigger_count = 0 },
	{ name = "GROUP_REFRESH_910003", event = EventType.EVENT_GROUP_REFRESH, source = "", condition = "", action = "action_EVENT_GROUP_REFRESH_910003", trigger_count = 0 }
}
