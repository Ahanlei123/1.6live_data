...
-- 区域
regions = {
	{ config_id = 559, shape = RegionShape.SPHERE, radius = 5, pos = { x = 2135.032, y = 207.197, z = -1168.102 }, area_id = 1 }
}

-- 触发器
triggers = {
	{ config_id = 1000559, name = "ENTER_REGION_559", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_559", action = "", trigger_count = 0 }
}
