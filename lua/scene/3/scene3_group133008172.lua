...
-- 装置
gadgets = {
	{ config_id = 172001, gadget_id = 70360001, pos = { x = 1079.287, y = 340.048, z = -514.302 }, rot = { x = 0.000, y = 9.315, z = 0.000 }, level = 30, isOneoff = true, persistent = true, area_id = 10 },
	{ config_id = 172002, gadget_id = 70211111, pos = { x = 1077.846, y = 339.049, z = -513.868 }, rot = { x = 355.965, y = 112.273, z = 4.392 }, level = 26, drop_tag = "雪山解谜中级蒙德", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 10 },
	{ config_id = 172006, gadget_id = 70220041, pos = { x = 1078.641, y = 339.058, z = -513.169 }, rot = { x = 353.406, y = 147.812, z = 6.219 }, level = 30, area_id = 10 }
}
...
function action_EVENT_SELECT_OPTION_172004(context, evt)
	-- 删除指定group： 133008172 ；指定config：172001；物件身上指定option：169；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 133008172, 172001, 169) then
	...
	-- 运营数据埋点，匹配LD定义的规则使用
		...
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 133008172, suite = 2 }) then
