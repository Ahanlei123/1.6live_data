...
gadgets = {
	...
	{ config_id = 457003, gadget_id = 70211001, pos = { x = 519.523, y = 173.112, z = 1090.769 }, rot = { x = 5.356, y = 270.038, z = 0.003 }, level = 21, drop_tag = "战斗低级璃月", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 6 }
}
