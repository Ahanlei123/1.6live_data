...
-- 怪物
monsters = {
	{ config_id = 907002, monster_id = 28020505, pos = { x = -504.972, y = 227.682, z = 433.338 }, rot = { x = 0.000, y = 158.185, z = 0.000 }, level = 18, drop_tag = "走兽", disableWander = true, pose_id = 12, area_id = 7 },
