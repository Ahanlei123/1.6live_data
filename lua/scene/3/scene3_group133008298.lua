...
gadgets = {
	...
	{ config_id = 298032, gadget_id = 70690001, pos = { x = 824.927, y = 358.802, z = -937.494 }, rot = { x = 90.000, y = 317.334, z = 0.000 }, level = 32, area_id = 10 },
	{ config_id = 298033, gadget_id = 70690001, pos = { x = 824.927, y = 349.962, z = -937.494 }, rot = { x = 89.980, y = 317.334, z = 0.000 }, level = 32, area_id = 10 },
	{ config_id = 298034, gadget_id = 70690001, pos = { x = 824.927, y = 335.193, z = -937.494 }, rot = { x = 90.000, y = 317.334, z = 0.000 }, level = 32, area_id = 10 },
	{ config_id = 298035, gadget_id = 70690001, pos = { x = 824.927, y = 324.256, z = -937.494 }, rot = { x = 89.980, y = 317.334, z = 0.000 }, level = 32, area_id = 10 },
	{ config_id = 298036, gadget_id = 70690001, pos = { x = 824.927, y = 314.697, z = -937.494 }, rot = { x = 90.000, y = 317.334, z = 0.000 }, level = 32, area_id = 10 },
	{ config_id = 298037, gadget_id = 70690001, pos = { x = 824.927, y = 304.360, z = -937.494 }, rot = { x = 89.980, y = 317.334, z = 0.000 }, level = 32, area_id = 10 },
...
triggers = {
	...
	{ config_id = 1298046, name = "GADGET_CREATE_298046", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_298046", action = "action_EVENT_GADGET_CREATE_298046" }
}
...
suites = {
	{
		...
		gadgets = { 298038 },
		regions = { 298039 },
		triggers = { "ENTER_REGION_298039", "ANY_GADGET_DIE_298040", "GADGET_CREATE_298046" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_GADGET_DIE_298040(context, evt)
	...
	-- 创建id为298039的gadget
	if 0 ~= ScriptLib.CreateGadget(context, { config_id = 298039 }) then
...
-- 触发条件
function condition_EVENT_GADGET_CREATE_298046(context, evt)
	if 298039 ~= evt.param1 or GadgetState.Default ~= ScriptLib.GetGadgetStateByConfigId(context, 0, evt.param1) then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_CREATE_298046(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 133008298, 298039, {38}) then
