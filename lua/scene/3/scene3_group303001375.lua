...
-- 怪物
monsters = {
	{ config_id = 375001, monster_id = 21010301, pos = { x = 1557.233, y = 265.541, z = -1325.627 }, rot = { x = 0.000, y = 128.410, z = 0.000 }, level = 2 },
	{ config_id = 375002, monster_id = 21010301, pos = { x = 1552.555, y = 263.838, z = -1332.600 }, rot = { x = 0.000, y = 73.870, z = 0.000 }, level = 2 },
	{ config_id = 375003, monster_id = 21010201, pos = { x = 1566.437, y = 266.047, z = -1324.136 }, rot = { x = 0.000, y = 218.245, z = 0.000 }, level = 1 },
	{ config_id = 375018, monster_id = 21010501, pos = { x = 1567.429, y = 265.354, z = -1327.736 }, rot = { x = 0.000, y = 231.941, z = 0.000 }, level = 2 },
	{ config_id = 375019, monster_id = 21010201, pos = { x = 1566.687, y = 264.831, z = -1332.055 }, rot = { x = 0.000, y = 254.666, z = 0.000 }, level = 1 },
	{ config_id = 375020, monster_id = 21020201, pos = { x = 1562.558, y = 263.775, z = -1337.763 }, rot = { x = 0.000, y = 337.000, z = 0.000 }, level = 3, isElite = true },
	{ config_id = 375022, monster_id = 21020201, pos = { x = 1558.772, y = 263.604, z = -1337.646 }, rot = { x = 0.000, y = 9.900, z = 0.000 }, level = 3, isElite = true }
}
...
-- 装置
gadgets = {
	{ config_id = 375004, gadget_id = 70360056, pos = { x = 1560.575, y = 264.411, z = -1332.052 }, rot = { x = 0.000, y = 359.836, z = 0.000 }, level = 1, persistent = true },
	{ config_id = 375005, gadget_id = 70360057, pos = { x = 1560.575, y = 264.411, z = -1332.052 }, rot = { x = 0.000, y = 359.836, z = 0.000 }, level = 1, persistent = true },
	{ config_id = 375006, gadget_id = 70210106, pos = { x = 1561.010, y = 264.503, z = -1331.665 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, chest_drop_id = 1000100, drop_count = 1, showcutscene = true, persistent = true, is_blossom_chest = true }
}
...
triggers = {
	...
	{ name = "GADGET_STATE_CHANGE_375008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_375008", action = "action_EVENT_GADGET_STATE_CHANGE_375008", trigger_count = 0 },
	{ name = "GADGET_CREATE_375009", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_375009", action = "action_EVENT_GADGET_CREATE_375009", trigger_count = 0 },
	{ name = "GROUP_REFRESH_375010", event = EventType.EVENT_GROUP_REFRESH, source = "", condition = "", action = "action_EVENT_GROUP_REFRESH_375010" },
	{ name = "BLOSSOM_CHEST_DIE_375011", event = EventType.EVENT_BLOSSOM_CHEST_DIE, source = "", condition = "condition_EVENT_BLOSSOM_CHEST_DIE_375011", action = "action_EVENT_BLOSSOM_CHEST_DIE_375011", trigger_count = 0 },
	{ name = "GADGET_CREATE_375012", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_375012", action = "action_EVENT_GADGET_CREATE_375012", trigger_count = 0 },
	{ name = "SELECT_OPTION_375013", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_375013", action = "action_EVENT_SELECT_OPTION_375013", trigger_count = 0 },
	{ name = "SELECT_OPTION_375014", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_375014", action = "action_EVENT_SELECT_OPTION_375014", trigger_count = 0 },
	{ name = "ANY_MONSTER_DIE_375015", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "", action = "action_EVENT_ANY_MONSTER_DIE_375015", trigger_count = 0 },
	{ name = "BLOSSOM_PROGRESS_FINISH_375016", event = EventType.EVENT_BLOSSOM_PROGRESS_FINISH, source = "", condition = "", action = "action_EVENT_BLOSSOM_PROGRESS_FINISH_375016" },
	{ name = "GROUP_LOAD_375017", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_375017" },
	{ name = "ANY_MONSTER_DIE_375021", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_375021", action = "action_EVENT_ANY_MONSTER_DIE_375021" }
}
