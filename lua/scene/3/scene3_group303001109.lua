...
-- 装置
gadgets = {
	{ config_id = 1781, gadget_id = 70210051, pos = { x = 1372.863, y = 235.803, z = -1569.772 }, rot = { x = 0.000, y = 48.720, z = 0.000 }, level = 11, chest_drop_id = 2001000, drop_count = 1, state = GadgetState.ChestLocked, isOneoff = true, persistent = true }
}
