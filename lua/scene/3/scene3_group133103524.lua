...
-- 装置
gadgets = {
	{ config_id = 524001, gadget_id = 70500000, pos = { x = 360.774, y = 266.681, z = 1629.963 }, rot = { x = 0.232, y = 3.352, z = 356.270 }, level = 1, point_type = 1003, persistent = true, area_id = 6 },
