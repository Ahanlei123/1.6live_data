...
-- 装置
gadgets = {
	{ config_id = 350001, gadget_id = 70211112, pos = { x = 1325.448, y = 282.397, z = -1788.052 }, rot = { x = 0.000, y = 81.047, z = 0.000 }, level = 11, drop_tag = "解谜中级蒙德", state = GadgetState.ChestLocked, isOneoff = true, persistent = true }
}
