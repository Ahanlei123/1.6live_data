...
-- 装置
gadgets = {
	{ config_id = 208001, gadget_id = 70211101, pos = { x = 996.936, y = 329.156, z = 1503.916 }, rot = { x = 0.212, y = 47.552, z = 356.994 }, level = 21, drop_tag = "解谜低级璃月", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 6 },
	{ config_id = 208002, gadget_id = 70220021, pos = { x = 997.108, y = 327.783, z = 1504.104 }, rot = { x = 0.000, y = 176.729, z = 0.000 }, level = 24, isOneoff = true, persistent = true, oneoff_reset_version = 2, area_id = 6 }
}
