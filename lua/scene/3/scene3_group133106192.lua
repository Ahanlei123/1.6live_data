...
gadgets = {
	...
	{ config_id = 192002, gadget_id = 70211111, pos = { x = -438.024, y = 233.373, z = 793.277 }, rot = { x = 12.056, y = 89.901, z = 2.685 }, level = 26, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 8 }
}
