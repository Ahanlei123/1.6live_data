...
-- 装置
gadgets = {
	{ config_id = 159001, gadget_id = 70710006, pos = { x = 2016.418, y = 196.432, z = -1233.761 }, rot = { x = 0.000, y = 186.288, z = 0.000 }, level = 5, area_id = 2 },
	{ config_id = 159002, gadget_id = 70710010, pos = { x = 2045.764, y = 199.601, z = -1192.053 }, rot = { x = 0.000, y = 104.200, z = 0.000 }, level = 5, route_id = 300100233, area_id = 2 },
	{ config_id = 159003, gadget_id = 70710007, pos = { x = 2017.295, y = 196.471, z = -1232.779 }, rot = { x = 0.000, y = 31.390, z = 0.000 }, level = 5, area_id = 2 },
	{ config_id = 159004, gadget_id = 70211111, pos = { x = 2016.391, y = 196.394, z = -1232.319 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "解谜中级蒙德", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 2 }
}

-- 区域
regions = {
	{ config_id = 159007, shape = RegionShape.SPHERE, radius = 4, pos = { x = 2048.773, y = 198.394, z = -1192.679 }, area_id = 2 }
}
