...
variables = {
	...
	{ name = "418009_Hit_Uid", value = 0, no_refresh = true },
	{ name = "418010_Hit_Uid", value = 0, no_refresh = true },
	{ name = "418011_Hit_Uid", value = 0, no_refresh = true },
	{ name = "isStarted", value = 0, no_refresh = false },
	{ name = "phaseonecheckvalue", value = 0, no_refresh = false },
	{ name = "phasetwocheckvalue", value = 0, no_refresh = false }
}
