...
-- 区域
regions = {
	[788170] = { config_id = 788170, shape = RegionShape.SPHERE, radius = 100, pos = { x = 2880.511, y = 270.615, z = -1844.424 }, area_id = 1, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE }
}
