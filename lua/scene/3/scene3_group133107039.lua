...
-- 装置
gadgets = {
	{ config_id = 39001, gadget_id = 70211101, pos = { x = -528.358, y = 359.819, z = 643.736 }, rot = { x = 349.804, y = 335.547, z = 352.817 }, level = 21, drop_tag = "解谜低级璃月", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 7 },
	{ config_id = 39002, gadget_id = 70220021, pos = { x = -528.730, y = 358.485, z = 643.120 }, rot = { x = 0.000, y = 145.800, z = 0.000 }, level = 24, isOneoff = true, persistent = true, oneoff_reset_version = 2, area_id = 7 }
}
