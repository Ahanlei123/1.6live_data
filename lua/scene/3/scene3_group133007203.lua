...
-- 装置
gadgets = {
	{ config_id = 203001, gadget_id = 70710006, pos = { x = 2517.954, y = 211.009, z = 330.478 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 23, area_id = 4 },
	{ config_id = 203002, gadget_id = 70710010, pos = { x = 2548.635, y = 219.638, z = 370.398 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 23, route_id = 300700119, area_id = 4 },
	{ config_id = 203003, gadget_id = 70710007, pos = { x = 2519.270, y = 211.316, z = 332.242 }, rot = { x = 351.148, y = 30.408, z = 352.271 }, level = 23, area_id = 4 },
	{ config_id = 203004, gadget_id = 70211111, pos = { x = 2520.289, y = 210.676, z = 329.195 }, rot = { x = 349.642, y = 0.202, z = 357.767 }, level = 21, drop_tag = "解谜中级蒙德", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 4 }
}

-- 区域
regions = {
	{ config_id = 203007, shape = RegionShape.SPHERE, radius = 3, pos = { x = 2547.971, y = 219.569, z = 370.021 }, area_id = 4 }
}
...
function action_EVENT_ENTER_REGION_203007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 203002, 300700118) then
...
function action_EVENT_GADGET_STATE_CHANGE_203008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133007203, 2) then
