...
-- 怪物
monsters = {
	{ config_id = 73001, monster_id = 28050202, pos = { x = -113.772, y = 200.508, z = -713.892 }, rot = { x = 0.000, y = 146.791, z = 0.000 }, level = 32, drop_tag = "魔法生物", area_id = 7 },
	{ config_id = 73002, monster_id = 28050202, pos = { x = -102.993, y = 200.300, z = -727.710 }, rot = { x = 0.000, y = 149.896, z = 0.000 }, level = 32, drop_tag = "魔法生物", pose_id = 3, area_id = 7 }
}
...
-- 装置
gadgets = {
	{ config_id = 73003, gadget_id = 70360027, pos = { x = -102.889, y = 200.259, z = -727.656 }, rot = { x = 357.404, y = 104.143, z = 355.665 }, level = 32, mark_flag = 3, area_id = 7 },
	{ config_id = 73004, gadget_id = 70360015, pos = { x = -113.478, y = 200.419, z = -713.777 }, rot = { x = 0.489, y = 15.136, z = 8.418 }, level = 32, mark_flag = 2, area_id = 7 }
}
...
-- 触发器
triggers = {
	{ config_id = 1073005, name = "ANY_MONSTER_DIE_73005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_73005", action = "action_EVENT_ANY_MONSTER_DIE_73005" },
	{ config_id = 1073006, name = "SELECT_OPTION_73006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_73006", action = "action_EVENT_SELECT_OPTION_73006", trigger_count = 0 },
	...
	{ config_id = 1073008, name = "GADGET_STATE_CHANGE_73008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_73008", action = "action_EVENT_GADGET_STATE_CHANGE_73008", trigger_count = 0 },
	{ config_id = 1073009, name = "GROUP_LOAD_73009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_73009", action = "action_EVENT_GROUP_LOAD_73009", trigger_count = 0 },
	{ config_id = 1073010, name = "GROUP_LOAD_73010", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_73010", action = "action_EVENT_GROUP_LOAD_73010", trigger_count = 0 }
}
...
suites = {
	{
		...
		gadgets = { 73003, 73004 },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_73005", "SELECT_OPTION_73006", "GADGET_STATE_CHANGE_73007", "GADGET_STATE_CHANGE_73008", "GROUP_LOAD_73009", "GROUP_LOAD_73010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_73009(context, evt)
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_73010(context, evt)
...
-- 触发操作
function action_EVENT_GROUP_LOAD_73010(context, evt)
	-- 将configid为 73004 的物件更改为状态 GadgetState.GearAction1
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 73004, GadgetState.GearAction1) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
