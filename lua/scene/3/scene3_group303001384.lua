...
-- 触发器
triggers = {
	{ name = "QUEST_START_384001", event = EventType.EVENT_QUEST_START, source = "2070002", condition = "", action = "action_EVENT_QUEST_START_384001" },
	{ name = "TIMER_EVENT_384002", event = EventType.EVENT_TIMER_EVENT, source = "1330013842", condition = "", action = "action_EVENT_TIMER_EVENT_384002" }
}
