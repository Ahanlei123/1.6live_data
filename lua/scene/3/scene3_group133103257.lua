...
-- 装置
gadgets = {
	{ config_id = 257001, gadget_id = 70211101, pos = { x = 1049.803, y = 309.410, z = 1263.212 }, rot = { x = 337.728, y = 232.551, z = 342.653 }, level = 21, drop_tag = "解谜低级璃月", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 6 },
	{ config_id = 257002, gadget_id = 70220021, pos = { x = 1049.825, y = 310.019, z = 1263.069 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 24, isOneoff = true, persistent = true, oneoff_reset_version = 2, area_id = 6 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_GADGET_DIE_257003", "GADGET_STATE_CHANGE_257004" },
		rand_weight = 100
	}
}
...
function condition_EVENT_GADGET_STATE_CHANGE_257004(context, evt)
	if 257001 ~= evt.param2 or GadgetState.ChestOpened ~= evt.param1 then
		return false
	end
