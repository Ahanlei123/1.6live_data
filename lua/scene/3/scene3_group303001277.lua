...
-- 装置
gadgets = {
	{ config_id = 277001, gadget_id = 70211101, pos = { x = 2149.881, y = 205.348, z = -1736.447 }, rot = { x = 0.000, y = 230.283, z = 0.000 }, level = 11, drop_tag = "解谜低级蒙德", state = GadgetState.ChestLocked, isOneoff = true, persistent = true },
	{ config_id = 277002, gadget_id = 70220021, pos = { x = 2148.727, y = 205.171, z = -1736.511 }, rot = { x = 0.000, y = 45.825, z = 0.000 }, level = 15, isOneoff = true, persistent = true }
}
