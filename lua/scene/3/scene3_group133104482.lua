...
monsters = {
	...
	{ config_id = 482006, monster_id = 21010301, pos = { x = 235.771, y = 238.041, z = 971.490 }, rot = { x = 4.203, y = 271.202, z = 18.406 }, level = 19, drop_tag = "丘丘人", disableWander = true, pose_id = 9003, area_id = 6 }
}
