...
-- 区域
regions = {
	{ config_id = 904001, shape = RegionShape.SPHERE, radius = 20, pos = { x = 775.572, y = 322.386, z = 1524.591 }, area_id = 6 }
}

-- 触发器
triggers = {
	{ config_id = 1904001, name = "ENTER_REGION_904001", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_904001", action = "", trigger_count = 0 }
}
