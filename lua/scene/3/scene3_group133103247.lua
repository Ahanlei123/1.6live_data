...
-- 怪物
monsters = {
	{ config_id = 247001, monster_id = 20011301, pos = { x = 876.830, y = 224.951, z = 1224.243 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 24, drop_tag = "大史莱姆", area_id = 6 },
	{ config_id = 247002, monster_id = 20011301, pos = { x = 877.092, y = 224.424, z = 1221.360 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 24, drop_tag = "大史莱姆", area_id = 6 }
}
...
-- 区域
regions = {
	{ config_id = 247004, shape = RegionShape.SPHERE, radius = 5, pos = { x = 876.820, y = 224.573, z = 1223.041 }, area_id = 6 }
}
