...
-- 装置
gadgets = {
	{ config_id = 322001, gadget_id = 70620002, pos = { x = 1430.324, y = 260.256, z = -1694.814 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 10, isOneoff = true, persistent = true },
	{ config_id = 322002, gadget_id = 70211101, pos = { x = 1430.324, y = 260.112, z = -1694.813 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 11, drop_tag = "解谜低级蒙德", state = GadgetState.ChestLocked, isOneoff = true, persistent = true }
}
...
triggers = {
	...
	{ name = "GADGET_STATE_CHANGE_322004", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_322004", action = "action_EVENT_GADGET_STATE_CHANGE_322004" },
