...
gadgets = {
	...
	[460002] = { config_id = 460002, gadget_id = 70350173, pos = { x = 2527.522, y = 278.348, z = -270.491 }, rot = { x = 0.000, y = 91.534, z = 0.000 }, level = 20, is_use_point_array = true, area_id = 4 },
	[460003] = { config_id = 460003, gadget_id = 70350173, pos = { x = 2527.572, y = 282.169, z = -268.637 }, rot = { x = 0.000, y = 91.534, z = 0.000 }, level = 20, is_use_point_array = true, area_id = 4 },
	[460004] = { config_id = 460004, gadget_id = 70350173, pos = { x = 2527.457, y = 282.169, z = -272.924 }, rot = { x = 0.000, y = 91.534, z = 0.000 }, level = 20, is_use_point_array = true, area_id = 4 },
...
-- 区域
regions = {
	[460151] = { config_id = 460151, shape = RegionShape.SPHERE, radius = 100, pos = { x = 2559.676, y = 263.147, z = -272.421 }, area_id = 4, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE }
}
