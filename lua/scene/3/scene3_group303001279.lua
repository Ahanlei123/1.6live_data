...
-- 装置
gadgets = {
	{ config_id = 279001, gadget_id = 70211101, pos = { x = 1687.495, y = 220.083, z = -1483.990 }, rot = { x = 0.000, y = 115.354, z = 0.000 }, level = 1, drop_tag = "解谜低级蒙德", state = GadgetState.ChestLocked, isOneoff = true, persistent = true },
	{ config_id = 279002, gadget_id = 70220021, pos = { x = 1688.010, y = 218.453, z = -1484.280 }, rot = { x = 0.000, y = 276.288, z = 0.000 }, level = 5, isOneoff = true, persistent = true }
}
