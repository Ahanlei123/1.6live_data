...
gadgets = {
	...
	{ config_id = 511006, gadget_id = 70211112, pos = { x = 2001.311, y = 221.375, z = -1568.719 }, rot = { x = 0.000, y = 4.215, z = 0.000 }, level = 1, drop_tag = "解谜中级蒙德", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 1 }
}
