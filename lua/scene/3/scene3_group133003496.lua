...
-- 区域
regions = {
	{ config_id = 496001, shape = RegionShape.SPHERE, radius = 15, pos = { x = 2548.024, y = 214.075, z = -1115.929 }, area_id = 1 }
}
...
function action_EVENT_ENTER_REGION_496001(context, evt)
	...
	if 0 ~= ScriptLib.AddQuestProgress(context, "133003496") then
