...
-- 怪物
monsters = {
	{ config_id = 403001, monster_id = 26010101, pos = { x = 2048.245, y = 224.250, z = -1581.644 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 5 }
}
...
-- 装置
gadgets = {
	{ config_id = 403002, gadget_id = 70510014, pos = { x = 2048.273, y = 224.262, z = -1581.630 }, rot = { x = 0.000, y = 319.800, z = 0.000 }, level = 5, isOneoff = true, persistent = true }
}
...
-- 触发器
triggers = {
	{ name = "GADGET_STATE_CHANGE_403003", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_403003", action = "action_EVENT_GADGET_STATE_CHANGE_403003", trigger_count = 0 },
	{ name = "ANY_MONSTER_DIE_403004", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_403004", action = "action_EVENT_ANY_MONSTER_DIE_403004" },
	{ name = "GADGET_CREATE_403005", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_403005", action = "action_EVENT_GADGET_CREATE_403005", trigger_count = 0 },
	{ name = "SELECT_OPTION_403006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_403006", action = "action_EVENT_SELECT_OPTION_403006", trigger_count = 0 }
}
