...
-- 装置
gadgets = {
	{ config_id = 129001, gadget_id = 70710006, pos = { x = 1384.499, y = 233.793, z = -1515.541 }, rot = { x = 0.000, y = 55.491, z = 0.000 }, level = 15 },
	{ config_id = 129002, gadget_id = 70710010, pos = { x = 1361.132, y = 241.567, z = -1520.059 }, rot = { x = 0.000, y = 78.510, z = 0.000 }, level = 15, route_id = 300100231 },
	{ config_id = 129003, gadget_id = 70710007, pos = { x = 1383.712, y = 233.845, z = -1515.983 }, rot = { x = 0.000, y = 246.015, z = 0.000 }, level = 15 }
}

-- 区域
regions = {
	{ config_id = 129007, shape = RegionShape.SPHERE, radius = 2, pos = { x = 1363.151, y = 241.880, z = -1520.220 } }
}
