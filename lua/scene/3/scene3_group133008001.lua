...
-- 区域
regions = {
	{ config_id = 1001, shape = RegionShape.SPHERE, radius = 7.9, pos = { x = 1306.630, y = 275.381, z = -801.780 }, area_id = 10 }
}
...
function action_EVENT_ENTER_REGION_1001(context, evt)
	...
	if 0 ~= ScriptLib.AddQuestProgress(context, "701020501") then
