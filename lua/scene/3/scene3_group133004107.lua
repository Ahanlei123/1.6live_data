...
-- 装置
gadgets = {
	{ config_id = 107001, gadget_id = 70710006, pos = { x = 2413.131, y = 299.035, z = -246.919 }, rot = { x = 5.984, y = 0.345, z = 6.592 }, level = 20, area_id = 3 },
	{ config_id = 107002, gadget_id = 70710010, pos = { x = 2373.783, y = 315.847, z = -176.589 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 20, route_id = 300400616, area_id = 3 },
	{ config_id = 107003, gadget_id = 70710007, pos = { x = 2412.780, y = 298.926, z = -246.271 }, rot = { x = 8.613, y = 326.937, z = 2.224 }, level = 20, area_id = 3 },
	{ config_id = 107004, gadget_id = 70211111, pos = { x = 2415.255, y = 299.070, z = -239.905 }, rot = { x = 352.829, y = 171.938, z = 348.609 }, level = 16, drop_tag = "解谜中级蒙德", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 3 }
}

-- 区域
regions = {
	{ config_id = 107007, shape = RegionShape.SPHERE, radius = 2, pos = { x = 2373.939, y = 315.659, z = -176.675 }, area_id = 3 }
}
