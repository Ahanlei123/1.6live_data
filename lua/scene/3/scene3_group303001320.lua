...
-- 装置
gadgets = {
	{ config_id = 320001, gadget_id = 70620002, pos = { x = 1662.330, y = 232.868, z = -1172.878 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 10, isOneoff = true, persistent = true },
	{ config_id = 320002, gadget_id = 70211101, pos = { x = 1662.331, y = 232.327, z = -1172.877 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 6, drop_tag = "解谜低级蒙德", state = GadgetState.ChestLocked, isOneoff = true, persistent = true }
}
...
triggers = {
	...
	{ name = "GADGET_STATE_CHANGE_320004", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_320004", action = "action_EVENT_GADGET_STATE_CHANGE_320004" },
