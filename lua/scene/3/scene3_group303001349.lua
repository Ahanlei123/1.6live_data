...
-- 装置
gadgets = {
	{ config_id = 349001, gadget_id = 70710006, pos = { x = 1537.777, y = 333.746, z = -2087.571 }, rot = { x = 4.620, y = 25.349, z = 1.166 }, level = 15 },
	{ config_id = 349002, gadget_id = 70710010, pos = { x = 1516.301, y = 353.590, z = -2067.298 }, rot = { x = 0.000, y = 84.816, z = 0.000 }, level = 15, route_id = 300100244 },
	{ config_id = 349003, gadget_id = 70710007, pos = { x = 1536.952, y = 333.765, z = -2087.241 }, rot = { x = 0.000, y = 277.731, z = 0.000 }, level = 15 }
}

-- 区域
regions = {
	{ config_id = 349007, shape = RegionShape.SPHERE, radius = 5, pos = { x = 1519.968, y = 352.979, z = -2067.354 } }
}
