...
-- 怪物
monsters = {
	{ config_id = 119001, monster_id = 28050201, pos = { x = -50.732, y = 4.082, z = -506.198 }, rot = { x = 0.000, y = 29.457, z = 0.000 }, level = 32, drop_tag = "魔法生物", area_id = 7 },
	{ config_id = 119002, monster_id = 28050201, pos = { x = -47.840, y = 4.076, z = -501.426 }, rot = { x = 0.000, y = 29.457, z = 0.000 }, level = 32, drop_tag = "魔法生物", pose_id = 3, area_id = 7 }
}
...
-- 装置
gadgets = {
	{ config_id = 119003, gadget_id = 70360027, pos = { x = -47.737, y = 4.000, z = -501.583 }, rot = { x = 0.000, y = 104.100, z = 0.000 }, level = 32, persistent = true, area_id = 7 },
	{ config_id = 119004, gadget_id = 70360015, pos = { x = -50.437, y = 4.000, z = -506.083 }, rot = { x = 0.000, y = 15.100, z = 0.000 }, level = 32, persistent = true, area_id = 7 }
}
...
-- 触发器
triggers = {
	{ config_id = 1119005, name = "ANY_MONSTER_DIE_119005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_119005", action = "action_EVENT_ANY_MONSTER_DIE_119005" },
	{ config_id = 1119006, name = "SELECT_OPTION_119006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_119006", action = "action_EVENT_SELECT_OPTION_119006", trigger_count = 0 },
	{ config_id = 1119007, name = "GADGET_STATE_CHANGE_119007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_119007", action = "action_EVENT_GADGET_STATE_CHANGE_119007", trigger_count = 0 },
	{ config_id = 1119008, name = "GADGET_STATE_CHANGE_119008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_119008", action = "action_EVENT_GADGET_STATE_CHANGE_119008", trigger_count = 0 },
	{ config_id = 1119009, name = "GADGET_CREATE_119009", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_119009", action = "action_EVENT_GADGET_CREATE_119009", trigger_count = 0 },
