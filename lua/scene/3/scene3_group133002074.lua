...
gadgets = {
	...
	{ config_id = 74003, gadget_id = 70500000, pos = { x = 1627.557, y = 266.352, z = -440.195 }, rot = { x = 0.000, y = 123.547, z = 0.000 }, level = 10, point_type = 4001001, isOneoff = true, area_id = 3 }
}
