...
-- 装置
gadgets = {
	{ config_id = 455001, gadget_id = 70211101, pos = { x = -3.444, y = 202.492, z = 609.960 }, rot = { x = 358.217, y = 0.090, z = 355.532 }, level = 16, drop_tag = "解谜低级璃月", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 9 },
