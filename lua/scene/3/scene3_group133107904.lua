...
-- 怪物
monsters = {
	{ config_id = 904001, monster_id = 28030301, pos = { x = -552.835, y = 240.054, z = 320.032 }, rot = { x = 0.000, y = 354.890, z = 0.000 }, level = 18, drop_tag = "鸟类", disableWander = true, pose_id = 2, area_id = 7 },
	{ config_id = 904003, monster_id = 28030305, pos = { x = -552.032, y = 240.054, z = 320.980 }, rot = { x = 0.000, y = 171.818, z = 0.000 }, level = 18, drop_tag = "鸟类", disableWander = true, pose_id = 2, area_id = 7 }
}
