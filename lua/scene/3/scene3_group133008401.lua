...
variables = {
	...
	{ name = "Aout", value = 0, no_refresh = false },
	{ name = "Bout", value = 0, no_refresh = false },
	{ name = "Cout", value = 0, no_refresh = false },
	{ name = "Dout", value = 0, no_refresh = false },
	{ name = "First", value = 0, no_refresh = false },
	{ name = "X", value = 0, no_refresh = false },
	{ name = "Y", value = 0, no_refresh = false },
	{ name = "Z", value = 0, no_refresh = false }
}
