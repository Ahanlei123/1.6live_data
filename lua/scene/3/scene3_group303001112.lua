...
-- 怪物
monsters = {
	{ config_id = 544, monster_id = 20020101, pos = { x = 1331.750, y = 303.394, z = -1867.122 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 22, isOneoff = true }
}
...
-- 区域
regions = {
	{ config_id = 101, shape = RegionShape.SPHERE, radius = 31.8, pos = { x = 1339.578, y = 299.389, z = -1861.089 } }
}
