...
-- 装置
gadgets = {
	{ config_id = 925, gadget_id = 70211101, pos = { x = 1995.391, y = 210.900, z = -72.186 }, rot = { x = 0.000, y = 90.479, z = 0.000 }, level = 16, drop_tag = "解谜低级蒙德", isOneoff = true, persistent = true, type = GadgetType.GADGET_WORLD_CHECT },
	{ config_id = 926, gadget_id = 70220021, pos = { x = 1996.853, y = 209.672, z = -72.838 }, rot = { x = 0.000, y = 271.079, z = 0.000 }, level = 15, isOneoff = true }
}
