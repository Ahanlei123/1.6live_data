...
-- 装置
gadgets = {
	{ config_id = 344001, gadget_id = 70710006, pos = { x = 1389.419, y = 233.725, z = -1516.545 }, rot = { x = 0.000, y = 299.362, z = 0.000 }, level = 15 },
	{ config_id = 344002, gadget_id = 70710010, pos = { x = 1416.367, y = 241.419, z = -1540.498 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 15, route_id = 300100227 },
	{ config_id = 344003, gadget_id = 70710007, pos = { x = 1389.828, y = 233.767, z = -1517.056 }, rot = { x = 0.000, y = 148.000, z = 0.000 }, level = 15 }
}

-- 区域
regions = {
	{ config_id = 344007, shape = RegionShape.SPHERE, radius = 2, pos = { x = 1416.236, y = 241.933, z = -1539.431 } }
}
