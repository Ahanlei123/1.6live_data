...
-- 区域
regions = {
	{ config_id = 650001, shape = RegionShape.SPHERE, radius = 45, pos = { x = 1560.412, y = 237.188, z = 471.907 }, area_id = 5 },
	{ config_id = 650002, shape = RegionShape.SPHERE, radius = 15, pos = { x = 1603.036, y = 259.583, z = 317.936 }, area_id = 5 }
}

-- 触发器
triggers = {
	{ config_id = 1650001, name = "ENTER_REGION_650001", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_650001", action = "action_EVENT_ENTER_REGION_650001" },
