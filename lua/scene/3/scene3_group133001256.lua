...
-- 装置
gadgets = {
	{ config_id = 256001, gadget_id = 70710006, pos = { x = 1663.476, y = 266.510, z = -1294.355 }, rot = { x = 0.000, y = 66.616, z = 0.000 }, level = 10, area_id = 2 },
	{ config_id = 256002, gadget_id = 70710010, pos = { x = 1636.138, y = 247.626, z = -1296.091 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 10, route_id = 300100235, area_id = 2 },
	{ config_id = 256003, gadget_id = 70710007, pos = { x = 1662.546, y = 266.538, z = -1294.557 }, rot = { x = 0.000, y = 273.565, z = 0.000 }, level = 10, area_id = 2 },
	{ config_id = 256004, gadget_id = 70211111, pos = { x = 1665.207, y = 266.466, z = -1293.300 }, rot = { x = 359.031, y = 52.654, z = 351.008 }, level = 6, drop_tag = "解谜中级蒙德", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 2 }
}

-- 区域
regions = {
	{ config_id = 256007, shape = RegionShape.SPHERE, radius = 4, pos = { x = 1636.343, y = 247.616, z = -1294.651 }, area_id = 2 }
}

-- 触发器
triggers = {
	{ config_id = 1256005, name = "PLATFORM_REACH_POINT_256005", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_256005", action = "action_EVENT_PLATFORM_REACH_POINT_256005", trigger_count = 0 },
	{ config_id = 1256006, name = "AVATAR_NEAR_PLATFORM_256006", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_256006", action = "action_EVENT_AVATAR_NEAR_PLATFORM_256006", trigger_count = 0 },
	{ config_id = 1256007, name = "ENTER_REGION_256007", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_256007", action = "action_EVENT_ENTER_REGION_256007", trigger_count = 0 },
	{ config_id = 1256008, name = "GADGET_STATE_CHANGE_256008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_256008", action = "action_EVENT_GADGET_STATE_CHANGE_256008" },
