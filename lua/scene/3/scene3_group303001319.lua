...
-- 装置
gadgets = {
	{ config_id = 319001, gadget_id = 70620002, pos = { x = 1618.318, y = 283.463, z = -1247.527 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 10, isOneoff = true, persistent = true },
	{ config_id = 319002, gadget_id = 70211101, pos = { x = 1618.319, y = 283.303, z = -1247.525 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 6, drop_tag = "解谜低级蒙德", state = GadgetState.ChestLocked, isOneoff = true, persistent = true }
}
...
triggers = {
	...
	{ name = "GADGET_STATE_CHANGE_319004", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_319004", action = "action_EVENT_GADGET_STATE_CHANGE_319004" },
