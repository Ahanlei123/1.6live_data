...
-- 装置
gadgets = {
	{ config_id = 345001, gadget_id = 70710006, pos = { x = 1164.399, y = 205.664, z = 479.036 }, rot = { x = 358.205, y = 151.993, z = 2.925 }, level = 32, persistent = true, area_id = 5 },
	{ config_id = 345002, gadget_id = 70710010, pos = { x = 1094.305, y = 210.822, z = 347.099 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, route_id = 310200129, area_id = 5 },
	{ config_id = 345003, gadget_id = 70710007, pos = { x = 1164.382, y = 205.654, z = 478.442 }, rot = { x = 0.000, y = 203.822, z = 0.000 }, level = 32, area_id = 5 },
	{ config_id = 345004, gadget_id = 70211111, pos = { x = 1165.400, y = 205.554, z = 479.725 }, rot = { x = 0.831, y = 140.508, z = 10.510 }, level = 16, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 5 }
}

-- 区域
regions = {
	{ config_id = 345007, shape = RegionShape.SPHERE, radius = 3, pos = { x = 1094.261, y = 210.798, z = 347.068 }, area_id = 5 }
}
