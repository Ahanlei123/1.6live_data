...
-- 装置
gadgets = {
	{ config_id = 103001, gadget_id = 70211101, pos = { x = 211.886, y = 219.385, z = 344.976 }, rot = { x = 353.289, y = 316.314, z = 15.671 }, level = 16, drop_tag = "解谜低级璃月", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 9 },
	{ config_id = 103002, gadget_id = 70220021, pos = { x = 210.628, y = 219.726, z = 343.288 }, rot = { x = 0.000, y = 70.066, z = 0.000 }, level = 19, isOneoff = true, persistent = true, oneoff_reset_version = 2, area_id = 9 }
}
...
-- 触发器
triggers = {
	{ config_id = 1103003, name = "ANY_GADGET_DIE_103003", event = EventType.EVENT_ANY_GADGET_DIE, source = "", condition = "condition_EVENT_ANY_GADGET_DIE_103003", action = "action_EVENT_ANY_GADGET_DIE_103003" },
