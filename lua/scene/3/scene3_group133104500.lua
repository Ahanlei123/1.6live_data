...
-- 装置
gadgets = {
	{ config_id = 500001, gadget_id = 70710006, pos = { x = 909.781, y = 228.166, z = 903.942 }, rot = { x = 0.000, y = 348.619, z = 0.000 }, level = 32, area_id = 6 },
	{ config_id = 500002, gadget_id = 70710010, pos = { x = 985.436, y = 220.212, z = 821.185 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, route_id = 310400202, area_id = 6 },
	{ config_id = 500003, gadget_id = 70710007, pos = { x = 911.738, y = 227.004, z = 902.106 }, rot = { x = 0.000, y = 138.750, z = 0.000 }, level = 32, area_id = 6 },
	{ config_id = 500004, gadget_id = 70211111, pos = { x = 909.373, y = 227.188, z = 906.508 }, rot = { x = 0.900, y = 351.912, z = 341.550 }, level = 16, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 6 }
}

-- 区域
regions = {
	{ config_id = 500007, shape = RegionShape.SPHERE, radius = 5, pos = { x = 985.216, y = 220.138, z = 821.438 }, area_id = 6 }
}
