...
-- 装置
gadgets = {
	{ config_id = 138001, gadget_id = 70710006, pos = { x = 806.541, y = 317.139, z = 1400.296 }, rot = { x = 0.000, y = 211.184, z = 0.000 }, level = 24, persistent = true, area_id = 6 },
	{ config_id = 138002, gadget_id = 70710010, pos = { x = 753.757, y = 294.341, z = 1402.490 }, rot = { x = 0.000, y = 65.359, z = 0.000 }, level = 24, route_id = 310300034, area_id = 6 },
	{ config_id = 138003, gadget_id = 70710007, pos = { x = 804.378, y = 317.512, z = 1400.857 }, rot = { x = 0.000, y = 285.024, z = 0.000 }, level = 24, area_id = 6 },
	{ config_id = 138004, gadget_id = 70211111, pos = { x = 805.572, y = 317.189, z = 1401.820 }, rot = { x = 359.407, y = 183.777, z = 359.695 }, level = 21, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 6 }
}

-- 区域
regions = {
	{ config_id = 138007, shape = RegionShape.SPHERE, radius = 5, pos = { x = 753.700, y = 292.900, z = 1396.700 }, area_id = 6 }
}
...
triggers = {
	...
	{ config_id = 1138006, name = "AVATAR_NEAR_PLATFORM_138006", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_138006", action = "action_EVENT_AVATAR_NEAR_PLATFORM_138006", trigger_count = 0 },
	{ config_id = 1138007, name = "ENTER_REGION_138007", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_138007", action = "action_EVENT_ENTER_REGION_138007", trigger_count = 0 },
