...
-- 怪物
monsters = {
	{ config_id = 471, monster_id = 20010401, pos = { x = 1804.419, y = 257.192, z = -681.239 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 8, drop_tag = "史莱姆" }
}
...
-- 区域
regions = {
	{ config_id = 159, shape = RegionShape.SPHERE, radius = 5, pos = { x = 1806.675, y = 256.612, z = -680.898 } }
}
