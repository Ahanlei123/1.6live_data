...
-- 装置
gadgets = {
	{ config_id = 341001, gadget_id = 70710006, pos = { x = 1325.657, y = 282.277, z = -1784.180 }, rot = { x = 2.494, y = 71.253, z = 356.682 }, level = 15 },
	{ config_id = 341002, gadget_id = 70710010, pos = { x = 1321.328, y = 275.488, z = -1735.501 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 15, route_id = 300100223 },
	{ config_id = 341003, gadget_id = 70710007, pos = { x = 1325.796, y = 282.327, z = -1782.823 }, rot = { x = 0.000, y = 13.210, z = 0.000 }, level = 15 }
}

-- 区域
regions = {
	{ config_id = 341007, shape = RegionShape.SPHERE, radius = 5, pos = { x = 1322.828, y = 275.488, z = -1735.401 } }
}
