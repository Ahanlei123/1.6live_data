...
-- 区域
regions = {
	{ config_id = 277, shape = RegionShape.SPHERE, radius = 4.3, pos = { x = 1678.926, y = 263.575, z = -889.937 } },
	{ config_id = 278, shape = RegionShape.SPHERE, radius = 4.3, pos = { x = 1735.230, y = 241.077, z = -942.857 } },
	{ config_id = 279, shape = RegionShape.SPHERE, radius = 6.3, pos = { x = 1558.971, y = 201.294, z = -308.355 } }
}
