...
monsters = {
	...
	{ config_id = 4002, monster_id = 21010902, pos = { x = 0.146, y = 0.034, z = 12.091 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 4004, monster_id = 20010601, pos = { x = 2.579, y = 0.034, z = -8.493 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4005, monster_id = 21020301, pos = { x = 0.184, y = 0.034, z = -13.268 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4006, monster_id = 21020301, pos = { x = 14.718, y = 0.034, z = -0.039 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1 },
	{ config_id = 4007, monster_id = 20010701, pos = { x = -2.296, y = 0.034, z = -8.456 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4008, monster_id = 20010901, pos = { x = -12.129, y = 0.034, z = 0.020 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	{ config_id = 4009, monster_id = 21011002, pos = { x = 0.146, y = 0.034, z = -12.148 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 4010, monster_id = 21020201, pos = { x = 0.079, y = 0.034, z = 16.922 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 }
}
...
triggers = {
	...
	{ config_id = 1004027, name = "ANY_MONSTER_DIE_4027", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_4027", action = "action_EVENT_ANY_MONSTER_DIE_4027" },
...
function action_EVENT_ANY_MONSTER_LIVE_4025(context, evt)
	...
	-- 从231003001的变量TPL_TIME中取出对应值并开启挑战
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 231003004, 9, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function action_EVENT_CHALLENGE_SUCCESS_4029(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 231003001) then
	  ...
	  return -1
		...
		-- 卸载指定gadget
		if 0 ~= ScriptLib.RemoveEntityByConfigId(context, 231003004, EntityType.GADGET, 4003 ) then
