...
monsters = {
	...
	{ config_id = 4003, monster_id = 21010402, pos = { x = 12.464, y = 0.034, z = 2.341 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1 },
	{ config_id = 4007, monster_id = 20011501, pos = { x = 12.708, y = 0.034, z = -2.481 }, rot = { x = 0.000, y = 270.084, z = 0.000 }, level = 1 },
	{ config_id = 4008, monster_id = 22010103, pos = { x = 0.263, y = 0.034, z = 9.796 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, affix = { 1028 } },
	{ config_id = 4013, monster_id = 20011501, pos = { x = -11.952, y = 0.034, z = -2.442 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	{ config_id = 4014, monster_id = 21010402, pos = { x = -11.960, y = 0.034, z = 2.458 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_ANY_MONSTER_DIE_4002(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 232101004, 3)
...
function action_EVENT_ANY_MONSTER_LIVE_4023(context, evt)
	...
	-- 从232101001的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 232101001)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 232101004, 6, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function action_EVENT_CHALLENGE_SUCCESS_4027(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 232101001) then
...
function action_EVENT_CHALLENGE_FAIL_4028(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 232101004, suite = 1 }) then
