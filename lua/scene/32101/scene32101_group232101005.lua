...
-- 装置
gadgets = {
	{ config_id = 5001, gadget_id = 70350053, pos = { x = -0.023, y = 0.150, z = -0.030 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 5002, gadget_id = 70350054, pos = { x = 0.025, y = 0.135, z = -0.008 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
