...
-- 怪物
monsters = {
	{ config_id = 5001, monster_id = 21020301, pos = { x = -12.056, y = -0.110, z = 0.004 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	{ config_id = 5002, monster_id = 21020301, pos = { x = 12.050, y = -0.110, z = -0.081 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1 },
	{ config_id = 5003, monster_id = 23020102, pos = { x = 0.015, y = -0.110, z = -12.029 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
suites = {
	...
	},
	{
		...
		gadgets = { 5011 },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_5004", "ANY_MONSTER_LIVE_5012", "CHALLENGE_SUCCESS_5015", "CHALLENGE_FAIL_5016" },
		rand_weight = 100
	},
	{
		-- suite_id = 3,
...
function action_EVENT_ANY_MONSTER_DIE_5004(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 235708005, 3)
...
function action_EVENT_ANY_MONSTER_LIVE_5012(context, evt)
	...
	-- 从235708002的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 235708002)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 235708005, 3, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function action_EVENT_CHALLENGE_SUCCESS_5015(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 235708002) then
...
function action_EVENT_CHALLENGE_FAIL_5016(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 235708005, suite = 1 }) then
