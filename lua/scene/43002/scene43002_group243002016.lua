...
-- 怪物
monsters = {
	{ config_id = 16014, monster_id = 26040102, pos = { x = 79.814, y = 40.001, z = -66.093 }, rot = { x = 0.000, y = 238.164, z = 0.000 }, level = 1 }
}
...
-- 装置
gadgets = {
	{ config_id = 16006, gadget_id = 70360001, pos = { x = 74.593, y = 41.024, z = -71.328 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 16015, shape = RegionShape.CUBIC, size = { x = 60.000, y = 40.000, z = 50.000 }, pos = { x = 75.900, y = 40.000, z = -67.700 } }
}
