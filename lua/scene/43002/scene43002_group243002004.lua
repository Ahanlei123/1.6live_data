...
-- 怪物
monsters = {
	{ config_id = 4007, monster_id = 21020501, pos = { x = 27.683, y = -19.500, z = -45.312 }, rot = { x = 0.000, y = 173.189, z = 0.000 }, level = 11, affix = { 1008 } },
	{ config_id = 4010, monster_id = 26030101, pos = { x = 37.870, y = -19.498, z = -44.694 }, rot = { x = 0.000, y = 201.228, z = 0.000 }, level = 11, affix = { 1008 } }
}
...
-- 装置
gadgets = {
	{ config_id = 4001, gadget_id = 70360010, pos = { x = 32.666, y = -20.000, z = -52.312 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_SELECT_OPTION_4003(context, evt)
	...
	-- 删除指定group： 243002004 ；指定config：4001；物件身上指定option：7；
...
function condition_EVENT_VARIABLE_CHANGE_4004(context, evt)
	...
	-- 判断变量"success"为0
	if ScriptLib.GetGroupVariableValueByGroup(context, "success", 243002005) ~= 0 then
			return false
	end
...
function action_EVENT_CHALLENGE_FAIL_4006(context, evt)
	-- 改变指定group组243002013中， configid为4001的gadget的state
...
function action_EVENT_DUNGEON_SETTLE_4009(context, evt)
	ScriptLib.StopGallery(context, 7008, false)
