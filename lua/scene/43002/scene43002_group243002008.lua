...
monsters = {
	...
	{ config_id = 8006, monster_id = 21010701, pos = { x = 19.118, y = 40.120, z = -11.361 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8007, monster_id = 21010701, pos = { x = 20.083, y = 40.001, z = 5.767 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8009, monster_id = 21010501, pos = { x = 8.897, y = 40.210, z = -10.321 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8010, monster_id = 21010501, pos = { x = 9.015, y = 39.999, z = 4.827 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8020, monster_id = 20010701, pos = { x = 12.682, y = 40.020, z = -4.664 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8021, monster_id = 21020201, pos = { x = 24.925, y = 40.006, z = -2.671 }, rot = { x = 0.000, y = 264.698, z = 0.000 }, level = 1 }
}
...
function action_EVENT_CHALLENGE_SUCCESS_8013(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 243002008, 5000, GadgetState.GearStart) then
