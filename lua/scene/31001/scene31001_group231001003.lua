...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 20010801, pos = { x = 0.217, y = 0.034, z = 9.874 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	...
	{ config_id = 3004, monster_id = 20010501, pos = { x = 0.170, y = 0.034, z = -12.175 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	...
	{ config_id = 3007, monster_id = 20010701, pos = { x = 3.904, y = 0.034, z = -10.971 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3008, monster_id = 20010601, pos = { x = -3.528, y = 0.034, z = -10.878 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3009, monster_id = 20010901, pos = { x = 0.082, y = 0.034, z = -10.853 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
triggers = {
	...
	{ config_id = 1003011, name = "MONSTER_TIDE_DIE_3011", event = EventType.EVENT_MONSTER_TIDE_DIE, source = "1", condition = "condition_EVENT_MONSTER_TIDE_DIE_3011", action = "action_EVENT_MONSTER_TIDE_DIE_3011" },
...
function action_EVENT_ANY_MONSTER_LIVE_3031(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 197, 600, 231001003, 25, 0) then
...
function action_EVENT_CHALLENGE_SUCCESS_3035(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231001005, 5001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 改变指定group组231001005中， configid为5002的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231001005, 5002, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
