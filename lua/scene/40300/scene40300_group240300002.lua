...
function action_EVENT_SELECT_OPTION_13(context, evt)
	...
	if 0 ~= ScriptLib.AutoMonsterTide(context, 1, 240300001, {1001,1002,1003,1010,1015,1016,1009,1017,1018,1019,1020,1021,1022,1004,1005,1006,1007,1008,1012,1013}, 20, 5, 5) then
		return -1
	end
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 240300008, 8, GadgetState.GearStart) then
