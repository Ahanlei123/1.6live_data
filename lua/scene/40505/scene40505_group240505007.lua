...
-- 装置
gadgets = {
	{ config_id = 7001, gadget_id = 70360010, pos = { x = 0.000, y = 0.150, z = 0.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7004, gadget_id = 70350034, pos = { x = 0.000, y = 0.018, z = -7.779 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1007002, name = "SELECT_OPTION_7002", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_7002", action = "action_EVENT_SELECT_OPTION_7002", trigger_count = 0 },
...
function action_EVENT_SELECT_OPTION_7002(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 240505007, 7001, GadgetState.GearStop) then
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 240505007, 7004, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
