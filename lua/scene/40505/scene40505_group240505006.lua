...
gadgets = {
	...
	{ config_id = 6003, gadget_id = 70350008, pos = { x = 0.056, y = 2.644, z = -66.363 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1006002, name = "DUNGEON_SETTLE_6002", event = EventType.EVENT_DUNGEON_SETTLE, source = "", condition = "condition_EVENT_DUNGEON_SETTLE_6002", action = "action_EVENT_DUNGEON_SETTLE_6002" }
}
