...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 21010502, pos = { x = -16.921, y = 0.034, z = -0.011 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 4002, monster_id = 21010902, pos = { x = 14.744, y = 0.034, z = 0.084 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1 },
	{ config_id = 4004, monster_id = 21020202, pos = { x = -0.043, y = 0.034, z = -7.378 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4005, monster_id = 22010202, pos = { x = 0.005, y = 0.034, z = -8.679 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1029 } },
	{ config_id = 4006, monster_id = 21010902, pos = { x = -14.411, y = 0.034, z = -0.056 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	{ config_id = 4009, monster_id = 21011002, pos = { x = 12.169, y = 0.034, z = -0.080 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, pose_id = 32 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_4031(context, evt)
	...
	-- 从231102001的变量TPL_TIME中取出对应值并开启挑战
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 231102004, 6, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
