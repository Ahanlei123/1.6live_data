...
-- 装置
gadgets = {
	{ config_id = 1001, gadget_id = 70360010, pos = { x = 0.000, y = 0.093, z = -0.021 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, state = GadgetState.GearStop },
	{ config_id = 1002, gadget_id = 70350024, pos = { x = 0.000, y = 0.021, z = -0.021 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
