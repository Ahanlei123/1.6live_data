...
-- 装置
gadgets = {
	{ config_id = 5001, gadget_id = 70360010, pos = { x = 0.000, y = 0.150, z = 8.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_SELECT_OPTION_5003(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 240608006, 6005, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
