...
variables = {
	...
	{ name = "FIRST_WAVE_MONSTER_AFFIX", value = 0, no_refresh = false },
	{ name = "SECOND_WAVE_MONSTER_AFFIX", value = 0, no_refresh = false },
	{ name = "THIRD_WAVE_MONSTER_AFFIX", value = 0, no_refresh = false }
}
