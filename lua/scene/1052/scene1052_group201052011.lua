...
function action_EVENT_GROUP_REFRESH_11001(context, evt)
	-- 延迟2秒后,向groupId为：201052011的对象,请求一次调用,并将string参数："timeStart" 传递过去
...
function action_EVENT_TIMER_EVENT_11002(context, evt)
	...
	-- 延迟2秒后,向groupId为：201052011的对象,请求一次调用,并将string参数："time1" 传递过去
...
function action_EVENT_TIMER_EVENT_11003(context, evt)
	...
	-- 延迟2秒后,向groupId为：201052011的对象,请求一次调用,并将string参数："time2" 传递过去
...
function action_EVENT_TIMER_EVENT_11004(context, evt)
	...
	-- 延迟2秒后,向groupId为：201052011的对象,请求一次调用,并将string参数："time3" 传递过去
...
function action_EVENT_TIMER_EVENT_11005(context, evt)
	...
	-- 延迟2秒后,向groupId为：201052011的对象,请求一次调用,并将string参数："time4" 传递过去
