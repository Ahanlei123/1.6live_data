...
gadgets = {
	...
	{ config_id = 8003, gadget_id = 70350071, pos = { x = -81.420, y = 91.310, z = 136.050 }, rot = { x = 287.207, y = 128.819, z = 180.013 }, level = 1, state = GadgetState.GearStart },
	...
	{ config_id = 8009, gadget_id = 70350071, pos = { x = -39.000, y = 96.520, z = 65.790 }, rot = { x = 270.794, y = 83.543, z = 321.816 }, level = 1, state = GadgetState.GearStart },
...
-- 变量
variables = {
	{ name = "stage1", value = 0, no_refresh = false },
	{ name = "stage1state", value = 1, no_refresh = false },
	{ name = "stage2", value = 0, no_refresh = false },
	{ name = "stage2state", value = 1, no_refresh = false },
	{ name = "stage3", value = 0, no_refresh = false },
	{ name = "stage3state", value = 1, no_refresh = false }
}
...
function action_EVENT_VARIABLE_CHANGE_8014(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage1state", 2, 201052008) then
...
function action_EVENT_VARIABLE_CHANGE_8015(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage1state", 3, 201052008) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
...
function action_EVENT_VARIABLE_CHANGE_8016(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage1state", 4, 201052008) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
...
function action_EVENT_VARIABLE_CHANGE_8017(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage1state", 1, 201052008) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
...
function action_EVENT_VARIABLE_CHANGE_8025(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage2state", 2, 201052008) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
...
function action_EVENT_VARIABLE_CHANGE_8026(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage2state", 3, 201052008) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
...
function action_EVENT_VARIABLE_CHANGE_8027(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage2state", 4, 201052008) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
...
function action_EVENT_VARIABLE_CHANGE_8028(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage2state", 1, 201052008) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
...
function action_EVENT_VARIABLE_CHANGE_8035(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage3state", 2, 201052008) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
...
function action_EVENT_VARIABLE_CHANGE_8036(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage3state", 3, 201052008) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
...
function action_EVENT_VARIABLE_CHANGE_8037(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage3state", 4, 201052008) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
...
function action_EVENT_VARIABLE_CHANGE_8038(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage3state", 1, 201052008) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
