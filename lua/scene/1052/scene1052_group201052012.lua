...
function action_EVENT_GROUP_REFRESH_12001(context, evt)
	-- 延迟2秒后,向groupId为：201052012的对象,请求一次调用,并将string参数："timeStart" 传递过去
...
function action_EVENT_TIMER_EVENT_12002(context, evt)
	...
	-- 延迟2秒后,向groupId为：201052012的对象,请求一次调用,并将string参数："time1" 传递过去
...
function action_EVENT_TIMER_EVENT_12003(context, evt)
	...
	-- 延迟2秒后,向groupId为：201052012的对象,请求一次调用,并将string参数："time2" 传递过去
...
function action_EVENT_TIMER_EVENT_12004(context, evt)
	...
	-- 延迟2秒后,向groupId为：201052012的对象,请求一次调用,并将string参数："time3" 传递过去
...
function action_EVENT_TIMER_EVENT_12005(context, evt)
	...
	-- 延迟2秒后,向groupId为：201052012的对象,请求一次调用,并将string参数："time4" 传递过去
...
function action_EVENT_TIMER_EVENT_12006(context, evt)
	...
	-- 延迟2秒后,向groupId为：201052012的对象,请求一次调用,并将string参数："time5" 传递过去
