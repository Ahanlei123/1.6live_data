...
-- 怪物
monsters = {
	{ config_id = 7001, monster_id = 22010102, pos = { x = 0.655, y = -0.060, z = -15.785 }, rot = { x = 0.000, y = 0.373, z = 0.000 }, level = 1 },
	{ config_id = 7002, monster_id = 21010501, pos = { x = -8.826, y = -0.060, z = -8.655 }, rot = { x = 0.000, y = 31.210, z = 0.000 }, level = 1 },
	{ config_id = 7003, monster_id = 21010501, pos = { x = 11.890, y = -0.060, z = -10.488 }, rot = { x = 0.000, y = 346.307, z = 0.000 }, level = 1 },
	{ config_id = 7004, monster_id = 21010501, pos = { x = 15.201, y = -0.060, z = -8.555 }, rot = { x = 0.000, y = 307.217, z = 0.000 }, level = 1 },
	{ config_id = 7005, monster_id = 21010501, pos = { x = -6.924, y = -0.060, z = -11.904 }, rot = { x = 0.000, y = 25.409, z = 0.000 }, level = 1 },
	{ config_id = 7006, monster_id = 21010502, pos = { x = -9.685, y = -0.060, z = -2.687 }, rot = { x = 0.000, y = 64.828, z = 0.000 }, level = 1 },
	{ config_id = 7007, monster_id = 21010502, pos = { x = 13.393, y = -0.060, z = -2.390 }, rot = { x = 0.000, y = 270.084, z = 0.000 }, level = 1 },
	{ config_id = 7008, monster_id = 21010502, pos = { x = 1.320, y = -0.060, z = 5.942 }, rot = { x = 0.000, y = 182.789, z = 0.000 }, level = 1 },
	...
	{ config_id = 7011, monster_id = 21010502, pos = { x = 13.628, y = -0.060, z = 0.041 }, rot = { x = 0.000, y = 315.283, z = 0.000 }, level = 1 },
	{ config_id = 7012, monster_id = 21010502, pos = { x = 13.117, y = -0.060, z = -9.688 }, rot = { x = 0.000, y = 322.134, z = 0.000 }, level = 1 },
	{ config_id = 7013, monster_id = 21010502, pos = { x = 5.824, y = -0.060, z = -12.713 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7014, monster_id = 21010502, pos = { x = -11.381, y = -0.060, z = -6.753 }, rot = { x = 0.000, y = 50.168, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 7015, monster_id = 21010502, pos = { x = -12.930, y = -0.060, z = 0.828 }, rot = { x = 0.000, y = 76.240, z = 0.000 }, level = 1, pose_id = 32 },
	...
	{ config_id = 7021, monster_id = 22010102, pos = { x = 14.363, y = -0.161, z = -5.401 }, rot = { x = 0.000, y = 274.763, z = 0.000 }, level = 1 },
	{ config_id = 7022, monster_id = 22010102, pos = { x = -12.507, y = -0.161, z = -2.923 }, rot = { x = 0.000, y = 93.517, z = 0.000 }, level = 1 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_7028(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 191, 360, 250027007, 22, 0) then
...
function condition_EVENT_ANY_MONSTER_DIE_7029(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 250027007) ~= 0 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_7029(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 250027007, 3)
...
function action_EVENT_ANY_MONSTER_DIE_7030(context, evt)
	-- 添加suite4的新内容
	    ScriptLib.AddExtraGroupSuite(context, 250027007, 4)
...
function action_EVENT_ANY_MONSTER_DIE_7031(context, evt)
	-- 添加suite6的新内容
	    ScriptLib.AddExtraGroupSuite(context, 250027007, 6)
...
function action_EVENT_CHALLENGE_SUCCESS_7032(context, evt)
	-- 改变指定group组250027005中， configid为5002的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 250027005, 5002, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 改变指定group组250027007中， configid为7027的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 250027007, 7027, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
...
function action_EVENT_CHALLENGE_FAIL_7033(context, evt)
	-- 改变指定group组250027006中， configid为6001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 250027006, 6001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 250027006, 6001, {7}) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_wok_options_by_configid")
		return -1
	end
	
	-- 改变指定group组250027005中， configid为5001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 250027005, 5001, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 250027005, 5002, GadgetState.GearStart) then
		...
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 250027007, suite = 1 }) then
...
function action_EVENT_ANY_MONSTER_DIE_7034(context, evt)
	-- 添加suite5的新内容
	    ScriptLib.AddExtraGroupSuite(context, 250027007, 5)
