...
-- 装置
gadgets = {
	{ config_id = 8001, gadget_id = 70340012, pos = { x = 0.270, y = 0.130, z = -69.680 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8002, gadget_id = 70350008, pos = { x = -0.663, y = 4.237, z = -65.457 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
