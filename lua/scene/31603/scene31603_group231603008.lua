...
-- 怪物
monsters = {
	{ config_id = 8001, monster_id = 21010502, pos = { x = 12.024, y = -0.057, z = 0.035 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 8002, monster_id = 22010302, pos = { x = -0.211, y = -0.057, z = -9.169 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8003, monster_id = 20011103, pos = { x = -0.419, y = -0.057, z = -11.531 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8004, monster_id = 20011103, pos = { x = -13.569, y = -0.057, z = -9.850 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8005, monster_id = 20011103, pos = { x = 12.732, y = -0.057, z = -9.893 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8006, monster_id = 21010502, pos = { x = -12.352, y = -0.057, z = 0.065 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 8007, monster_id = 22010301, pos = { x = 0.186, y = -0.057, z = 7.409 }, rot = { x = 0.000, y = 182.425, z = 0.000 }, level = 1, affix = { 6106 } }
}
...
-- 装置
gadgets = {
	{ config_id = 8010, gadget_id = 70900205, pos = { x = 5.914, y = -1.268, z = 3.178 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_8011(context, evt)
	...
	-- 从231603005的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 231603005)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 231603008, 7, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function condition_EVENT_ANY_MONSTER_DIE_8012(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 231603008) ~= 0 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_8012(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 231603008, 3)
...
function action_EVENT_CHALLENGE_SUCCESS_8013(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 231603005) then
...
function action_EVENT_CHALLENGE_FAIL_8014(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 231603008, suite = 1 }) then
