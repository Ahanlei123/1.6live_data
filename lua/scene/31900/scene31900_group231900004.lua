...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 20011304, pos = { x = 0.139, y = 0.034, z = -12.136 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4002, monster_id = 20010604, pos = { x = 1.299, y = 0.034, z = 9.629 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 4003, monster_id = 20010702, pos = { x = -1.090, y = 0.034, z = 9.671 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 4013, monster_id = 20010702, pos = { x = -1.117, y = 0.034, z = 8.516 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 4018, monster_id = 20010604, pos = { x = 1.300, y = 0.034, z = 8.576 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 4019, monster_id = 22010103, pos = { x = 0.137, y = 0.034, z = -9.684 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_ANY_MONSTER_DIE_4006(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 231900004, 3)
...
function action_EVENT_ANY_MONSTER_LIVE_4027(context, evt)
	...
	-- 从231900001的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 231900001)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 231900004, 6, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function action_EVENT_CHALLENGE_SUCCESS_4031(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 231900001) then
...
function action_EVENT_CHALLENGE_FAIL_4032(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 231900004, suite = 1 }) then
