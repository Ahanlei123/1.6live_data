...
-- DEFS_MISCS
package_tide_defs={
  [1]={{monster_package={12010},route=1,route_points={1,2,3,4,5,6,7,8},tags=2,count=10,max=2,min=2},{monster_package={12010},route=2,route_points={1,2,3,4,5,6,7,8},tags=2,count=10,max=2,min=2},{monster_package={12020,12021,12022},route=3,route_points={1,2,3,4,5,6,7,8},tags=4,count=12,max=4,min=4},{monster_package={12020,12021,12022},route=4,route_points={1,2,3,4,5,6,7,8},tags=8,count=12,max=4,min=4}},
