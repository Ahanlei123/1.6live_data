...
-- 装置
gadgets = {
	{ config_id = 13001, gadget_id = 70360145, pos = { x = 71.245, y = 1.751, z = -46.940 }, rot = { x = 0.000, y = 225.000, z = 0.000 }, level = 1, is_guest_can_operate = true },
	{ config_id = 13002, gadget_id = 70360140, pos = { x = 71.245, y = 1.751, z = -46.940 }, rot = { x = 0.000, y = 225.000, z = 0.000 }, level = 1 },
