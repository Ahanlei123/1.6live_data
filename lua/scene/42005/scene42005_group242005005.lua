...
-- DEFS_MISCS
package_tide_defs={
  [1]={{monster_package={12003},route=1,route_points={1,2,3,4,5,6,7,8},tags=2,count=8,max=2,min=2},{monster_package={12003},route=2,route_points={1,2,3,4,5,6,7,8},tags=2,count=8,max=2,min=2},{monster_package={12010,12011,12012},route=3,route_points={1,2,3,4,5,6,7,8},tags=4,count=15,max=5,min=5},{monster_package={12010,12011,12012},route=4,route_points={1,2,3,4,5,6,7,8},tags=8,count=15,max=5,min=5}},
