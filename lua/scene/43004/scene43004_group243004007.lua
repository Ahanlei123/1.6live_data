...
-- 装置
gadgets = {
	{ config_id = 7001, gadget_id = 70360157, pos = { x = 18.466, y = 40.000, z = -2.677 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7002, gadget_id = 70360158, pos = { x = 72.885, y = 40.000, z = -75.668 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7003, gadget_id = 70360156, pos = { x = -4.417, y = 39.999, z = -50.133 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7004, gadget_id = 70360155, pos = { x = 98.234, y = 40.000, z = -1.095 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7005, gadget_id = 70360158, pos = { x = 18.466, y = 40.000, z = -2.677 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7006, gadget_id = 70360156, pos = { x = 72.885, y = 40.000, z = -75.668 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7007, gadget_id = 70360155, pos = { x = -4.417, y = 39.999, z = -50.134 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7008, gadget_id = 70360157, pos = { x = 98.233, y = 40.000, z = -1.094 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7009, gadget_id = 70360155, pos = { x = 18.466, y = 40.000, z = -2.677 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7010, gadget_id = 70360157, pos = { x = 72.884, y = 40.000, z = -75.668 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7011, gadget_id = 70360156, pos = { x = -4.417, y = 39.999, z = -50.134 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7012, gadget_id = 70360158, pos = { x = 98.234, y = 40.000, z = -1.095 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7013, gadget_id = 70360156, pos = { x = 18.466, y = 40.000, z = -2.677 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7014, gadget_id = 70360155, pos = { x = 72.885, y = 40.000, z = -75.668 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7015, gadget_id = 70360158, pos = { x = -4.417, y = 39.999, z = -50.134 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7016, gadget_id = 70360157, pos = { x = 98.234, y = 40.000, z = -1.095 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_SELECT_OPTION_7021(context, evt)
	...
	-- 删除指定group： 243004001 ；指定config：1003；物件身上指定option：7；
...
function action_EVENT_ENTER_REGION_7053(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "Gflag", 4, defs.group_c2) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	    return -1
	end
...
function action_EVENT_ENTER_REGION_7055(context, evt)
	...
	-- 将本组内变量名为 "Gflag" 的变量设置为 1
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "Gflag", 1, defs.group_c1) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	    return -1
	end
