...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 21020301, pos = { x = 6.633, y = 0.034, z = -7.390 }, rot = { x = 0.000, y = 346.531, z = 0.000 }, level = 1 },
	{ config_id = 4002, monster_id = 21020202, pos = { x = -6.642, y = 0.034, z = -7.403 }, rot = { x = 0.000, y = 21.465, z = 0.000 }, level = 1, affix = { 6105 } },
	{ config_id = 4003, monster_id = 21030103, pos = { x = 0.091, y = 0.034, z = -12.255 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1026 } }
}
...
function action_EVENT_ANY_MONSTER_LIVE_4028(context, evt)
	...
	-- 从231203001的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 231203001)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 231203004, 3, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function action_EVENT_CHALLENGE_SUCCESS_4032(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 231203001) then
...
function action_EVENT_CHALLENGE_FAIL_4033(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 231203004, suite = 1 }) then
