...
-- 怪物
monsters = {
	{ config_id = 1001, monster_id = 29040103, pos = { x = 518.625, y = 74.167, z = 461.735 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, mark_flag = 16 }
}
...
gadgets = {
	...
	{ config_id = 1012, gadget_id = 70210106, pos = { x = 526.934, y = 74.192, z = 465.003 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "若陀龙王火冰", persistent = true, boss_chest = { monster_config_id = 1001, resin=60, life_time = 1800, take_num = 1} },
	{ config_id = 1014, gadget_id = 70360001, pos = { x = 506.465, y = 74.185, z = 437.336 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
