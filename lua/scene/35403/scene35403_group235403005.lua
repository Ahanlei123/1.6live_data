...
-- 怪物
monsters = {
	{ config_id = 5001, monster_id = 23010301, pos = { x = 0.044, y = -0.046, z = -12.430 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 5002, monster_id = 23010501, pos = { x = -4.762, y = -0.046, z = -11.217 }, rot = { x = 0.000, y = 15.299, z = 0.000 }, level = 1 },
	{ config_id = 5005, monster_id = 23010601, pos = { x = 5.565, y = -0.046, z = -11.624 }, rot = { x = 0.000, y = 337.135, z = 0.000 }, level = 1 }
}
...
-- 装置
gadgets = {
	{ config_id = 5010, gadget_id = 70350033, pos = { x = 0.159, y = -0.048, z = -8.667 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
...
function action_EVENT_ANY_MONSTER_LIVE_5012(context, evt)
	...
	-- 从235403002的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 235403002)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 235403005, 3, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function condition_EVENT_ANY_MONSTER_DIE_5013(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 235403005) ~= 0 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_5013(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 235403005, 3)
...
function action_EVENT_CHALLENGE_SUCCESS_5015(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 235403002) then
