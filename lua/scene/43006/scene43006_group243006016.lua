...
-- 怪物
monsters = {
	{ config_id = 16012, monster_id = 26040101, pos = { x = 7.393, y = 40.049, z = -81.680 }, rot = { x = 0.000, y = 311.869, z = 0.000 }, level = 1 }
}
...
-- 装置
gadgets = {
	{ config_id = 16006, gadget_id = 70360001, pos = { x = -3.933, y = 41.019, z = -80.582 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
