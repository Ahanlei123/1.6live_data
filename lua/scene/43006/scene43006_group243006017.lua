...
-- 怪物
monsters = {
	{ config_id = 17003, monster_id = 25030301, pos = { x = -28.693, y = 40.049, z = -32.686 }, rot = { x = 0.000, y = 301.327, z = 0.000 }, level = 1 },
	{ config_id = 17004, monster_id = 25030301, pos = { x = -28.479, y = 40.029, z = -22.046 }, rot = { x = 0.000, y = 204.559, z = 0.000 }, level = 1 },
	{ config_id = 17005, monster_id = 25030201, pos = { x = -35.230, y = 40.049, z = -18.618 }, rot = { x = 0.000, y = 179.403, z = 0.000 }, level = 1 },
	{ config_id = 17012, monster_id = 25030201, pos = { x = -34.020, y = 40.049, z = -36.702 }, rot = { x = 0.000, y = 333.391, z = 0.000 }, level = 1 },
	{ config_id = 17014, monster_id = 25070101, pos = { x = -25.335, y = 40.029, z = -27.561 }, rot = { x = 0.000, y = 271.228, z = 0.000 }, level = 1 }
}
...
-- 装置
gadgets = {
	{ config_id = 17006, gadget_id = 70360001, pos = { x = -36.389, y = 41.009, z = -28.244 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
suites = {
	...
	},
	{
		-- suite_id = 2,
		-- description = ,
		monsters = { 17003, 17004, 17005, 17012, 17014 },
		gadgets = { },
		regions = { },
		triggers = { },
		rand_weight = 100
...
function action_EVENT_CHALLENGE_FAIL_17010(context, evt)
	...
	-- 改变指定group组243006001中， configid为1003的gadget的state
