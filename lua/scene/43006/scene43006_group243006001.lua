...
-- 怪物
monsters = {
	{ config_id = 1004, monster_id = 23020101, pos = { x = 102.552, y = 39.997, z = -7.119 }, rot = { x = 0.000, y = 346.531, z = 0.000 }, level = 1 },
	{ config_id = 1005, monster_id = 21020201, pos = { x = 95.128, y = 40.009, z = -7.568 }, rot = { x = 0.000, y = 21.465, z = 0.000 }, level = 1 }
}
