...
-- 装置
gadgets = {
	{ config_id = 5001, gadget_id = 70350053, pos = { x = -0.043, y = 0.103, z = 0.009 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 5002, gadget_id = 70350054, pos = { x = 0.005, y = 0.088, z = 0.031 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
