...
-- 装置
gadgets = {
	{ config_id = 5001, gadget_id = 70350053, pos = { x = 0.006, y = 0.129, z = 0.038 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 5002, gadget_id = 70350054, pos = { x = 0.054, y = 0.114, z = 0.060 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
