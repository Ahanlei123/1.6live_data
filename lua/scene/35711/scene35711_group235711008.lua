...
-- 怪物
monsters = {
	{ config_id = 8001, monster_id = 22020102, pos = { x = -3.731, y = 0.046, z = -13.781 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 9002 }, pose_id = 101 },
	{ config_id = 8002, monster_id = 22020102, pos = { x = 3.752, y = 0.012, z = -13.497 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 9002 }, pose_id = 101 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_8009(context, evt)
	...
	-- 从235711005的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 235711005)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 235711008, 2, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function action_EVENT_CHALLENGE_SUCCESS_8011(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 235711005) then
...
function action_EVENT_CHALLENGE_FAIL_8012(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 235711008, suite = 1 }) then
