...
-- 怪物
monsters = {
	{ config_id = 8001, monster_id = 23030102, pos = { x = -3.731, y = 0.046, z = -13.781 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 9002 } },
	{ config_id = 8002, monster_id = 23030102, pos = { x = 3.752, y = 0.012, z = -13.497 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 9002 } },
	{ config_id = 8003, monster_id = 23020102, pos = { x = -0.078, y = 0.012, z = -12.177 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8004, monster_id = 23020102, pos = { x = -0.038, y = 0.012, z = 9.787 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_8009(context, evt)
	...
	-- 从235709005的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 235709005)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 235709008, 4, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function condition_EVENT_ANY_MONSTER_DIE_8010(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 235709008) ~= 0 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_8010(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 235709008, 3)
...
function action_EVENT_CHALLENGE_SUCCESS_8011(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 235709005) then
...
function action_EVENT_CHALLENGE_FAIL_8012(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 235709008, suite = 1 }) then
