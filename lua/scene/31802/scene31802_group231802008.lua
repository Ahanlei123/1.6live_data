...
-- 装置
gadgets = {
	{ config_id = 8001, gadget_id = 70350053, pos = { x = 0.007, y = -0.002, z = -0.039 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8002, gadget_id = 70350054, pos = { x = 0.055, y = -0.017, z = -0.016 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
