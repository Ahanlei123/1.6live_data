...
monsters = {
	...
	{ config_id = 2003, monster_id = 21010501, pos = { x = 527.037, y = -1.983, z = 234.897 }, rot = { x = 0.000, y = 120.000, z = 0.000 }, level = 1, affix = { 1007, 1008 } },
	...
	{ config_id = 2006, monster_id = 21010701, pos = { x = 538.589, y = -1.984, z = 237.988 }, rot = { x = 0.000, y = 210.000, z = 0.000 }, level = 1, affix = { 1007, 1008 } },
	...
	{ config_id = 2010, monster_id = 21010501, pos = { x = 535.410, y = -2.056, z = 245.817 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, affix = { 1007, 1008 } },
	...
	{ config_id = 2013, monster_id = 21010301, pos = { x = 538.605, y = -1.983, z = 245.325 }, rot = { x = 0.000, y = 210.000, z = 0.000 }, level = 1, affix = { 1007, 1008 } },
	{ config_id = 2014, monster_id = 21010201, pos = { x = 527.270, y = -1.983, z = 235.124 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, affix = { 1007, 1008 } },
	{ config_id = 2015, monster_id = 21010701, pos = { x = 538.228, y = -1.983, z = 235.061 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, affix = { 1007, 1008 } },
	...
	{ config_id = 2019, monster_id = 21010501, pos = { x = 538.497, y = -1.984, z = 241.787 }, rot = { x = 0.000, y = 210.000, z = 0.000 }, level = 1, affix = { 1007, 1008 } },
...
triggers = {
	...
	{ config_id = 1002022, name = "CHALLENGE_FAIL_2022", event = EventType.EVENT_CHALLENGE_FAIL, source = "110126", condition = "", action = "action_EVENT_CHALLENGE_FAIL_2022", trigger_count = 0 },
	{ config_id = 1002023, name = "CHALLENGE_SUCCESS_2023", event = EventType.EVENT_CHALLENGE_SUCCESS, source = "110126", condition = "", action = "action_EVENT_CHALLENGE_SUCCESS_2023", trigger_count = 0 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_2021(context, evt)
	ScriptLib.CreateFatherChallenge(context, 110126, 110126, 90, {success = 2, fail = 1, fail_on_wipe=true})
	ScriptLib.AttachChildChallenge(context, 110126, 110127, 110127, {27000,0,0,0},{},{success=1,fail=1})
	ScriptLib.AttachChildChallenge(context, 110126, 110128, 110128, {1,0,0,1,30},{},{success=1,fail=1})
	ScriptLib.StartFatherChallenge(context, 110126)
	return 0
end
...
function action_EVENT_CHALLENGE_FAIL_2022(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 240036002, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
			return -1
		end
	
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 240036001, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
			return -1
		end
...
function action_EVENT_CHALLENGE_SUCCESS_2023(context, evt)
	-- 改变指定group组240036001中， configid为1001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 240036001, 1001, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 240036002, suite = 3 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
			return -1
		end
