...
gadgets = {
	...
	{ config_id = 11, gadget_id = 70350008, pos = { x = 1.162, y = 2.900, z = -42.800 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 12, gadget_id = 70350008, pos = { x = -0.843, y = 2.900, z = -42.800 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 13, gadget_id = 70350008, pos = { x = 1.170, y = 2.900, z = -42.372 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 14, gadget_id = 70350008, pos = { x = -0.488, y = 2.900, z = -42.388 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 15, gadget_id = 70350008, pos = { x = 0.300, y = 2.900, z = -42.179 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
...
function action_EVENT_DUNGEON_REWARD_GET_27(context, evt)
	-- 将configid为 16 的物件更改为状态 GadgetState.Default
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 16, GadgetState.Default) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
