...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 20011103, pos = { x = 2.554, y = 0.034, z = -12.131 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4002, monster_id = 20010904, pos = { x = -2.289, y = 0.034, z = -12.136 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4005, monster_id = 20011103, pos = { x = 7.657, y = 0.034, z = -7.251 }, rot = { x = 0.000, y = 312.600, z = 0.000 }, level = 1 },
	{ config_id = 4007, monster_id = 20011103, pos = { x = -9.906, y = 0.034, z = -7.264 }, rot = { x = 0.000, y = 53.618, z = 0.000 }, level = 1 },
	{ config_id = 4019, monster_id = 22010203, pos = { x = 0.137, y = 0.034, z = -9.684 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_ANY_MONSTER_DIE_4006(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 232000004, 3)
...
function action_EVENT_ANY_MONSTER_LIVE_4027(context, evt)
	...
	-- 从232000001的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 232000001)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 232000004, 5, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function action_EVENT_CHALLENGE_SUCCESS_4031(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 232000001) then
...
function action_EVENT_CHALLENGE_FAIL_4032(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 232000004, suite = 1 }) then
