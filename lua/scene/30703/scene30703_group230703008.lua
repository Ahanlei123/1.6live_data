...
-- 装置
gadgets = {
	{ config_id = 8001, gadget_id = 70350053, pos = { x = 0.006, y = 0.117, z = 0.021 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8002, gadget_id = 70350054, pos = { x = 0.054, y = 0.102, z = 0.043 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
