...
gadgets = {
	...
	{ config_id = 14, gadget_id = 70350008, pos = { x = 1.173, y = 3.162, z = -42.439 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 15, gadget_id = 70350008, pos = { x = 0.400, y = 3.200, z = -42.451 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 16, gadget_id = 70350008, pos = { x = 1.617, y = 3.200, z = -42.900 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 17, gadget_id = 70350008, pos = { x = 0.400, y = 3.200, z = -42.900 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 18, gadget_id = 70350008, pos = { x = 0.400, y = 3.200, z = -42.900 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 19, gadget_id = 70350008, pos = { x = -0.430, y = 3.200, z = -42.900 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
