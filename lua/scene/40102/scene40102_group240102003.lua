...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 20011301, pos = { x = 9.675, y = 0.002, z = -6.727 }, rot = { x = 0.000, y = 343.038, z = 0.000 }, level = 1 },
	{ config_id = 3002, monster_id = 20011301, pos = { x = -11.239, y = 0.002, z = -6.632 }, rot = { x = 0.000, y = 17.150, z = 0.000 }, level = 1 },
	{ config_id = 3003, monster_id = 20011304, pos = { x = -0.807, y = 0.002, z = -12.314 }, rot = { x = 0.000, y = 2.783, z = 0.000 }, level = 1, isElite = true },
	{ config_id = 3004, monster_id = 20011301, pos = { x = -12.220, y = 0.002, z = 0.182 }, rot = { x = 0.000, y = 108.551, z = 0.000 }, level = 1 },
	{ config_id = 3005, monster_id = 20011301, pos = { x = 12.373, y = 0.120, z = -0.314 }, rot = { x = 0.000, y = 274.008, z = 0.000 }, level = 1, affix = { 6105 }, isElite = true },
	{ config_id = 3006, monster_id = 20011304, pos = { x = 0.044, y = 0.246, z = -11.456 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, isElite = true },
	{ config_id = 3007, monster_id = 22010101, pos = { x = 8.860, y = 0.439, z = -7.100 }, rot = { x = 0.000, y = 330.858, z = 0.000 }, level = 1, isElite = true },
	{ config_id = 3008, monster_id = 22010101, pos = { x = -9.682, y = 0.246, z = -7.655 }, rot = { x = 0.000, y = 54.891, z = 0.000 }, level = 1, isElite = true }
}
...
-- 装置
gadgets = {
	{ config_id = 3010, gadget_id = 70900205, pos = { x = 1.864, y = -1.123, z = 9.277 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_3(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 191, 360, 240102003, 8, 0) then
...
function action_EVENT_CHALLENGE_FAIL_4(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 240102010, 12, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
