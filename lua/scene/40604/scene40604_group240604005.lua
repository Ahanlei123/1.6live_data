...
-- 怪物
monsters = {
	{ config_id = 5002, monster_id = 21010201, pos = { x = -12.782, y = -0.004, z = -2.617 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	{ config_id = 5003, monster_id = 21010201, pos = { x = -12.820, y = -0.025, z = 2.592 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	{ config_id = 5005, monster_id = 21010201, pos = { x = 12.776, y = 0.195, z = 2.596 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1 },
	{ config_id = 5006, monster_id = 21010201, pos = { x = 12.717, y = 0.195, z = -2.544 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1 },
	{ config_id = 5010, monster_id = 21010501, pos = { x = -4.497, y = 0.006, z = -10.044 }, rot = { x = 0.000, y = 0.918, z = 0.000 }, level = 1, affix = { 1031 }, isElite = true },
	{ config_id = 5011, monster_id = 21010501, pos = { x = 5.724, y = 0.068, z = -10.321 }, rot = { x = 0.000, y = 0.918, z = 0.000 }, level = 1 },
	{ config_id = 5013, monster_id = 22010101, pos = { x = 0.482, y = 0.195, z = -12.550 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
-- 装置
gadgets = {
	{ config_id = 5001, gadget_id = 70350035, pos = { x = 0.037, y = 0.112, z = 0.035 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 16 },
	{ config_id = 5007, gadget_id = 70900205, pos = { x = 7.409, y = -1.264, z = 2.128 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 5031, gadget_id = 70350023, pos = { x = 0.037, y = 0.112, z = 0.035 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, state = GadgetState.GearAction1 }
}
