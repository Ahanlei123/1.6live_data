...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 22010204, pos = { x = 0.064, y = 0.034, z = -7.307 }, rot = { x = 0.000, y = 346.531, z = 0.000 }, level = 1, affix = { 6101 } },
	{ config_id = 3002, monster_id = 21011001, pos = { x = -14.747, y = 0.034, z = -2.910 }, rot = { x = 0.000, y = 43.734, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 3003, monster_id = 21010501, pos = { x = 12.595, y = -0.002, z = -2.736 }, rot = { x = 0.000, y = 336.491, z = 0.000 }, level = 1, pose_id = 32 }
}
...
function action_EVENT_CHALLENGE_SUCCESS_3035(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231201005, 5001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 改变指定group组231201005中， configid为5002的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231201005, 5002, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
