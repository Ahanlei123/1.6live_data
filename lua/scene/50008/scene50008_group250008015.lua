...
-- NPC
npcs = {
	{ config_id = 1, npc_id = 2000303, pos = { x = -56.600, y = 3.500, z = -428.054 }, rot = { x = 0.000, y = 0.000, z = 0.000 } }
}

-- 装置
gadgets = {
	{ config_id = 76, gadget_id = 70220011, pos = { x = -56.600, y = 3.500, z = -412.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 77, gadget_id = 70220011, pos = { x = -56.600, y = 3.500, z = -407.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 78, gadget_id = 70220011, pos = { x = -56.600, y = 3.500, z = -402.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 79, gadget_id = 70211101, pos = { x = -53.000, y = 3.500, z = -430.859 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "解谜低级蒙德", isOneoff = true, persistent = true, type = GadgetType.GADGET_WORLD_CHECT },
	{ config_id = 80, gadget_id = 70211011, pos = { x = -56.600, y = 3.500, z = -430.859 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "战斗中级蒙德", isOneoff = true, persistent = true, type = GadgetType.GADGET_WORLD_CHECT },
	{ config_id = 81, gadget_id = 70211121, pos = { x = -60.200, y = 3.500, z = -430.859 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "解谜高级蒙德", isOneoff = true, persistent = true, type = GadgetType.GADGET_WORLD_CHECT },
	{ config_id = 411, gadget_id = 70900201, pos = { x = -56.600, y = 3.500, z = -388.874 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 45, shape = RegionShape.SPHERE, radius = 5, pos = { x = -56.600, y = 3.500, z = -388.900 } }
}
