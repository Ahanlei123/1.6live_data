...
-- 区域
regions = {
	{ config_id = 5001, shape = RegionShape.SPHERE, radius = 2.5, pos = { x = 3.630, y = 0.917, z = -2.870 }, room = 1 }
}
...
function action_EVENT_ENTER_REGION_5001(context, evt)
	-- 调用提示id为 1110043 的提示UI，会显示在屏幕中央偏下位置，id索引自 ReminderData表格
	if 0 ~= ScriptLib.ShowReminder(context, 1110043) then
