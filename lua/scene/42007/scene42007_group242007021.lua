...
-- DEFS_MISCS
package_tide_defs={        [1]={{monster_package={12030,12031},route=1,route_points={1,2,4,5,9,10,13,14,17,18,21},tags=2,count=10,max=5,min=5},{monster_package={12039},route=2,route_points={1,2,4,5,9,10,13,14,17,18,21,22,25,26,29,30,33,34,38,39,40,41,43,44},tags=4,count=10,max=5,min=5},{monster_package={12033,12035},route=3,route_points={1,2,4,5,9,10,13,14,17,18,21,22,25,26,29,30,33,34,37},tags=8,count=5,max=5,min=5}},   
}
