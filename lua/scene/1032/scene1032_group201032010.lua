...
-- 区域
regions = {
	{ config_id = 10005, shape = RegionShape.SPHERE, radius = 400, pos = { x = 12.212, y = 256.747, z = 11.591 }, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE }
}
...
variables = {
	...
	{ name = "isFirstEntry", value = 1, no_refresh = false },
	{ name = "test_re", value = 0, no_refresh = false },
	{ name = "test_enter_region", value = 0, no_refresh = false },
	{ name = "isSlipDie", value = 0, no_refresh = false },
	{ name = "test_slip_enter_region", value = 0, no_refresh = false }
}
