...
-- 装置
gadgets = {
	{ config_id = 257, gadget_id = 70360002, pos = { x = 436.051, y = 0.429, z = -44.529 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000095, name = "GADGET_CREATE_95", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_95", action = "action_EVENT_GADGET_CREATE_95" },
	{ config_id = 1000096, name = "SELECT_OPTION_96", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_96", action = "action_EVENT_SELECT_OPTION_96", trigger_count = 0, forbid_guest = false }
}
