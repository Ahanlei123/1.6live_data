...
-- 装置
gadgets = {
	{ config_id = 250, gadget_id = 70360002, pos = { x = 754.729, y = 0.518, z = -44.549 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000081, name = "GADGET_CREATE_81", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_81", action = "action_EVENT_GADGET_CREATE_81" },
	{ config_id = 1000082, name = "SELECT_OPTION_82", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_82", action = "action_EVENT_SELECT_OPTION_82", trigger_count = 0, forbid_guest = false }
}
