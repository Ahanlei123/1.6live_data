...
-- 装置
gadgets = {
	{ config_id = 255, gadget_id = 70360002, pos = { x = 526.703, y = 0.429, z = -44.180 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000091, name = "GADGET_CREATE_91", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_91", action = "action_EVENT_GADGET_CREATE_91" },
