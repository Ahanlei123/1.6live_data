...
-- 装置
gadgets = {
	{ config_id = 258, gadget_id = 70360002, pos = { x = 391.638, y = 0.286, z = -44.682 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000097, name = "GADGET_CREATE_97", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_97", action = "action_EVENT_GADGET_CREATE_97" },
	{ config_id = 1000098, name = "SELECT_OPTION_98", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_98", action = "action_EVENT_SELECT_OPTION_98", trigger_count = 0, forbid_guest = false }
}
