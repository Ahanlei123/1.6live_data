...
-- 装置
gadgets = {
	{ config_id = 244, gadget_id = 70360002, pos = { x = 673.813, y = 1.133, z = -4.693 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000069, name = "GADGET_CREATE_69", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_69", action = "action_EVENT_GADGET_CREATE_69" },
	{ config_id = 1000070, name = "SELECT_OPTION_70", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_70", action = "action_EVENT_SELECT_OPTION_70", trigger_count = 0, forbid_guest = false }
}
