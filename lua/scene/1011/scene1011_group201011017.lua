...
-- 装置
gadgets = {
	{ config_id = 239, gadget_id = 70360002, pos = { x = 426.424, y = 1.133, z = -4.101 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000059, name = "GADGET_CREATE_59", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_59", action = "action_EVENT_GADGET_CREATE_59" },
	{ config_id = 1000060, name = "SELECT_OPTION_60", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_60", action = "action_EVENT_SELECT_OPTION_60", trigger_count = 0, forbid_guest = false }
}
