...
-- 装置
gadgets = {
	{ config_id = 262, gadget_id = 70360002, pos = { x = 209.792, y = -0.071, z = -45.195 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000105, name = "GADGET_CREATE_105", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_105", action = "action_EVENT_GADGET_CREATE_105" },
	{ config_id = 1000106, name = "SELECT_OPTION_106", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_106", action = "action_EVENT_SELECT_OPTION_106", trigger_count = 0, forbid_guest = false }
}
