...
-- 装置
gadgets = {
	{ config_id = 238, gadget_id = 70360002, pos = { x = 376.743, y = 1.133, z = -4.475 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000057, name = "GADGET_CREATE_57", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_57", action = "action_EVENT_GADGET_CREATE_57" },
	{ config_id = 1000058, name = "SELECT_OPTION_58", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_58", action = "action_EVENT_SELECT_OPTION_58", trigger_count = 0, forbid_guest = false }
}
