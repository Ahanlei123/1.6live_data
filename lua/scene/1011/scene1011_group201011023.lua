...
-- 装置
gadgets = {
	{ config_id = 245, gadget_id = 70360002, pos = { x = 722.771, y = 1.133, z = -3.705 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000071, name = "GADGET_CREATE_71", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_71", action = "action_EVENT_GADGET_CREATE_71" },
	{ config_id = 1000072, name = "SELECT_OPTION_72", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_72", action = "action_EVENT_SELECT_OPTION_72", trigger_count = 0, forbid_guest = false }
}
