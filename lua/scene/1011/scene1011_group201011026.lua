...
-- 装置
gadgets = {
	{ config_id = 248, gadget_id = 70360002, pos = { x = 833.904, y = 0.786, z = -35.035 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000077, name = "GADGET_CREATE_77", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_77", action = "action_EVENT_GADGET_CREATE_77" },
	{ config_id = 1000078, name = "SELECT_OPTION_78", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_78", action = "action_EVENT_SELECT_OPTION_78", trigger_count = 0, forbid_guest = false }
}
