...
-- 变量
variables = {
	{ name = "State_Floor_1", value = 0, no_refresh = true },
	{ name = "State_Floor_2", value = 0, no_refresh = true },
	{ name = "State_Floor_3", value = 0, no_refresh = true },
	{ name = "Door_Open_1", value = 0, no_refresh = true },
	{ name = "Door_Open_2", value = 0, no_refresh = true },
	{ name = "Door_Open_3", value = 0, no_refresh = true },
	{ name = "Right_Floor_1", value = 0, no_refresh = true },
	{ name = "Right_Floor_2", value = 0, no_refresh = true },
	{ name = "Right_Floor_3", value = 0, no_refresh = true }
}
