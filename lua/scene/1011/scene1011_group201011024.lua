...
-- 装置
gadgets = {
	{ config_id = 246, gadget_id = 70360002, pos = { x = 772.393, y = 1.133, z = -4.359 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000073, name = "GADGET_CREATE_73", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_73", action = "action_EVENT_GADGET_CREATE_73" },
	{ config_id = 1000074, name = "SELECT_OPTION_74", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_74", action = "action_EVENT_SELECT_OPTION_74", trigger_count = 0, forbid_guest = false }
}
