...
-- 装置
gadgets = {
	{ config_id = 237, gadget_id = 70360002, pos = { x = 327.353, y = 1.133, z = -5.249 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000055, name = "GADGET_CREATE_55", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_55", action = "action_EVENT_GADGET_CREATE_55" },
	{ config_id = 1000056, name = "SELECT_OPTION_56", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_56", action = "action_EVENT_SELECT_OPTION_56", trigger_count = 0, forbid_guest = false }
}
