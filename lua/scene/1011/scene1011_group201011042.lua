...
-- 装置
gadgets = {
	{ config_id = 264, gadget_id = 70360002, pos = { x = 149.347, y = -0.177, z = -82.833 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000109, name = "GADGET_CREATE_109", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_109", action = "action_EVENT_GADGET_CREATE_109" },
	{ config_id = 1000110, name = "SELECT_OPTION_110", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_110", action = "action_EVENT_SELECT_OPTION_110", trigger_count = 0, forbid_guest = false }
}
