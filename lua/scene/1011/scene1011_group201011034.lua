...
-- 装置
gadgets = {
	{ config_id = 256, gadget_id = 70360002, pos = { x = 481.170, y = 0.429, z = -44.740 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000093, name = "GADGET_CREATE_93", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_93", action = "action_EVENT_GADGET_CREATE_93" },
	{ config_id = 1000094, name = "SELECT_OPTION_94", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_94", action = "action_EVENT_SELECT_OPTION_94", trigger_count = 0, forbid_guest = false }
}
