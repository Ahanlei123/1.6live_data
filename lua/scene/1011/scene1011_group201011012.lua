...
-- 装置
gadgets = {
	{ config_id = 234, gadget_id = 70360002, pos = { x = 180.338, y = 1.133, z = -5.043 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000049, name = "GADGET_CREATE_49", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_49", action = "action_EVENT_GADGET_CREATE_49" },
	{ config_id = 1000050, name = "SELECT_OPTION_50", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_50", action = "action_EVENT_SELECT_OPTION_50", trigger_count = 0, forbid_guest = false }
}
