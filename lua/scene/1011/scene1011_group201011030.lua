...
-- 装置
gadgets = {
	{ config_id = 252, gadget_id = 70360002, pos = { x = 663.833, y = 0.429, z = -44.431 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000085, name = "GADGET_CREATE_85", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_85", action = "action_EVENT_GADGET_CREATE_85" },
