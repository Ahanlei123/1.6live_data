...
-- 装置
gadgets = {
	{ config_id = 261, gadget_id = 70360002, pos = { x = 255.188, y = -0.071, z = -44.567 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000103, name = "GADGET_CREATE_103", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_103", action = "action_EVENT_GADGET_CREATE_103" },
	{ config_id = 1000104, name = "SELECT_OPTION_104", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_104", action = "action_EVENT_SELECT_OPTION_104", trigger_count = 0, forbid_guest = false }
}
