...
-- 装置
gadgets = {
	{ config_id = 242, gadget_id = 70360002, pos = { x = 573.920, y = 1.133, z = -4.671 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000065, name = "GADGET_CREATE_65", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_65", action = "action_EVENT_GADGET_CREATE_65" },
	{ config_id = 1000066, name = "SELECT_OPTION_66", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_66", action = "action_EVENT_SELECT_OPTION_66", trigger_count = 0, forbid_guest = false }
}
