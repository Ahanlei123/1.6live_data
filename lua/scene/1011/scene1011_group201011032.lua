...
-- 装置
gadgets = {
	{ config_id = 254, gadget_id = 70360002, pos = { x = 571.959, y = 0.595, z = -44.659 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000089, name = "GADGET_CREATE_89", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_89", action = "action_EVENT_GADGET_CREATE_89" },
	{ config_id = 1000090, name = "SELECT_OPTION_90", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_90", action = "action_EVENT_SELECT_OPTION_90", trigger_count = 0, forbid_guest = false }
}
