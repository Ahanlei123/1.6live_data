...
-- 装置
gadgets = {
	{ config_id = 243, gadget_id = 70360002, pos = { x = 624.207, y = 1.133, z = -4.837 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000067, name = "GADGET_CREATE_67", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_67", action = "action_EVENT_GADGET_CREATE_67" },
	{ config_id = 1000068, name = "SELECT_OPTION_68", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_68", action = "action_EVENT_SELECT_OPTION_68", trigger_count = 0, forbid_guest = false }
}
