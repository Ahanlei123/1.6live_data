...
-- 装置
gadgets = {
	{ config_id = 263, gadget_id = 70360002, pos = { x = 163.855, y = 0.133, z = -45.400 }, rot = { x = 0.000, y = 270.536, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ config_id = 1000107, name = "GADGET_CREATE_107", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_107", action = "action_EVENT_GADGET_CREATE_107" },
	{ config_id = 1000108, name = "SELECT_OPTION_108", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_108", action = "action_EVENT_SELECT_OPTION_108", trigger_count = 0, forbid_guest = false }
}
