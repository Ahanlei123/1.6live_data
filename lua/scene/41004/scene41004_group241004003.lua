...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 20011201, pos = { x = 7.314, y = 0.034, z = -7.672 }, rot = { x = 0.000, y = 346.531, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3002, monster_id = 20011201, pos = { x = -8.049, y = 0.034, z = -7.875 }, rot = { x = 0.000, y = 21.465, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3003, monster_id = 20011201, pos = { x = -3.734, y = 0.034, z = 8.975 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3004, monster_id = 20011201, pos = { x = -3.538, y = 0.034, z = -9.618 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3005, monster_id = 20011201, pos = { x = 3.541, y = 0.034, z = 8.876 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	...
	{ config_id = 3008, monster_id = 21010301, pos = { x = 5.281, y = 0.034, z = 8.448 }, rot = { x = 0.000, y = 198.800, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3009, monster_id = 20011301, pos = { x = 0.164, y = 0.034, z = -11.233 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3010, monster_id = 21010701, pos = { x = 0.118, y = 0.034, z = 9.744 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3011, monster_id = 21020201, pos = { x = 0.162, y = 0.034, z = -17.049 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, affix = { 1028 }, isElite = true },
	{ config_id = 3012, monster_id = 21020101, pos = { x = 0.171, y = 0.034, z = -14.610 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3013, monster_id = 20011201, pos = { x = -11.043, y = 0.034, z = 11.071 }, rot = { x = 0.000, y = 146.360, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3014, monster_id = 20011201, pos = { x = 10.839, y = 0.034, z = 11.020 }, rot = { x = 0.000, y = 205.201, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3016, monster_id = 21010301, pos = { x = -0.018, y = 0.034, z = -12.808 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	...
	{ config_id = 3019, monster_id = 20011201, pos = { x = -8.173, y = 0.034, z = 6.275 }, rot = { x = 0.000, y = 133.400, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3020, monster_id = 21010301, pos = { x = 0.123, y = 0.034, z = 8.695 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3027, monster_id = 20011201, pos = { x = 2.237, y = 0.034, z = -9.696 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3028, monster_id = 21010301, pos = { x = -5.587, y = 0.034, z = 8.270 }, rot = { x = 0.000, y = 157.400, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3029, monster_id = 20011201, pos = { x = 8.232, y = 0.034, z = 5.868 }, rot = { x = 0.000, y = 230.800, z = 0.000 }, level = 1, drop_id = 11010210 }
}
...
function condition_EVENT_ANY_MONSTER_DIE_3022(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 241004003) ~= 0 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_3022(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 241004002, suite = 1 }) then
...
function action_EVENT_ANY_MONSTER_LIVE_3031(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 1, 241004003, 13, 0, 0) then
...
function action_EVENT_ANY_MONSTER_DIE_3032(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 241004003, 3)
...
function action_EVENT_ANY_MONSTER_DIE_3033(context, evt)
	-- 添加suite4的新内容
	    ScriptLib.AddExtraGroupSuite(context, 241004003, 4)
...
function condition_EVENT_ANY_MONSTER_DIE_3034(context, evt)
	...
	-- 判断变量"monster_wave_re"为3
	if ScriptLib.GetGroupVariableValue(context, "monster_wave_re") ~= 3 then
			return false
	end
...
function action_EVENT_CHALLENGE_SUCCESS_3035(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 1, 241004001) then
...
function action_EVENT_CHALLENGE_FAIL_3036(context, evt)
		...
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 241004003, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
			return -1
		end
...
function condition_EVENT_ANY_MONSTER_DIE_3037(context, evt)
	...
	-- 判断变量"stage"为1
	if ScriptLib.GetGroupVariableValueByGroup(context, "stage", 241004001) ~= 1 then
			return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_3037(context, evt)
	-- 添加suite6的新内容
	    ScriptLib.AddExtraGroupSuite(context, 241004003, 6)
