...
gadgets = {
	...
	{ config_id = 7002, gadget_id = 70350008, pos = { x = 0.317, y = 5.776, z = -65.627 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
-- 触发器
triggers = {
	{ name = "DUNGEON_SETTLE_7003", event = EventType.EVENT_DUNGEON_SETTLE, source = "", condition = "condition_EVENT_DUNGEON_SETTLE_7003", action = "action_EVENT_DUNGEON_SETTLE_7003" }
}
