...
gadgets = {
	...
	{ config_id = 14, gadget_id = 70350008, pos = { x = 0.300, y = 2.900, z = -42.800 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 15, gadget_id = 70350008, pos = { x = 0.944, y = 2.900, z = -42.800 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 16, gadget_id = 70350008, pos = { x = -0.734, y = 2.900, z = -42.800 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 17, gadget_id = 70350008, pos = { x = 1.296, y = 2.900, z = -42.353 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 18, gadget_id = 70350008, pos = { x = -0.679, y = 2.900, z = -42.449 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 19, gadget_id = 70350008, pos = { x = 0.300, y = 2.900, z = -42.288 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
