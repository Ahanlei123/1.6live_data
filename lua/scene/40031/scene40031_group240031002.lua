...
-- 怪物
monsters = {
	{ config_id = 2001, monster_id = 21010301, pos = { x = 526.010, y = -1.921, z = 245.618 }, rot = { x = 0.000, y = 150.000, z = 0.000 }, level = 1, affix = { 1007, 1008 } },
	...
	{ config_id = 2004, monster_id = 21010301, pos = { x = 538.729, y = -1.953, z = 245.587 }, rot = { x = 0.000, y = 210.000, z = 0.000 }, level = 1, affix = { 1007, 1008 } },
	{ config_id = 2005, monster_id = 21010201, pos = { x = 525.977, y = -1.984, z = 242.190 }, rot = { x = 0.000, y = 150.000, z = 0.000 }, level = 1, affix = { 1007, 1008 } },
	{ config_id = 2006, monster_id = 21020201, pos = { x = 538.589, y = -1.984, z = 237.988 }, rot = { x = 0.000, y = 210.000, z = 0.000 }, level = 1, affix = { 1007 } },
	{ config_id = 2007, monster_id = 21020201, pos = { x = 526.619, y = -1.984, z = 238.006 }, rot = { x = 0.000, y = 150.000, z = 0.000 }, level = 1, affix = { 1007 } },
...
triggers = {
	...
	{ config_id = 1002022, name = "CHALLENGE_FAIL_2022", event = EventType.EVENT_CHALLENGE_FAIL, source = "110110", condition = "", action = "action_EVENT_CHALLENGE_FAIL_2022", trigger_count = 0 },
	{ config_id = 1002023, name = "CHALLENGE_SUCCESS_2023", event = EventType.EVENT_CHALLENGE_SUCCESS, source = "110110", condition = "", action = "action_EVENT_CHALLENGE_SUCCESS_2023", trigger_count = 0 },
	{ config_id = 1002025, name = "MONSTER_TIDE_DIE_2025", event = EventType.EVENT_MONSTER_TIDE_DIE, source = "3", condition = "condition_EVENT_MONSTER_TIDE_DIE_2025", action = "action_EVENT_MONSTER_TIDE_DIE_2025" },
	{ config_id = 1002026, name = "MONSTER_TIDE_DIE_2026", event = EventType.EVENT_MONSTER_TIDE_DIE, source = "4", condition = "condition_EVENT_MONSTER_TIDE_DIE_2026", action = "action_EVENT_MONSTER_TIDE_DIE_2026", trigger_count = 0 },
	{ config_id = 1002027, name = "MONSTER_TIDE_DIE_2027", event = EventType.EVENT_MONSTER_TIDE_DIE, source = "5", condition = "condition_EVENT_MONSTER_TIDE_DIE_2027", action = "action_EVENT_MONSTER_TIDE_DIE_2027", trigger_count = 0 }
}
...
suites = {
	{
		...
		gadgets = { 2024 },
		regions = { },
		triggers = { "ANY_MONSTER_LIVE_2021", "CHALLENGE_FAIL_2022", "CHALLENGE_SUCCESS_2023", "MONSTER_TIDE_DIE_2025", "MONSTER_TIDE_DIE_2026", "MONSTER_TIDE_DIE_2027" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
		-- description = suite_2,
		monsters = { 2001, 2002, 2003, 2004, 2005, 2006, 2007 },
		gadgets = { 2024 },
		regions = { },
		triggers = { },
		rand_weight = 100
...
function action_EVENT_ANY_MONSTER_LIVE_2021(context, evt)
	ScriptLib.CreateFatherChallenge(context, 110110, 110110, 90, {success = 2, fail = 1, fail_on_wipe=true})
	ScriptLib.AttachChildChallenge(context, 110110, 110111, 110111, {15000,0,0,0},{},{success=1,fail=1})
	ScriptLib.AttachChildChallenge(context, 110110, 110112, 110112, {1,15,0,0},{},{success=1,fail=1})
	ScriptLib.StartFatherChallenge(context, 110110)
	return 0
end
...
function action_EVENT_CHALLENGE_FAIL_2022(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 240031002, suite = 1 }) then
...
function action_EVENT_CHALLENGE_SUCCESS_2023(context, evt)
	-- 改变指定group组240031001中， configid为1001的gadget的state
...
-- 触发条件
function condition_EVENT_MONSTER_TIDE_DIE_2025(context, evt)
...
-- 触发操作
function action_EVENT_MONSTER_TIDE_DIE_2025(context, evt)
