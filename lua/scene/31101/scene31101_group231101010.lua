...
-- 装置
gadgets = {
	{ config_id = 10001, gadget_id = 70350053, pos = { x = 0.031, y = 0.112, z = -0.010 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 10002, gadget_id = 70350054, pos = { x = 0.079, y = 0.096, z = 0.013 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
