...
-- 装置
gadgets = {
	{ config_id = 5001, gadget_id = 70340012, pos = { x = 0.000, y = 0.000, z = -46.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 5002, gadget_id = 70350008, pos = { x = 0.020, y = 5.646, z = -42.337 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
