...
-- 装置
gadgets = {
	{ config_id = 1001, gadget_id = 70350013, pos = { x = 0.091, y = 0.045, z = 24.158 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 1002, gadget_id = 70350013, pos = { x = 0.088, y = 0.098, z = -24.204 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 1003, gadget_id = 70360010, pos = { x = 0.000, y = 0.078, z = 0.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 1012, gadget_id = 44000006, pos = { x = 0.000, y = 0.000, z = 14.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
-- 点位
points = {
	{ config_id = 1006, pos = { x = 4.792, y = 0.047, z = -9.804 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, tag = 2 },
	{ config_id = 1007, pos = { x = -4.957, y = 0.047, z = -9.732 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, tag = 4 },
	{ config_id = 1008, pos = { x = 0.014, y = 0.046, z = -12.152 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, tag = 8 }
}
...
function action_EVENT_GADGET_CREATE_1004(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 240039001, 1003, {175}) then
...
function action_EVENT_SELECT_OPTION_1005(context, evt)
	-- 添加suite2的新内容
	    ScriptLib.AddExtraGroupSuite(context, 240039001, 2)
	
	-- 删除指定group： 240039001 ；指定config：1003；物件身上指定option：175；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 240039001, 1003, 175) then
...
function action_EVENT_GADGET_STATE_CHANGE_1009(context, evt)
	...
	-- 创建编号为201的子挑战：杀怪挑战
	if 0 ~= ScriptLib.AttachChildChallenge(context, 1, 201, 110188, {240039001,2},{},{success=0,fail=0}) then
		return -1
	end
	...
	if 0 ~= challenge_time then
		ScriptLib.AttachChildChallenge(context, 1, 202, 110189, {challenge_time,240039001,2},{},{success=0,fail=0})
	else
		ScriptLib.AddExtraGroupSuite(context, 240039001, 3)
	end
	...
	--  刷怪
	ScriptLib.CreateEffigyChallengeMonster(context, 240039001, {15001,15002})
	
	-- 卸载回血gadget
	if 0 ~= ScriptLib.RemoveEntityByConfigId(context, 240039001, EntityType.GADGET, 1012 ) then
...
function action_EVENT_CHALLENGE_FAIL_1011(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 240039001, suite = 1 }) then
