...
-- 装置
gadgets = {
	{ config_id = 4001, gadget_id = 70350053, pos = { x = 0.044, y = -0.082, z = 0.019 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4002, gadget_id = 70350054, pos = { x = 0.092, y = -0.098, z = 0.042 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
