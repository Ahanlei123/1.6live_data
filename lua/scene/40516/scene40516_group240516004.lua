...
-- 装置
gadgets = {
	{ config_id = 4001, gadget_id = 70340012, pos = { x = 0.243, y = 0.101, z = -69.754 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4002, gadget_id = 70350008, pos = { x = 0.218, y = 2.677, z = -65.187 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
