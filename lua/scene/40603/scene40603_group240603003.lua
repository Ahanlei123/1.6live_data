...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 21020201, pos = { x = -10.362, y = 0.120, z = 0.017 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	{ config_id = 3002, monster_id = 21020201, pos = { x = 0.021, y = 0.120, z = 10.573 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 3003, monster_id = 21020201, pos = { x = 10.245, y = 0.120, z = -0.034 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1 },
	{ config_id = 3004, monster_id = 21020201, pos = { x = 0.021, y = 0.120, z = 10.573 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 3006, monster_id = 21020201, pos = { x = 0.021, y = 0.120, z = -10.996 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3013, monster_id = 21010201, pos = { x = 2.685, y = 0.120, z = 10.853 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, pose_id = 402 },
	{ config_id = 3020, monster_id = 22010204, pos = { x = -0.018, y = 0.120, z = -10.128 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3034, monster_id = 21010201, pos = { x = -2.923, y = 0.120, z = 10.879 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, pose_id = 402 }
}
...
-- 装置
gadgets = {
	{ config_id = 3005, gadget_id = 70350035, pos = { x = -0.245, y = 0.038, z = -0.162 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26 },
