...
regions = {
	...
	{ config_id = 2015, shape = RegionShape.SPHERE, radius = 150, pos = { x = 715.273, y = 120.132, z = 260.409 }, area_id = 102, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE },
...
-- 变量
variables = {
	{ name = "findpoint", value = 0, no_refresh = false },
	{ name = "samandie", value = 0, no_refresh = false },
	{ name = "4001002", value = 1, no_refresh = false },
	{ name = "findpoint2", value = 0, no_refresh = false }
}
