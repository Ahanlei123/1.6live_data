...
-- 装置
gadgets = {
	{ config_id = 68001, gadget_id = 70220068, pos = { x = 524.702, y = 200.000, z = -115.064 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, persistent = true, area_id = 102 }
}

-- 区域
regions = {
	{ config_id = 68002, shape = RegionShape.SPHERE, radius = 8, pos = { x = 524.702, y = 200.000, z = -115.064 }, area_id = 102 },
	{ config_id = 68003, shape = RegionShape.SPHERE, radius = 8, pos = { x = 524.702, y = 200.000, z = -115.064 }, area_id = 102 },
	{ config_id = 68004, shape = RegionShape.SPHERE, radius = 10, pos = { x = 524.702, y = 200.000, z = -115.064 }, area_id = 102 }
}
...
triggers = {
	...
	{ config_id = 1068003, name = "ENTER_REGION_68003", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_68003", action = "action_EVENT_ENTER_REGION_68003", trigger_count = 0 },
...
-- 点位
points = {
	{ config_id = 68005, pos = { x = 519.360, y = 200.000, z = -104.650 }, rot = { x = 0.000, y = 332.014, z = 0.000 }, area_id = 102 }
}
...
suites = {
	{
		...
		monsters = { },
		gadgets = { 68001 },
		regions = { 68002, 68003, 68004 },
		triggers = { "ENTER_REGION_68002", "ENTER_REGION_68003", "ENTER_REGION_68004" },
		rand_weight = 100
	}
}
