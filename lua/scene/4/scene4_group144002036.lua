...
variables = {
	...
	{ name = "done", value = 0, no_refresh = false },
	{ name = "feng1", value = 2, no_refresh = false },
	{ name = "feng2", value = 1, no_refresh = false },
	{ name = "shui", value = 1, no_refresh = false },
	{ name = "lei", value = 2, no_refresh = false }
}
