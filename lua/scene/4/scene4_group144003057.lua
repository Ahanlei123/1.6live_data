...
-- 装置
gadgets = {
	{ config_id = 57001, gadget_id = 70210105, pos = { x = -556.091, y = 120.000, z = 907.200 }, rot = { x = 0.000, y = 235.625, z = 0.000 }, level = 26, chest_drop_id = 1002000, drop_count = 1, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 103 },
	{ config_id = 57002, gadget_id = 70950081, pos = { x = -574.100, y = 120.000, z = 806.137 }, rot = { x = 0.000, y = 235.625, z = 0.000 }, level = 1, start_route = false, is_use_point_array = true, area_id = 103 }
}

-- 区域
regions = {
	{ config_id = 57004, shape = RegionShape.SPHERE, radius = 5, pos = { x = -574.100, y = 120.000, z = 806.137 }, area_id = 103 }
}

-- 触发器
triggers = {
	{ config_id = 1057003, name = "AVATAR_NEAR_PLATFORM_57003", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_57003", action = "action_EVENT_AVATAR_NEAR_PLATFORM_57003", trigger_count = 0 },
	{ config_id = 1057004, name = "ENTER_REGION_57004", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_57004", action = "action_EVENT_ENTER_REGION_57004", trigger_count = 0 },
...
suites = {
	{
		...
		gadgets = { 57002 },
		regions = { 57004 },
		triggers = { "AVATAR_NEAR_PLATFORM_57003", "ENTER_REGION_57004", "PLATFORM_REACH_POINT_57005" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_57003(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_57003(context, evt)
...
-- 触发条件
function condition_EVENT_ENTER_REGION_57004(context, evt)
	if evt.param1 ~= 57004 then return false end
...
-- 触发操作
function action_EVENT_ENTER_REGION_57004(context, evt)
	return 0
end
