...
-- 区域
regions = {
	{ config_id = 1001, shape = RegionShape.SPHERE, radius = 30, pos = { x = 25.608, y = 118.755, z = -807.613 }, area_id = 101 }
}
...
function action_EVENT_ENTER_REGION_1001(context, evt)
	...
	if 0 ~= ScriptLib.AddQuestProgress(context, "14400400101") then
