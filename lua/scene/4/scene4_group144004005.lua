...
-- 变量
variables = {
	{ name = "times", value = 0, no_refresh = true },
	{ name = "correct", value = 0, no_refresh = true },
	{ name = "interact", value = 0, no_refresh = true },
	{ name = "complete", value = 0, no_refresh = true }
}
...
suite_disk = {
	[1] = {
		...
		npcs = { },
		variables = {
			{ name = "times", value = 0, no_refresh = false },
			{ name = "correct", value = 0, no_refresh = false },
			{ name = "interact", value = 0, no_refresh = false },
			{ name = "complete", value = 0, no_refresh = true }
		}
	},
	[2] = {
	...
	[3] = {
		...
		variables = {
			{ name = "times", value = 0, no_refresh = false },
			{ name = "correct", value = 0, no_refresh = false },
			{ name = "interact", value = 1, no_refresh = false },
			{ name = "complete", value = 0, no_refresh = true }
		}
	},
	[4] = {
		...
		npcs = { },
		variables = {
			{ name = "times", value = 4, no_refresh = false },
			{ name = "correct", value = 4, no_refresh = false },
			{ name = "interact", value = 0, no_refresh = false },
			{ name = "complete", value = 1, no_refresh = false }
		}
	},
	[5] = {
		gadgets = {
