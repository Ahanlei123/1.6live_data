...
monsters = {
	...
	{ config_id = 10017, monster_id = 28030101, pos = { x = -613.602, y = 207.428, z = 35.007 }, rot = { x = 0.000, y = 63.012, z = 0.000 }, level = 1, drop_tag = "鸟类", disableWander = true, pose_id = 2, area_id = 103 },
