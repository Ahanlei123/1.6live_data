...
local defs = {
	maxPathNode = 7,
	pointarray_route = 400300007,
	gadget_bubble = 111002,
	group_id = 144004111,
	gadget_reward = 111001
}
...
-- 装置
gadgets = {
	{ config_id = 111001, gadget_id = 70210105, pos = { x = -278.399, y = 200.000, z = 149.806 }, rot = { x = 0.000, y = 235.625, z = 0.000 }, level = 16, chest_drop_id = 1002000, drop_count = 1, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 103 },
	{ config_id = 111002, gadget_id = 70950081, pos = { x = -92.321, y = 200.000, z = 142.469 }, rot = { x = 0.000, y = 235.625, z = 0.000 }, level = 1, start_route = false, is_use_point_array = true, area_id = 102 }
}

-- 区域
regions = {
	{ config_id = 111004, shape = RegionShape.SPHERE, radius = 5, pos = { x = -92.321, y = 200.000, z = 142.469 }, area_id = 102 }
}
...
triggers = {
	...
	{ config_id = 1111004, name = "ENTER_REGION_111004", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_111004", action = "action_EVENT_ENTER_REGION_111004", trigger_count = 0 },
...
suites = {
	{
		...
		gadgets = { 111002 },
		regions = { 111004 },
		triggers = { "AVATAR_NEAR_PLATFORM_111003", "ENTER_REGION_111004", "PLATFORM_REACH_POINT_111005" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
