...
variables = {
	...
	{ name = "killedHoops", value = 0, no_refresh = false },
	{ name = "turncount", value = 0, no_refresh = false }
}
...
suites = {
	...
	},
	{
		...
		regions = { },
		triggers = { "SELECT_OPTION_147027", "GADGET_STATE_CHANGE_147043", "GADGET_STATE_CHANGE_147044", "GADGET_CREATE_147045" },
		rand_weight = 100
	},
	{
		-- suite_id = 11,
...
-- 触发条件
function condition_EVENT_SELECT_OPTION_147027(context, evt)
	-- 判断是gadgetid 147011 option_id 211
	if 147011 ~= evt.param1 then
		return false	
	end
...
-- 触发操作
function action_EVENT_SELECT_OPTION_147027(context, evt)
	-- 设置移动平台点阵,点阵id为point_array_id
	-- route_type = 0,1,2 [OneWay 单向/Reciprocate 往复/Loop 循环]
	-- turn_mode = true/false 开启/关闭
	local tempParam = {route_type = 0, turn_mode = true}
