...
triggers = {
	...
	{ config_id = 1142040, name = "GADGET_CREATE_142040", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_142040", action = "action_EVENT_GADGET_CREATE_142040", trigger_count = 0 },
	...
	{ config_id = 1142066, name = "SELECT_OPTION_142066", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_142066", action = "action_EVENT_SELECT_OPTION_142066", trigger_count = 0 },
...
-- 变量
variables = {
	{ name = "hoop1Pos", value = 0, no_refresh = false },
	{ name = "hoop2Pos", value = 0, no_refresh = false },
...
suites = {
	...
	},
	{
		...
		gadgets = { 142009 },
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_142038", "GADGET_STATE_CHANGE_142039", "GADGET_CREATE_142040", "SELECT_OPTION_142066" },
		rand_weight = 100
	}
}
...
function action_EVENT_GADGET_STATE_CHANGE_142039(context, evt)
	...
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 144001142, 142011, {211}) then
...
-- 触发条件
function condition_EVENT_GADGET_CREATE_142040(context, evt)
	if 142011 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_CREATE_142040(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 144001142, 142011, {211}) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_wok_options_by_configid")
		return -1
...
-- 触发条件
function condition_EVENT_SELECT_OPTION_142066(context, evt)
	-- 判断是gadgetid 142011 option_id 211
	if 142011 ~= evt.param1 then
		return false	
	end
...
-- 触发操作
function action_EVENT_SELECT_OPTION_142066(context, evt)
	-- 设置移动平台点阵,点阵id为point_array_id
	-- route_type = 0,1,2 [OneWay 单向/Reciprocate 往复/Loop 循环]
	-- turn_mode = true/false 开启/关闭
	local tempParam = {route_type = 0, turn_mode = true}
	if 0 ~= ScriptLib.SetPlatformPointArray(context, 142009, 110100018, {3}, tempParam) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_platform_pointArray")
	  return -1
	end
