...
-- 区域
regions = {
	{ config_id = 12001, shape = RegionShape.SPHERE, radius = 5, pos = { x = -345.377, y = 201.416, z = -616.453 }, area_id = 100 }
}
...
function action_EVENT_ENTER_REGION_12001(context, evt)
	...
	if 0 ~= ScriptLib.AddQuestProgress(context, "14400101201") then
