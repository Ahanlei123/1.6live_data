...
-- 区域
regions = {
	{ config_id = 119001, shape = RegionShape.SPHERE, radius = 168, pos = { x = 743.487, y = 120.493, z = 259.011 }, area_id = 102, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE }
}
