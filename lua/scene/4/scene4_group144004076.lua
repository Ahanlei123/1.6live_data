...
-- 装置
gadgets = {
	{ config_id = 76001, gadget_id = 70220068, pos = { x = 163.118, y = 200.000, z = -547.824 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, persistent = true, area_id = 101 }
}

-- 区域
regions = {
	{ config_id = 76002, shape = RegionShape.SPHERE, radius = 8, pos = { x = 163.118, y = 200.000, z = -547.824 }, area_id = 101 },
	{ config_id = 76003, shape = RegionShape.SPHERE, radius = 8, pos = { x = 163.118, y = 200.000, z = -547.824 }, area_id = 101 },
	{ config_id = 76004, shape = RegionShape.SPHERE, radius = 10, pos = { x = 160.551, y = 200.747, z = -544.765 }, area_id = 101 }
}
...
-- 点位
points = {
	{ config_id = 76005, pos = { x = 167.110, y = 200.747, z = -540.404 }, rot = { x = 0.000, y = 53.872, z = 0.000 }, area_id = 101 }
}
