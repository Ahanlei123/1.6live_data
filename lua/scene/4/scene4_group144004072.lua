...
-- 装置
gadgets = {
	{ config_id = 72001, gadget_id = 70220068, pos = { x = -193.209, y = 200.000, z = -658.525 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, persistent = true, area_id = 100 }
}

-- 区域
regions = {
	{ config_id = 72002, shape = RegionShape.SPHERE, radius = 8, pos = { x = -193.209, y = 201.731, z = -658.525 }, area_id = 100 },
	{ config_id = 72003, shape = RegionShape.SPHERE, radius = 8, pos = { x = -193.209, y = 201.731, z = -658.525 }, area_id = 100 },
	{ config_id = 72004, shape = RegionShape.SPHERE, radius = 10, pos = { x = -196.030, y = 200.000, z = -655.506 }, area_id = 100 }
}
...
-- 点位
points = {
	{ config_id = 72005, pos = { x = -189.470, y = 200.000, z = -651.144 }, rot = { x = 0.000, y = 53.872, z = 0.000 }, area_id = 100 }
}
