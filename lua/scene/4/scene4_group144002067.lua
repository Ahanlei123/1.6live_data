...
-- 变量
variables = {
	{ name = "monster_tide", value = 0, no_refresh = false },
	{ name = "time_out", value = 0, no_refresh = false },
	{ name = "monster_tide2", value = 0, no_refresh = false },
	{ name = "monster_tide3", value = 0, no_refresh = false }
}
