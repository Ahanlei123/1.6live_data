...
gadgets = {
	...
	{ config_id = 145002, gadget_id = 70211112, pos = { x = 135.919, y = 125.012, z = 285.538 }, rot = { x = 12.335, y = 278.474, z = 0.000 }, level = 16, drop_tag = "解谜中级群岛", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 102 },
...
triggers = {
	...
	{ config_id = 1145041, name = "GADGET_CREATE_145041", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_145041", action = "action_EVENT_GADGET_CREATE_145041", trigger_count = 0 },
...
variables = {
	...
	{ name = "complete", value = 0, no_refresh = false }
}
...
suites = {
	...
	},
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_145039", "GADGET_STATE_CHANGE_145040", "GADGET_CREATE_145041" },
		rand_weight = 100
	},
	{
		-- suite_id = 7,
...
-- 触发条件
function condition_EVENT_GADGET_CREATE_145041(context, evt)
	if 145011 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_CREATE_145041(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 144001145, 145011, {211}) then
