...
-- 装置
gadgets = {
	{ config_id = 74001, gadget_id = 70220068, pos = { x = 3.812, y = 200.000, z = -630.505 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, persistent = true, area_id = 101 }
}

-- 区域
regions = {
	{ config_id = 74002, shape = RegionShape.SPHERE, radius = 8, pos = { x = 3.812, y = 200.000, z = -630.505 }, area_id = 101 },
	{ config_id = 74003, shape = RegionShape.SPHERE, radius = 8, pos = { x = 3.812, y = 200.000, z = -630.505 }, area_id = 101 },
	{ config_id = 74004, shape = RegionShape.SPHERE, radius = 10, pos = { x = 1.507, y = 200.701, z = -627.493 }, area_id = 101 }
}
...
-- 点位
points = {
	{ config_id = 74005, pos = { x = 8.066, y = 200.701, z = -623.132 }, rot = { x = 0.000, y = 53.872, z = 0.000 }, area_id = 101 }
}
