...
gadgets = {
	...
	{ config_id = 13012, gadget_id = 70220021, pos = { x = -732.754, y = 102.399, z = 398.374 }, rot = { x = 9.313, y = 197.711, z = 0.000 }, level = 1, area_id = 103 },
...
-- 变量
variables = {
	{ name = "dooropen", value = 0, no_refresh = false }
}
