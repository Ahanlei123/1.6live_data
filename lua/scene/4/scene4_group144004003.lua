...
-- 区域
regions = {
	{ config_id = 3001, shape = RegionShape.SPHERE, radius = 5, pos = { x = -344.217, y = 201.267, z = -616.082 }, area_id = 100 }
}
...
function action_EVENT_ENTER_REGION_3001(context, evt)
	...
	if 0 ~= ScriptLib.AddQuestProgress(context, "14400400301") then
