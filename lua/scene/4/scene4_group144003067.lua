...
-- 装置
gadgets = {
	{ config_id = 67001, gadget_id = 70220068, pos = { x = -386.776, y = 200.000, z = 31.900 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, persistent = true, area_id = 103 }
}

-- 区域
regions = {
	{ config_id = 67002, shape = RegionShape.SPHERE, radius = 8, pos = { x = -386.776, y = 200.000, z = 31.900 }, area_id = 103 },
	{ config_id = 67003, shape = RegionShape.SPHERE, radius = 8, pos = { x = -386.776, y = 200.000, z = 31.900 }, area_id = 103 },
	{ config_id = 67004, shape = RegionShape.SPHERE, radius = 10, pos = { x = -386.776, y = 200.000, z = 31.900 }, area_id = 103 }
}
...
-- 点位
points = {
	{ config_id = 67005, pos = { x = -402.873, y = 200.000, z = 33.533 }, rot = { x = 0.000, y = 245.070, z = 0.000 }, area_id = 103 }
}
