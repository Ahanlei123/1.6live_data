...
-- 装置
gadgets = {
	{ config_id = 71001, gadget_id = 70220068, pos = { x = 295.624, y = 200.000, z = -504.382 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, persistent = true, area_id = 101 }
}

-- 区域
regions = {
	{ config_id = 71002, shape = RegionShape.SPHERE, radius = 8, pos = { x = 295.624, y = 200.000, z = -504.382 }, area_id = 101 },
	{ config_id = 71003, shape = RegionShape.SPHERE, radius = 8, pos = { x = 295.624, y = 200.000, z = -504.382 }, area_id = 101 },
	{ config_id = 71004, shape = RegionShape.SPHERE, radius = 10, pos = { x = 294.072, y = 200.000, z = -502.826 }, area_id = 101 }
}
...
-- 点位
points = {
	{ config_id = 71005, pos = { x = 300.632, y = 200.000, z = -498.465 }, rot = { x = 0.000, y = 53.872, z = 0.000 }, area_id = 101 }
}
