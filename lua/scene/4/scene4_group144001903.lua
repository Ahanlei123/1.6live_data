...
-- 变量
variables = {
	{ name = "Gear", value = 0, no_refresh = false },
	{ name = "FirstReminder", value = 0, no_refresh = false },
	{ name = "Gear1", value = 0, no_refresh = false },
	{ name = "Gear2", value = 0, no_refresh = false },
	{ name = "Gear3", value = 0, no_refresh = false }
}
