...
-- 装置
gadgets = {
	{ config_id = 4001, gadget_id = 70350053, pos = { x = 0.154, y = 0.028, z = -0.045 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4002, gadget_id = 70350054, pos = { x = 0.154, y = 0.028, z = -0.045 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
