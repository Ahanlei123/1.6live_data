...
-- 装置
gadgets = {
	{ config_id = 5001, gadget_id = 70350053, pos = { x = -0.023, y = 0.153, z = -0.001 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 5002, gadget_id = 70350054, pos = { x = 0.025, y = 0.138, z = 0.021 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
