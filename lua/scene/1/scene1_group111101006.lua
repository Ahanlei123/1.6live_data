...
-- 怪物
monsters = {
	{ config_id = 6001, monster_id = 28050201, pos = { x = 2594.781, y = 212.367, z = -1354.458 }, rot = { x = 0.000, y = 29.457, z = 0.000 }, level = 1, drop_tag = "魔法生物" },
	{ config_id = 6002, monster_id = 28050201, pos = { x = 2603.056, y = 213.657, z = -1359.396 }, rot = { x = 0.000, y = 29.457, z = 0.000 }, level = 1, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 6003, gadget_id = 70360027, pos = { x = 2603.159, y = 213.581, z = -1359.553 }, rot = { x = 0.000, y = 104.100, z = 0.000 }, level = 1, persistent = true },
	{ config_id = 6004, gadget_id = 70360015, pos = { x = 2595.075, y = 212.285, z = -1354.343 }, rot = { x = 0.000, y = 15.100, z = 0.000 }, level = 1, persistent = true }
}
...
triggers = {
	...
	{ config_id = 1006006, name = "SELECT_OPTION_6006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_6006", action = "action_EVENT_SELECT_OPTION_6006", trigger_count = 0, forbid_guest = false },
	...
	{ config_id = 1006009, name = "GADGET_CREATE_6009", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "", action = "action_EVENT_GADGET_CREATE_6009", trigger_count = 0 }
}
