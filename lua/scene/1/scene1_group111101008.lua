...
-- 怪物
monsters = {
	{ config_id = 8001, monster_id = 21010101, pos = { x = 2563.416, y = 211.681, z = -1293.900 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 1000100 }
}
...
-- 装置
gadgets = {
	{ config_id = 8002, gadget_id = 70900007, pos = { x = 2563.416, y = 212.341, z = -1289.300 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, persistent = true },
	{ config_id = 8003, gadget_id = 70211111, pos = { x = 2563.116, y = 213.095, z = -1284.900 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "解谜中级蒙德", showcutscene = true, isOneoff = true, persistent = true }
}
...
triggers = {
	...
	{ config_id = 1008005, name = "CHALLENGE_SUCCESS_8005", event = EventType.EVENT_CHALLENGE_SUCCESS, source = "180", condition = "", action = "action_EVENT_CHALLENGE_SUCCESS_8005" },
	{ config_id = 1008006, name = "CHALLENGE_FAIL_8006", event = EventType.EVENT_CHALLENGE_FAIL, source = "180", condition = "", action = "action_EVENT_CHALLENGE_FAIL_8006" }
}
