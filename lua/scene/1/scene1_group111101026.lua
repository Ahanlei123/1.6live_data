...
-- 装置
gadgets = {
	{ config_id = 26001, gadget_id = 70220032, pos = { x = 2521.732, y = 215.895, z = -1297.820 }, rot = { x = 0.000, y = 196.100, z = 0.000 }, level = 18 },
	{ config_id = 26002, gadget_id = 70211101, pos = { x = 2520.320, y = 215.343, z = -1299.743 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "解谜低级蒙德", showcutscene = true, isOneoff = true, persistent = true }
}
...
-- 触发器
triggers = {
	{ config_id = 1026003, name = "GADGET_STATE_CHANGE_26003", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_26003", action = "action_EVENT_GADGET_STATE_CHANGE_26003" },
	...
	{ config_id = 1026005, name = "GADGET_STATE_CHANGE_26005", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_26005", action = "action_EVENT_GADGET_STATE_CHANGE_26005", trigger_count = 0 },
	{ config_id = 1026006, name = "GADGET_CREATE_26006", event = EventType.EVENT_GADGET_CREATE, source = "111", condition = "condition_EVENT_GADGET_CREATE_26006", action = "action_EVENT_GADGET_CREATE_26006", trigger_count = 0 }
}
