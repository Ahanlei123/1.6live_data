...
monsters = {
	...
	{ config_id = 6003, monster_id = 21011001, pos = { x = -8.609, y = 0.082, z = 9.042 }, rot = { x = 0.000, y = 141.500, z = 0.000 }, level = 1, affix = { 1031 }, pose_id = 32 },
	{ config_id = 6004, monster_id = 21011001, pos = { x = 9.183, y = 0.082, z = 8.828 }, rot = { x = 0.000, y = 213.100, z = 0.000 }, level = 1, affix = { 1031 }, pose_id = 32 },
	{ config_id = 6005, monster_id = 20011301, pos = { x = 0.113, y = 0.082, z = -11.345 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1031 } },
	{ config_id = 6006, monster_id = 20010501, pos = { x = -11.167, y = 0.082, z = -4.080 }, rot = { x = 0.000, y = 64.828, z = 0.000 }, level = 1 },
	...
	{ config_id = 6009, monster_id = 20010501, pos = { x = 10.540, y = 0.082, z = -3.846 }, rot = { x = 0.000, y = 296.100, z = 0.000 }, level = 1 },
	{ config_id = 6010, monster_id = 20010601, pos = { x = 0.101, y = 0.082, z = -9.483 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 6011, monster_id = 20010501, pos = { x = -11.167, y = 0.082, z = -4.080 }, rot = { x = 0.000, y = 64.828, z = 0.000 }, level = 1 },
	...
	{ config_id = 6015, monster_id = 21011001, pos = { x = -11.061, y = 0.082, z = 7.643 }, rot = { x = 0.000, y = 139.840, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 6016, monster_id = 21011001, pos = { x = 11.335, y = 0.082, z = 7.491 }, rot = { x = 0.000, y = 230.100, z = 0.000 }, level = 1, pose_id = 32 },
	...
	{ config_id = 6018, monster_id = 20010501, pos = { x = 10.540, y = 0.082, z = -3.846 }, rot = { x = 0.000, y = 296.100, z = 0.000 }, level = 1 },
	{ config_id = 6019, monster_id = 20011301, pos = { x = 0.218, y = 0.082, z = -10.891 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1031 } },
	{ config_id = 6020, monster_id = 20010701, pos = { x = 0.101, y = 0.082, z = -9.483 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	...
	{ config_id = 6022, monster_id = 20010604, pos = { x = 9.360, y = 0.082, z = -9.019 }, rot = { x = 0.000, y = 323.678, z = 0.000 }, level = 1 },
	{ config_id = 6023, monster_id = 20010702, pos = { x = -8.843, y = 0.082, z = -9.421 }, rot = { x = 0.000, y = 48.200, z = 0.000 }, level = 1 },
	{ config_id = 6024, monster_id = 20011304, pos = { x = 0.031, y = 0.082, z = -9.945 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1031 } },
	{ config_id = 6025, monster_id = 21011002, pos = { x = -16.580, y = 0.082, z = -0.203 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 6027, monster_id = 21011002, pos = { x = 17.228, y = 0.082, z = -0.090 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 6029, monster_id = 22010104, pos = { x = 0.231, y = 0.082, z = -12.220 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1031 } },
	...
	{ config_id = 6044, monster_id = 21011001, pos = { x = -11.061, y = 0.082, z = 7.643 }, rot = { x = 0.000, y = 139.840, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 6045, monster_id = 21011001, pos = { x = 11.335, y = 0.082, z = 7.491 }, rot = { x = 0.000, y = 230.100, z = 0.000 }, level = 1, pose_id = 32 },
...
-- 触发器
triggers = {
	{ config_id = 1006007, name = "DUNGEON_SETTLE_6007", event = EventType.EVENT_DUNGEON_SETTLE, source = "", condition = "", action = "action_EVENT_DUNGEON_SETTLE_6007" },
...
function action_EVENT_ANY_MONSTER_LIVE_6032(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 188, 231902006, 25, 6030, 0) then
...
function condition_EVENT_ANY_MONSTER_DIE_6033(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 231902006) ~= 0 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_6033(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 231902006, 3)
...
function action_EVENT_ANY_MONSTER_DIE_6034(context, evt)
	-- 添加suite4的新内容
	    ScriptLib.AddExtraGroupSuite(context, 231902006, 4)
...
function action_EVENT_ANY_MONSTER_DIE_6035(context, evt)
	-- 添加suite5的新内容
	    ScriptLib.AddExtraGroupSuite(context, 231902006, 5)
...
function action_EVENT_CHALLENGE_SUCCESS_6036(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 1, 231902005) then
	...
	-- 改变指定group组231902007中， configid为7001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231902007, 7001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 231902007, 7001, {176}) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_wok_options_by_configid")
		return -1
	end
	
	-- 改变指定group组231902008中， configid为8001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231902008, 8001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 改变指定group组231902008中， configid为8002的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231902008, 8002, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
...
function action_EVENT_CHALLENGE_FAIL_6037(context, evt)
	-- 改变指定group组231902007中， configid为7001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231902007, 7001, GadgetState.GearAction2) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 231902006, suite = 1 }) then
...
function action_EVENT_ANY_MONSTER_DIE_6038(context, evt)
	-- 添加suite8的新内容
	    ScriptLib.AddExtraGroupSuite(context, 231902006, 8)
...
function action_EVENT_ANY_MONSTER_LIVE_6039(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 2, 188, 231902006, 6, 6030, 0) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge")
		return -1
	end
...
function action_EVENT_CHALLENGE_SUCCESS_6040(context, evt)
	-- 改变指定group组231902007中， configid为7001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231902007, 7001, GadgetState.GearAction1) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 将本组内变量名为 "stage" 的变量设置为 2
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 231902005) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
...
function action_EVENT_ANY_MONSTER_DIE_6047(context, evt)
	-- 添加suite6的新内容
	    ScriptLib.AddExtraGroupSuite(context, 231902006, 6)
