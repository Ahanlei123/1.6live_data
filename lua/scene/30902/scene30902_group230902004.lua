...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 22010302, pos = { x = 0.064, y = 0.034, z = -9.774 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4002, monster_id = 21010502, pos = { x = 0.146, y = 0.034, z = 12.115 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 4003, monster_id = 20011103, pos = { x = 0.018, y = 0.034, z = -9.775 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4008, monster_id = 21020202, pos = { x = 0.076, y = 0.034, z = 9.651 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 4009, monster_id = 20011103, pos = { x = 3.915, y = 0.034, z = -9.616 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4010, monster_id = 20011103, pos = { x = -3.935, y = 0.034, z = -9.797 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4014, monster_id = 21020101, pos = { x = 0.069, y = 0.034, z = 9.620 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 4020, monster_id = 22010104, pos = { x = 0.006, y = 0.034, z = -7.910 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1028 } }
}
...
function action_EVENT_ANY_MONSTER_LIVE_4031(context, evt)
	...
	-- 从230902001的变量TPL_TIME中取出对应值并开启挑战
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 230902004, 8, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
