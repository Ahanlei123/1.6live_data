...
-- 怪物
monsters = {
	{ config_id = 11001, monster_id = 20011001, pos = { x = 4.255, y = 69.432, z = 76.582 }, rot = { x = 0.000, y = 301.167, z = 0.000 }, level = 1 },
	{ config_id = 11002, monster_id = 20011101, pos = { x = -6.758, y = 69.431, z = 75.375 }, rot = { x = 0.000, y = 301.167, z = 0.000 }, level = 1 },
	{ config_id = 11003, monster_id = 20011001, pos = { x = 5.072, y = 69.504, z = 82.916 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 11004, monster_id = 20011001, pos = { x = -3.469, y = 69.509, z = 76.118 }, rot = { x = 0.000, y = 301.167, z = 0.000 }, level = 1 },
	{ config_id = 11005, monster_id = 20011001, pos = { x = 2.363, y = 69.507, z = 79.594 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
