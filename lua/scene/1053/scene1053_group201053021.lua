...
-- 变量
variables = {
	{ name = "icon1Appear", value = 0, no_refresh = false },
	{ name = "icon2Appear", value = 0, no_refresh = false },
	{ name = "icon3Appear", value = 0, no_refresh = false },
	{ name = "icon4Appear", value = 0, no_refresh = false },
	{ name = "default", value = 0, no_refresh = false },
	{ name = "icon5Appear", value = 0, no_refresh = false },
	{ name = "icon6Appear", value = 0, no_refresh = false },
	{ name = "icon7Appear", value = 0, no_refresh = false },
	{ name = "icon8Appear", value = 0, no_refresh = false }
}
