...
-- 变量
variables = {
	{ name = "step", value = 0, no_refresh = false },
	{ name = "enid", value = 99, no_refresh = false },
	{ name = "act", value = 0, no_refresh = false }
}
...
function action_EVENT_CHALLENGE_FAIL_2001(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 240022002, suite = 3 }) then
