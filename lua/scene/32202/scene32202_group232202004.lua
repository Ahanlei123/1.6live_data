...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 21020201, pos = { x = 0.154, y = 0.034, z = 12.096 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 4002, monster_id = 21010902, pos = { x = -14.508, y = 0.034, z = -0.131 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	{ config_id = 4003, monster_id = 21010902, pos = { x = 14.696, y = 0.034, z = 0.014 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1 },
	{ config_id = 4006, monster_id = 22010204, pos = { x = 0.119, y = 0.034, z = 9.670 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	...
	{ config_id = 4020, monster_id = 21020201, pos = { x = 0.122, y = 0.034, z = -12.097 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_4032(context, evt)
	...
	-- 从232202001的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 232202001)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 232202004, 7, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function condition_EVENT_ANY_MONSTER_DIE_4033(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 232202004) ~= 0 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_4033(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 232202004, 3)
...
function action_EVENT_ANY_MONSTER_DIE_4034(context, evt)
	-- 添加suite4的新内容
	    ScriptLib.AddExtraGroupSuite(context, 232202004, 4)
...
function action_EVENT_CHALLENGE_SUCCESS_4036(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 232202001) then
...
function action_EVENT_CHALLENGE_FAIL_4037(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 232202004, suite = 1 }) then
