...
local defs = {
	...
	trap_group_id = 242002013,
	init_building_points = 400,
	speed_down_gadget = 1041
}

-- DEFS_MISCS
trap_group={242002013}

tide_group_defs ={
        [1] = {group = 242002003, delay = 30, next_group = 2, buff = {1,2,3},guide_routes={1},enter={1001},exit={1004},enter_id={5},exit_id={6}},
        [2] = {group = 242002004, delay = 30, next_group = 3, buff = {1,2,3},guide_routes={1,2},enter={1003,1001},exit={1004},enter_id={4,5},exit_id={6}},
        [3] = {group = 242002005, delay = 30, next_group = 4, buff = {1,2,3},guide_routes={1,2},enter={1003,1001},exit={1004},enter_id={4,5},exit_id={6}},
        [4] = {group = 242002006, delay = 30, next_group = 0, buff = {1,2,3},guide_routes={1,2},enter={1003,1001},exit={1004},enter_id={4,5},exit_id={6}},
