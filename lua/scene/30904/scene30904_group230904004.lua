...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 24010101, pos = { x = 0.230, y = 0.034, z = -17.130 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, pose_id = 100 },
	{ config_id = 4003, monster_id = 24010101, pos = { x = 0.093, y = 0.034, z = 17.004 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, pose_id = 100 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_4013(context, evt)
	...
	-- 从230904001的变量TPL_TIME中取出对应值并开启挑战
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 230904004, 2, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
