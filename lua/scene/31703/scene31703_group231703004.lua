...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 21020202, pos = { x = 0.174, y = 0.034, z = -13.351 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4002, monster_id = 21020202, pos = { x = 0.146, y = 0.034, z = 12.091 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 4004, monster_id = 22010102, pos = { x = 0.069, y = 0.034, z = -12.152 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4006, monster_id = 21010902, pos = { x = 14.718, y = 0.034, z = -0.039 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1 },
	{ config_id = 4008, monster_id = 21010902, pos = { x = -12.129, y = 0.034, z = 0.020 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 }
}
...
-- 装置
gadgets = {
	{ config_id = 4003, gadget_id = 70350033, pos = { x = 0.152, y = 0.047, z = 6.072 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
...
function action_EVENT_ANY_MONSTER_LIVE_4025(context, evt)
	...
	-- 从231703001的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 231703001)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 231703004, 5, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
	...
	-- 改变指定group组231703004中， configid为4003的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231703004, 4003, GadgetState.GearStart) then
...
function condition_EVENT_ANY_MONSTER_DIE_4026(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 231703004) ~= 0 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_4026(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 231703004, 3)
...
function action_EVENT_CHALLENGE_SUCCESS_4029(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 231703001) then
...
function action_EVENT_CHALLENGE_FAIL_4030(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 231703004, suite = 1 }) then
