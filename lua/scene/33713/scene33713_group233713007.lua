...
-- 怪物
monsters = {
	{ config_id = 7001, monster_id = 21011401, pos = { x = 18.259, y = 0.046, z = 3.538 }, rot = { x = 0.000, y = 269.994, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7002, monster_id = 21011401, pos = { x = 18.150, y = 0.046, z = -3.742 }, rot = { x = 0.000, y = 269.994, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7003, monster_id = 21011401, pos = { x = 17.204, y = 0.046, z = 0.007 }, rot = { x = 0.000, y = 269.994, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7004, monster_id = 21011401, pos = { x = -0.403, y = -0.044, z = -12.100 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1031 } },
	{ config_id = 7005, monster_id = 21011401, pos = { x = 7.083, y = -0.044, z = -12.359 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1031 } },
	{ config_id = 7006, monster_id = 21011401, pos = { x = -6.333, y = -0.044, z = -12.427 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1031 } },
	{ config_id = 7007, monster_id = 21020601, pos = { x = -0.058, y = 0.046, z = -14.391 }, rot = { x = 0.000, y = 0.052, z = 0.000 }, level = 1, disableWander = true, affix = { 1031 } },
	{ config_id = 7008, monster_id = 26010101, pos = { x = -3.655, y = 0.046, z = -14.344 }, rot = { x = 0.000, y = 0.052, z = 0.000 }, level = 1, disableWander = true, affix = { 1031 } },
	{ config_id = 7009, monster_id = 26010101, pos = { x = 3.672, y = 0.046, z = -14.399 }, rot = { x = 0.000, y = 0.052, z = 0.000 }, level = 1, disableWander = true, affix = { 1031 } },
	{ config_id = 7012, monster_id = 21011401, pos = { x = -17.929, y = 0.046, z = -3.577 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7016, monster_id = 21011401, pos = { x = -17.958, y = 0.046, z = 3.704 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7017, monster_id = 21011401, pos = { x = -16.941, y = 0.046, z = -0.027 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function action_EVENT_ANY_MONSTER_LIVE_7013(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 197, 600, 233713007, 15, 0) then
...
function action_EVENT_CHALLENGE_SUCCESS_7014(context, evt)
	-- 将剩余时间记录在触发此challenge的group变量TPL_TIME中
	    if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "TPL_TIME", evt.param2, 233713005) then
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 1, 233713005) then
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 233713006, 6001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 233713006, 6001, {176}) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_wok_options_by_configid")
		return -1
	end
	
	-- 改变指定group组233713005中， configid为5001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 233713005, 5001, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 233713006, 6006, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 改变指定group组233713006中， configid为6007的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 233713006, 6007, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	...
	-- 删除suite2的所有内容
	    ScriptLib.RemoveExtraGroupSuite(context, 233713006, 2)
...
function action_EVENT_CHALLENGE_FAIL_7015(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 233713007, suite = 1 }) then
