...
-- DEFS_MISCS
trap_group={242012022,242012023}

tide_group_defs ={
        [1] = {group = 242012018, delay = 60, next_group = 2, buff = {1,2,3},guide_routes={1,2},enter={17001,17003},exit={17002},enter_id={10,11},exit_id={13}},
        [2] = {group = 242012019, delay = 60, next_group = 3, buff = {1,2,3},guide_routes={1,2},enter={17001,17003},exit={17002},enter_id={10,11},exit_id={13}},
        [3] = {group = 242012020, delay = 60, next_group = 4, buff = {1,2,3},guide_routes={1,2,3},enter={17001,17003,17006},exit={17002},enter_id={10,11,12},exit_id={13}},
        [4] = {group = 242012021, delay = 60, next_group = 5, buff = {1,2,3},guide_routes={1,2,3},enter={},enter={17001,17003,17006},exit={17002},enter_id={10,11,12},exit_id={13}},
        [5] = {group = 242012024, delay = 60, next_group = 6, buff = {1,2,3},guide_routes={1,2,3},enter={},enter={17001,17003,17006},exit={17002},enter_id={10,11,12},exit_id={13}},
        [6] = {group = 242012025, delay = 60, next_group = 0, buff = {1,2,3},guide_routes={1,2,3},enter={},enter={17001,17003,17006},exit={17002},enter_id={10,11,12},exit_id={13}},
}
...
gadgets = {
	...
	[17039] = { config_id = 17039, gadget_id = 70350176, pos = { x = 76.005, y = -13.390, z = -4.664 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	[17040] = { config_id = 17040, gadget_id = 70350166, pos = { x = 107.236, y = -9.640, z = -4.955 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	[17041] = { config_id = 17041, gadget_id = 70350176, pos = { x = 106.386, y = -9.634, z = 18.473 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	[17042] = { config_id = 17042, gadget_id = 70350176, pos = { x = 136.281, y = -13.401, z = -24.170 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	[17043] = { config_id = 17043, gadget_id = 70350176, pos = { x = 106.046, y = -9.636, z = -54.873 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
