...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 22010302, pos = { x = 0.064, y = -0.110, z = -9.774 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 6106 }, isElite = true },
	{ config_id = 4002, monster_id = 21010502, pos = { x = -17.039, y = -0.110, z = -0.012 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 4003, monster_id = 22010102, pos = { x = 0.018, y = -0.110, z = -9.775 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1028 }, isElite = true },
	{ config_id = 4004, monster_id = 21010502, pos = { x = 15.998, y = -0.110, z = -0.091 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 4008, monster_id = 21020202, pos = { x = 0.076, y = -0.110, z = 9.651 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, affix = { 6105 }, isElite = true }
}
...
function action_EVENT_ANY_MONSTER_LIVE_4031(context, evt)
	...
	-- 从233702001的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 233702001)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 233702004, 5, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function condition_EVENT_ANY_MONSTER_DIE_4032(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 233702004) ~= 0 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_4032(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 233702004, 3)
...
function action_EVENT_CHALLENGE_SUCCESS_4035(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 233702001) then
...
function action_EVENT_CHALLENGE_FAIL_4036(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 233702004, suite = 1 }) then
