...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 20011001, pos = { x = 4.791, y = 0.080, z = -5.709 }, rot = { x = 0.000, y = 346.531, z = 0.000 }, level = 1 },
	{ config_id = 3002, monster_id = 21010301, pos = { x = -7.006, y = 0.080, z = -5.185 }, rot = { x = 0.000, y = 21.465, z = 0.000 }, level = 1 },
	{ config_id = 3003, monster_id = 20011001, pos = { x = -3.459, y = 0.080, z = -8.799 }, rot = { x = 0.000, y = 18.562, z = 0.000 }, level = 1 },
	{ config_id = 3004, monster_id = 21010301, pos = { x = -2.766, y = 0.080, z = -6.322 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3005, monster_id = 20011001, pos = { x = 6.081, y = 0.080, z = -1.856 }, rot = { x = 0.000, y = 343.731, z = 0.000 }, level = 1 },
	{ config_id = 3006, monster_id = 21010301, pos = { x = -6.157, y = 0.080, z = -1.281 }, rot = { x = 0.000, y = 64.828, z = 0.000 }, level = 1 },
	{ config_id = 3007, monster_id = 20010501, pos = { x = 7.267, y = 0.080, z = 0.147 }, rot = { x = 0.000, y = 270.084, z = 0.000 }, level = 1 },
	{ config_id = 3008, monster_id = 21010301, pos = { x = 0.633, y = 0.080, z = 6.391 }, rot = { x = 0.000, y = 182.789, z = 0.000 }, level = 1 },
	{ config_id = 3009, monster_id = 20010501, pos = { x = 2.791, y = 0.080, z = -6.903 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3010, monster_id = 21010301, pos = { x = -5.842, y = 0.080, z = -7.808 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3011, monster_id = 21010701, pos = { x = 9.672, y = 0.080, z = 3.017 }, rot = { x = 0.000, y = 234.100, z = 0.000 }, level = 1 },
	{ config_id = 3012, monster_id = 21011001, pos = { x = 11.545, y = 0.080, z = -8.290 }, rot = { x = 0.000, y = 322.134, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 3013, monster_id = 21010701, pos = { x = -0.488, y = 0.080, z = -10.193 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3014, monster_id = 21011001, pos = { x = -12.953, y = 0.080, z = -5.355 }, rot = { x = 0.000, y = 50.168, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 3015, monster_id = 21010701, pos = { x = -9.889, y = 0.080, z = 5.313 }, rot = { x = 0.000, y = 126.700, z = 0.000 }, level = 1 },
	{ config_id = 3017, monster_id = 20010801, pos = { x = -7.165, y = 0.080, z = 1.714 }, rot = { x = 0.000, y = 101.360, z = 0.000 }, level = 1 },
	{ config_id = 3018, monster_id = 20011001, pos = { x = 5.665, y = 0.080, z = 1.955 }, rot = { x = 0.000, y = 274.510, z = 0.000 }, level = 1 },
	{ config_id = 3019, monster_id = 20010801, pos = { x = -4.647, y = 0.080, z = 5.034 }, rot = { x = 0.000, y = 133.400, z = 0.000 }, level = 1 },
	{ config_id = 3020, monster_id = 20011001, pos = { x = 2.626, y = 0.080, z = 6.182 }, rot = { x = 0.000, y = 203.110, z = 0.000 }, level = 1 },
	...
	{ config_id = 3029, monster_id = 20010801, pos = { x = 5.098, y = 0.080, z = 4.797 }, rot = { x = 0.000, y = 230.800, z = 0.000 }, level = 1 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_3031(context, evt)
	-- 创建编号为1（该挑战的识别id),挑战内容为1003的区域挑战，具体参数填写方式，见DungeonChallengeData表中的注释，所有填写的值都必须是int类型
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 1003, 300, 230103003, 23, 0) then
...
function condition_EVENT_ANY_MONSTER_DIE_3032(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 230103003) ~= 0 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_3032(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 230103003, 3)
...
function action_EVENT_ANY_MONSTER_DIE_3033(context, evt)
	-- 添加suite4的新内容
	    ScriptLib.AddExtraGroupSuite(context, 230103003, 4)
...
function action_EVENT_ANY_MONSTER_DIE_3034(context, evt)
	-- 添加suite5的新内容
	    ScriptLib.AddExtraGroupSuite(context, 230103003, 5)
...
function action_EVENT_CHALLENGE_SUCCESS_3035(context, evt)
	-- 改变指定group组230103001中， configid为1002的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 230103001, 1002, GadgetState.GearStart) then
...
function action_EVENT_CHALLENGE_FAIL_3036(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 230103003, suite = 1 }) then
...
function action_EVENT_ANY_MONSTER_DIE_3037(context, evt)
	-- 添加suite6的新内容
	    ScriptLib.AddExtraGroupSuite(context, 230103003, 6)
