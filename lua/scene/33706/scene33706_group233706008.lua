...
-- 怪物
monsters = {
	{ config_id = 8001, monster_id = 22010203, pos = { x = 3.609, y = 0.046, z = -11.137 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1031, 6101 }, isElite = true },
	{ config_id = 8002, monster_id = 21020601, pos = { x = 0.008, y = 0.046, z = 14.638 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 8003, monster_id = 22010202, pos = { x = 0.030, y = 0.030, z = -12.875 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1031 } },
	{ config_id = 8004, monster_id = 21030501, pos = { x = -12.196, y = 0.046, z = -9.718 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8005, monster_id = 21030501, pos = { x = 12.146, y = 0.046, z = -9.659 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8006, monster_id = 21010902, pos = { x = 8.566, y = 0.046, z = -9.780 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8007, monster_id = 21010902, pos = { x = 15.879, y = 0.046, z = -9.652 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8008, monster_id = 21010902, pos = { x = -15.900, y = 0.046, z = -9.780 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8014, monster_id = 21010902, pos = { x = -8.587, y = 0.046, z = -9.652 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_8010(context, evt)
	...
	-- 从233706005的变量TPL_TIME中取出对应值并开启挑战
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 233706008, 9, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function action_EVENT_CHALLENGE_SUCCESS_8012(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 233706005) then
...
function action_EVENT_CHALLENGE_FAIL_8013(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 233706008, suite = 1 }) then
