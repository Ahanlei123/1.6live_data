...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 21020301, pos = { x = -0.009, y = 0.034, z = -11.636 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4002, monster_id = 21020101, pos = { x = 0.141, y = 0.034, z = 12.087 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 4003, monster_id = 22010102, pos = { x = 12.290, y = 0.034, z = -0.024 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, affix = { 1028 } },
	{ config_id = 4005, monster_id = 21020301, pos = { x = -14.446, y = 0.034, z = -0.049 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 }
}
...
function condition_EVENT_ANY_MONSTER_DIE_4004(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 232104004) ~= 0 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_4004(context, evt)
	-- 添加suite2的新内容
	    ScriptLib.AddExtraGroupSuite(context, 232104004, 2)
...
function action_EVENT_ANY_MONSTER_LIVE_4010(context, evt)
	...
	-- 从232104001的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 232104001)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 232104004, 4, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function action_EVENT_CHALLENGE_SUCCESS_4011(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 232104001) then
...
function action_EVENT_CHALLENGE_FAIL_4012(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 232104004, suite = 1 }) then
