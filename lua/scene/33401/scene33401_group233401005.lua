...
-- 装置
gadgets = {
	{ config_id = 5001, gadget_id = 70350053, pos = { x = 0.612, y = 0.234, z = -0.286 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 5002, gadget_id = 70350054, pos = { x = 0.660, y = 0.219, z = -0.264 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
