...
monsters = {
	...
	{ config_id = 3, monster_id = 24010101, pos = { x = -61.278, y = -32.312, z = 72.983 }, rot = { x = 0.000, y = 92.700, z = 0.000 }, level = 1, pose_id = 101 },
...
function action_EVENT_ANY_MONSTER_DIE_13(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 220027012, suite = 2 }) then
