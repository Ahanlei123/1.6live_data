...
-- DEFS_MISCS
trap_group={242014038}

tide_group_defs ={
        [1] = {group = 242014033, delay = 30, next_group = 2, buff = {1,2,3},guide_routes={1,2},enter={31001,31003},exit={31002},enter_id={1,2},exit_id={3}},
        [2] = {group = 242014034, delay = 30, next_group = 3, buff = {1,2,3},guide_routes={1,2},enter={31001,31003},exit={31002},enter_id={1,2},exit_id={3}},
        [3] = {group = 242014035, delay = 30, next_group = 0, buff = {1,2,3},guide_routes={1,2},enter={31001,31003},exit={31002},enter_id={1,2},exit_id={3}},
}
