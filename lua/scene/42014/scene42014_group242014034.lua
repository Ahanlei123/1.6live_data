...
-- DEFS_MISCS
package_tide_defs={       [1]={{monster_package={12003},route=1,route_points={1,2,4,5,9,10,13,14,17,18,21,22,25,26,29,30,33,34,35,36},tags=2,count=8,max=5,min=5},{monster_package={12003},route=2,route_points={1,2,4,5,9,10,13,14,17,18,21,22,25,26,29,30,33,34,35,36},tags=4,count=8,max=5,min=5}},   
}
