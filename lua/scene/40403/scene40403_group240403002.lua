...
-- 装置
gadgets = {
	{ config_id = 5, gadget_id = 70360010, pos = { x = 0.000, y = 0.100, z = 0.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, state = GadgetState.GearStop }
}
...
function action_EVENT_SELECT_OPTION_2(context, evt)
	...
	if 0 ~= ScriptLib.AutoMonsterTide(context, 1, 240403001, {1001,1002,1004,1005,1006,1009,1010,1011}, 8, 3, 3) then
		return -1
	end
	
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 240403008, suite = 2 }) then
