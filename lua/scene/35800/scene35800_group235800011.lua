...
-- 区域
regions = {
	[11006] = { config_id = 11006, shape = RegionShape.CUBIC, size = { x = 180.000, y = 80.000, z = 50.000 }, pos = { x = 530.448, y = 37.254, z = 23.850 }, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE },
...
-- 变量
variables = {
	{ name = "BubbleNum", value = 11, no_refresh = false },
	{ name = "BubbleRefresh", value = 0, no_refresh = false },
	{ name = "BubbleFlowerCount", value = 0, no_refresh = false }
}
