...
-- 区域
regions = {
	[10004] = { config_id = 10004, shape = RegionShape.CUBIC, size = { x = 180.000, y = 80.000, z = 50.000 }, pos = { x = 530.448, y = 37.254, z = -22.331 }, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE },
...
-- 变量
variables = {
	{ name = "BubbleNum", value = 1, no_refresh = false },
