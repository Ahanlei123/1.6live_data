...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 21010301, pos = { x = 6.223, y = 0.053, z = -5.071 }, rot = { x = 0.000, y = 346.531, z = 0.000 }, level = 1 },
	{ config_id = 3002, monster_id = 21010301, pos = { x = -7.052, y = 0.053, z = -5.084 }, rot = { x = 0.000, y = 21.465, z = 0.000 }, level = 1, affix = { 1031 } },
	{ config_id = 3003, monster_id = 21010901, pos = { x = 7.386, y = 0.053, z = -11.847 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 3004, monster_id = 21010901, pos = { x = -6.030, y = 0.053, z = -11.915 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 3005, monster_id = 21010901, pos = { x = 11.872, y = 0.053, z = -8.494 }, rot = { x = 0.000, y = 316.967, z = 0.000 }, level = 1, affix = { 1031 } },
	{ config_id = 3010, monster_id = 21010901, pos = { x = -9.743, y = 0.053, z = -8.494 }, rot = { x = 0.000, y = 22.810, z = 0.000 }, level = 1 },
	{ config_id = 3011, monster_id = 20010904, pos = { x = 0.156, y = 0.053, z = -12.165 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 6101 } },
	...
	{ config_id = 3013, monster_id = 21010902, pos = { x = -13.811, y = 0.053, z = -11.246 }, rot = { x = 0.000, y = 45.697, z = 0.000 }, level = 1, affix = { 1031 } },
	{ config_id = 3018, monster_id = 21020101, pos = { x = -2.292, y = 0.053, z = -9.895 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3019, monster_id = 21010902, pos = { x = 12.330, y = 0.053, z = -0.031 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 3020, monster_id = 21010902, pos = { x = -12.046, y = 0.053, z = -0.002 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, affix = { 1031 }, pose_id = 32 },
	{ config_id = 3022, monster_id = 22010204, pos = { x = -7.494, y = 0.053, z = 7.581 }, rot = { x = 0.000, y = 146.572, z = 0.000 }, level = 1, affix = { 1031 } },
...
function action_EVENT_ANY_MONSTER_LIVE_3007(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 188, 231502003, 30, 3024, 0) then
...
function action_EVENT_CHALLENGE_SUCCESS_3008(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 1, 231502001) then
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231502002, 2001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 231502002, 2001, {176}) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_wok_options_by_configid")
		return -1
	end
	
	-- 改变指定group组231502001中， configid为1001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231502001, 1001, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 改变指定group组231502002中， configid为2002的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231502002, 2002, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 改变指定group组231502009中， configid为9001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231502009, 9001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 改变指定group组231502009中， configid为9002的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231502009, 9002, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
...
function action_EVENT_CHALLENGE_FAIL_3009(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 231502003, suite = 1 }) then
	...
	-- 改变指定group组231502002中， configid为2001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231502002, 2001, GadgetState.GearAction2) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
...
function condition_EVENT_ANY_MONSTER_DIE_3014(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 231502003) ~= 0 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_3014(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 231502003, 3)
...
function action_EVENT_ANY_MONSTER_LIVE_3015(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 2, 188, 231502003, 8, 3024, 0) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge")
		return -1
	end
...
function action_EVENT_CHALLENGE_SUCCESS_3016(context, evt)
	-- 改变指定group组231502002中， configid为2001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231502002, 2001, GadgetState.GearAction1) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 将本组内变量名为 "stage" 的变量设置为 2
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 231502001) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
...
function action_EVENT_ANY_MONSTER_DIE_3021(context, evt)
	-- 添加suite4的新内容
	    ScriptLib.AddExtraGroupSuite(context, 231502003, 4)
