...
triggers = {
	...
	{ config_id = 1001012, name = "DUNGEON_SETTLE_1012", event = EventType.EVENT_DUNGEON_SETTLE, source = "", condition = "condition_EVENT_DUNGEON_SETTLE_1012", action = "action_EVENT_DUNGEON_SETTLE_1012" },
	{ config_id = 1001014, name = "GADGET_STATE_CHANGE_1014", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_1014", action = "action_EVENT_GADGET_STATE_CHANGE_1014" }
}
