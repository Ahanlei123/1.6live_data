...
-- 装置
gadgets = {
	{ config_id = 6001, gadget_id = 70350110, pos = { x = 94.868, y = 2.986, z = -40.740 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 6002, gadget_id = 70350110, pos = { x = 95.087, y = 2.996, z = -62.704 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
