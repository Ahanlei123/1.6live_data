...
-- 装置
gadgets = {
	{ config_id = 23001, gadget_id = 70211031, pos = { x = 131.265, y = -92.292, z = -201.193 }, rot = { x = 0.000, y = 269.604, z = 0.000 }, level = 26, drop_tag = "战斗超级蒙德", showcutscene = true, isOneoff = true, persistent = true }
}
