...
function action_EVENT_TIMER_EVENT_52(context, evt)
	...
	-- 改变指定group组220028019中， configid为115的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 220028019, 115, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 改变指定group组220028019中， configid为116的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 220028019, 116, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 改变指定group组220028019中， configid为118的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 220028019, 118, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
