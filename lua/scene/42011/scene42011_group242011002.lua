...
points = {
	...
	{ config_id = 2030, pos = { x = 90.099, y = -6.181, z = -12.658 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 2031, pos = { x = 85.105, y = -6.189, z = -17.793 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 2032, pos = { x = 87.606, y = -6.184, z = -15.283 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 2033, pos = { x = 85.105, y = -6.189, z = -12.767 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
