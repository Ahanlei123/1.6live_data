...
-- DEFS_MISCS
trap_group={242011013}

tide_group_defs ={
        [1] = {group = 242011003, delay = 30, next_group = 2, buff = {1,2,3},guide_routes={3,4},enter={1003,1005},exit={1002,1004},enter_id={19,20},exit_id={21,22}},
        [2] = {group = 242011004, delay = 30, next_group = 3, buff = {1,2,3},guide_routes={1,2,3,4},enter={1001,1003,1005},exit={1002,1004},enter_id={18,19,20},exit_id={21,22}},
        [3] = {group = 242011005, delay = 30, next_group = 4, buff = {1,2,3},guide_routes={1,2,3,4},enter={1001,1003,1005},exit={1002,1004},enter_id={18,19,20},exit_id={21,22}},
        [4] = {group = 242011006, delay = 30, next_group = 5, buff = {1,2,3},guide_routes={1,2,3,4},enter={1001,1003,1005},exit={1002,1004},enter_id={18,19,20},exit_id={21,22}},
        [5] = {group = 242011007, delay = 30, next_group = 6, buff = {1,2,3},guide_routes={1,2,3,4},enter={1001,1003,1005},exit={1002,1004},enter_id={18,19,20},exit_id={21,22}},
        [6] = {group = 242011008, delay = 30, next_group = 0, buff = {1,2,3},guide_routes={1,2,3,4},enter={1001,1003,1005},exit={1002,1004},enter_id={18,19,20},exit_id={21,22}},
}
...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 1041, 1042, 1043, 1044, 1045, 1046 },
		regions = { },
		triggers = { },
		rand_weight = 100
	}
