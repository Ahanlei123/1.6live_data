...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 20011001, pos = { x = 2.646, y = 0.034, z = -9.731 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3002, monster_id = 20011001, pos = { x = -2.315, y = 0.034, z = -9.713 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3003, monster_id = 20011001, pos = { x = 0.166, y = 0.034, z = -9.709 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3004, monster_id = 21010201, pos = { x = 5.016, y = 0.034, z = 14.463 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3005, monster_id = 21030103, pos = { x = 0.161, y = 0.034, z = 16.876 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3006, monster_id = 20011101, pos = { x = -2.285, y = 0.034, z = -12.146 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3007, monster_id = 20011101, pos = { x = 2.610, y = 0.034, z = -12.137 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3008, monster_id = 21030303, pos = { x = 0.154, y = 0.034, z = -12.122 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3012, monster_id = 22010301, pos = { x = 0.171, y = 0.034, z = -14.610 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3016, monster_id = 20011501, pos = { x = -0.018, y = 0.034, z = -12.808 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3017, monster_id = 20011401, pos = { x = -13.189, y = 0.034, z = -6.402 }, rot = { x = 0.000, y = 60.720, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3018, monster_id = 20011401, pos = { x = 10.920, y = 0.034, z = -6.421 }, rot = { x = 0.000, y = 299.700, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3019, monster_id = 20011001, pos = { x = -8.660, y = 0.034, z = 11.112 }, rot = { x = 0.000, y = 133.400, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3020, monster_id = 20011001, pos = { x = 0.152, y = 0.034, z = 14.563 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3027, monster_id = 21010201, pos = { x = -4.744, y = 0.034, z = 14.481 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, drop_id = 11010210 },
	{ config_id = 3029, monster_id = 20011001, pos = { x = 8.676, y = 0.034, z = 10.765 }, rot = { x = 0.000, y = 214.351, z = 0.000 }, level = 1, drop_id = 11010210 }
}
...
function condition_EVENT_ANY_MONSTER_DIE_3022(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 241002003) ~= 0 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_3022(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 241002002, suite = 1 }) then
...
function action_EVENT_ANY_MONSTER_LIVE_3031(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 1, 241002003, 9, 0, 0) then
...
function action_EVENT_ANY_MONSTER_DIE_3032(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 241002003, 3)
...
function action_EVENT_CHALLENGE_SUCCESS_3035(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 1, 241002001) then
...
function action_EVENT_CHALLENGE_FAIL_3036(context, evt)
		...
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 241002003, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
			return -1
		end
...
function condition_EVENT_ANY_MONSTER_DIE_3037(context, evt)
	...
	-- 判断变量"stage"为1
	if ScriptLib.GetGroupVariableValueByGroup(context, "stage", 241002001) ~= 1 then
			return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_3037(context, evt)
	-- 添加suite6的新内容
	    ScriptLib.AddExtraGroupSuite(context, 241002003, 6)
