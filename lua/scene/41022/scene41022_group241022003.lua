...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 20011101, pos = { x = 5.272, y = 0.018, z = -10.156 }, rot = { x = 0.000, y = 345.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true },
	{ config_id = 3002, monster_id = 20011101, pos = { x = -5.415, y = 0.009, z = -10.129 }, rot = { x = 0.000, y = 15.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true },
	{ config_id = 3003, monster_id = 21010501, pos = { x = 1.886, y = 0.026, z = -10.693 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true },
	{ config_id = 3004, monster_id = 21010901, pos = { x = -3.823, y = 0.036, z = -12.922 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true },
	{ config_id = 3005, monster_id = 21011001, pos = { x = 0.127, y = 0.024, z = -13.268 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true },
	{ config_id = 3007, monster_id = 20010901, pos = { x = 4.060, y = 0.030, z = -12.855 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true },
	{ config_id = 3008, monster_id = 22010201, pos = { x = 0.149, y = 0.029, z = -14.747 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true },
	{ config_id = 3009, monster_id = 21010501, pos = { x = -1.764, y = 0.027, z = -10.701 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true },
	{ config_id = 3011, monster_id = 21011201, pos = { x = 3.503, y = 0.027, z = -14.549 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true },
	{ config_id = 3012, monster_id = 21010201, pos = { x = -3.456, y = 0.028, z = -14.455 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true }
}
...
function condition_EVENT_ANY_MONSTER_DIE_3006(context, evt)
	...
	-- 判断变量"stage"为1
	if ScriptLib.GetGroupVariableValueByGroup(context, "stage", 241022001) ~= 1 then
			return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_3006(context, evt)
	...
	if 0 ~= ScriptLib.AutoMonsterTide(context, 1, 241022003, {3008,3011,3012}, 3, 3, 3) then
		return -1
	end
...
function action_EVENT_ANY_MONSTER_DIE_3010(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 241022003, 3)
...
function condition_EVENT_ANY_MONSTER_DIE_3013(context, evt)
	...
	-- 判断变量"stage"为0
	if ScriptLib.GetGroupVariableValueByGroup(context, "stage", 241022001) ~= 0 then
			return false
	end
...
function action_EVENT_ANY_MONSTER_LIVE_3022(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 1, 241022003, 10, 0, 0) then
...
function action_EVENT_CHALLENGE_SUCCESS_3023(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 1, 241022001) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
	
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 241022002, suite = 1 }) then
...
function action_EVENT_CHALLENGE_FAIL_3024(context, evt)
		...
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 241022003, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
			return -1
		end
