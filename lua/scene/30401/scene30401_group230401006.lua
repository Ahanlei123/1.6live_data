...
monsters = {
	...
	{ config_id = 6006, monster_id = 21010201, pos = { x = -11.288, y = 0.034, z = -1.068 }, rot = { x = 0.000, y = 64.828, z = 0.000 }, level = 1 },
	{ config_id = 6007, monster_id = 21010201, pos = { x = 11.790, y = 0.034, z = -0.770 }, rot = { x = 0.000, y = 270.084, z = 0.000 }, level = 1 },
	{ config_id = 6008, monster_id = 21010902, pos = { x = 1.379, y = 0.034, z = 9.915 }, rot = { x = 0.000, y = 182.789, z = 0.000 }, level = 1 },
	...
	{ config_id = 6014, monster_id = 21010201, pos = { x = -12.984, y = 0.034, z = -5.133 }, rot = { x = 0.000, y = 50.168, z = 0.000 }, level = 1 },
	...
	{ config_id = 6018, monster_id = 21010902, pos = { x = -8.116, y = 0.034, z = 6.371 }, rot = { x = 0.000, y = 133.400, z = 0.000 }, level = 1 },
	{ config_id = 6019, monster_id = 21010201, pos = { x = 4.993, y = 0.034, z = 9.240 }, rot = { x = 0.000, y = 203.110, z = 0.000 }, level = 1 },
	{ config_id = 6020, monster_id = 22010202, pos = { x = 0.126, y = 0.034, z = -7.935 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1029 } },
	{ config_id = 6021, monster_id = 20011001, pos = { x = -7.775, y = 0.034, z = -6.634 }, rot = { x = 0.000, y = 43.800, z = 0.000 }, level = 1 },
	{ config_id = 6022, monster_id = 20011001, pos = { x = 7.186, y = 0.034, z = -6.009 }, rot = { x = 0.000, y = 320.900, z = 0.000 }, level = 1 },
	{ config_id = 6023, monster_id = 21020201, pos = { x = 8.289, y = 0.034, z = 5.964 }, rot = { x = 0.000, y = 230.800, z = 0.000 }, level = 1 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_6026(context, evt)
	-- 创建编号为1（该挑战的识别id),挑战内容为1031的区域挑战，具体参数填写方式，见DungeonChallengeData表中的注释，所有填写的值都必须是int类型
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 1031, 300, 230401006, 23, 0) then
...
function action_EVENT_CHALLENGE_SUCCESS_6027(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 230401004, 4002, GadgetState.GearStart) then
...
function action_EVENT_CHALLENGE_FAIL_6028(context, evt)
	-- 通知任务系统完成条件类型"LUA通知"，复杂参数为quest_param的进度+1
		ScriptLib.GoBackGroupSuite(context, 230401006)
