...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 21020501, pos = { x = -0.008, y = -0.110, z = -14.053 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4002, monster_id = 21030103, pos = { x = 2.037, y = -0.110, z = -16.031 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 6106 }, isElite = true },
	{ config_id = 4003, monster_id = 21030103, pos = { x = -2.028, y = -0.110, z = -16.067 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1026 }, isElite = true }
}
...
function action_EVENT_ANY_MONSTER_LIVE_4013(context, evt)
	...
	-- 从235702001的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 235702001)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 235702004, 3, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function action_EVENT_CHALLENGE_SUCCESS_4014(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 235702001) then
...
function action_EVENT_CHALLENGE_FAIL_4015(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 235702004, suite = 1 }) then
