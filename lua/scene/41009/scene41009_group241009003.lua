...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 20010701, pos = { x = 2.143, y = 0.013, z = -10.263 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3002, monster_id = 20010601, pos = { x = -1.933, y = 0.016, z = -10.235 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3003, monster_id = 20010501, pos = { x = 5.036, y = 0.015, z = -9.973 }, rot = { x = 0.000, y = 330.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3004, monster_id = 20010501, pos = { x = -5.133, y = 0.015, z = -10.072 }, rot = { x = 0.000, y = 30.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3005, monster_id = 20011001, pos = { x = 5.047, y = 0.015, z = -10.896 }, rot = { x = 0.000, y = 330.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3006, monster_id = 20011101, pos = { x = -2.684, y = 0.016, z = -11.858 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3007, monster_id = 20011101, pos = { x = 2.714, y = 0.013, z = -11.882 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3008, monster_id = 20011001, pos = { x = -5.424, y = 0.015, z = -11.112 }, rot = { x = 0.000, y = 30.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3009, monster_id = 20011001, pos = { x = 0.008, y = 0.017, z = -12.188 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3012, monster_id = 22010301, pos = { x = -0.115, y = 0.011, z = -13.780 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function condition_EVENT_ANY_MONSTER_DIE_3010(context, evt)
	...
	-- 判断变量"wave"为1
	if ScriptLib.GetGroupVariableValueByGroup(context, "wave", 241009002) ~= 1 then
			return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_3010(context, evt)
	...
	if 0 ~= ScriptLib.ChangeGroupVariableValueByGroup(context, "wave", 1, 241009002) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : change_GroupVariable_by_group")
	  return -1
	end
	
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 241009003, 3)
...
function condition_EVENT_ANY_MONSTER_DIE_3011(context, evt)
	-- 判断变量"wave"为2
	if ScriptLib.GetGroupVariableValueByGroup(context, "wave", 241009002) ~= 2 then
			return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_3011(context, evt)
	...
	if 0 ~= ScriptLib.AutoMonsterTide(context, 2, 241009003, {3012}, 1, 1, 1) then
		return -1
	end
...
function action_EVENT_ANY_MONSTER_LIVE_3022(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 1, 241009003, 10, 0, 0) then
...
function action_EVENT_CHALLENGE_SUCCESS_3023(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 1, 241009001) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
	
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 241009002, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
			return -1
		end
	
	-- 将本组内变量名为 "wave" 的变量设置为 0
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "wave", 0, 241009002) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
...
function action_EVENT_CHALLENGE_FAIL_3024(context, evt)
		...
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 241009003, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
			return -1
		end
...
function condition_EVENT_MONSTER_TIDE_DIE_3025(context, evt)
	...
	-- 判断变量"stage"为1
	if ScriptLib.GetGroupVariableValueByGroup(context, "stage", 241009001) ~= 1 then
			return false
	end
