...
-- 变量
variables = {
	{ name = "guihuo_1", value = 0, no_refresh = false },
	{ name = "Refresh1", value = 0, no_refresh = false },
	{ name = "Refresh2", value = 0, no_refresh = false },
	{ name = "Dead", value = 0, no_refresh = false }
}
...
suites = {
	{
		...
		triggers = { "ENTER_REGION_2002", "ANY_MONSTER_DIE_2013", "GADGET_STATE_CHANGE_2014", "QUEST_FINISH_2015", "GADGET_CREATE_2016", "ENTER_REGION_2019", "GADGET_STATE_CHANGE_2024", "GADGET_STATE_CHANGE_2025", "VARIABLE_CHANGE_2026", "GADGET_CREATE_2027", "GADGET_CREATE_2028", "TIMER_EVENT_2033", "GADGET_STATE_CHANGE_2034", "ENTER_REGION_2035", "GADGET_STATE_CHANGE_2046", "GADGET_STATE_CHANGE_2050" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_GADGET_CREATE_2016(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 201059002, 2010, {7}) then
