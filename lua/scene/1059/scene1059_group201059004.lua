...
-- 变量
variables = {
	{ name = "guihuo_2", value = 0, no_refresh = false },
	{ name = "loop0", value = 0, no_refresh = false },
	{ name = "loop1", value = 0, no_refresh = false },
	{ name = "loop2", value = 0, no_refresh = false },
	{ name = "loop3", value = 0, no_refresh = false },
	{ name = "Enterloop", value = 0, no_refresh = false },
	{ name = "revivetest", value = 0, no_refresh = false },
	{ name = "loop3_bool", value = 0, no_refresh = false }
}
