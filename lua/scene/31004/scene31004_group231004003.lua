...
monsters = {
	...
	{ config_id = 3002, monster_id = 21010402, pos = { x = 0.125, y = 0.034, z = 12.169 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 3009, monster_id = 22010203, pos = { x = -0.009, y = 0.034, z = -11.636 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3010, monster_id = 21010502, pos = { x = 0.153, y = 0.034, z = 9.687 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 3015, monster_id = 22010202, pos = { x = -0.009, y = 0.034, z = -11.636 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1029 } },
	{ config_id = 3016, monster_id = 21011002, pos = { x = 0.143, y = 0.034, z = 14.495 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, pose_id = 32 }
}
...
function action_EVENT_CHALLENGE_SUCCESS_3035(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231004005, 5001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 改变指定group组231004005中， configid为5002的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 231004005, 5002, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
