...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 23030101, pos = { x = -0.009, y = 0.034, z = -11.636 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1027, 6104 } },
	{ config_id = 4002, monster_id = 25010601, pos = { x = -7.095, y = 0.034, z = 12.103 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 4003, monster_id = 25030201, pos = { x = 12.290, y = 0.034, z = -0.024 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1 },
	{ config_id = 4005, monster_id = 25030201, pos = { x = -14.446, y = 0.034, z = -0.049 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	{ config_id = 4006, monster_id = 23020102, pos = { x = 0.147, y = 0.034, z = -14.605 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4008, monster_id = 25010601, pos = { x = 7.440, y = 0.034, z = 12.111 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_ANY_MONSTER_DIE_4004(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 231004004, 3)
...
function action_EVENT_ANY_MONSTER_LIVE_4010(context, evt)
	...
	-- 从231004001的变量TPL_TIME中取出对应值并开启挑战
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 231004004, 6, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
