...
-- 怪物
monsters = {
	{ config_id = 10001, monster_id = 20010501, pos = { x = -10.637, y = 0.198, z = -7.444 }, rot = { x = 0.000, y = 50.400, z = 0.000 }, level = 1, affix = { 1007, 1010 }, isElite = true },
	{ config_id = 10002, monster_id = 20010501, pos = { x = -6.737, y = 0.314, z = 8.556 }, rot = { x = 0.000, y = 112.800, z = 0.000 }, level = 1, affix = { 1007, 1010 }, isElite = true },
	{ config_id = 10003, monster_id = 20010601, pos = { x = 6.563, y = 0.314, z = -7.544 }, rot = { x = 0.000, y = 325.600, z = 0.000 }, level = 1, affix = { 1007, 1009 }, isElite = true },
	{ config_id = 10004, monster_id = 20010701, pos = { x = 7.763, y = 0.314, z = 6.756 }, rot = { x = 0.000, y = 213.700, z = 0.000 }, level = 1, affix = { 1007, 1009 }, isElite = true },
	{ config_id = 10005, monster_id = 20010501, pos = { x = -1.637, y = 0.314, z = -10.544 }, rot = { x = 0.000, y = 358.300, z = 0.000 }, level = 1, affix = { 1007, 1010 }, isElite = true },
	{ config_id = 10006, monster_id = 20010501, pos = { x = 0.463, y = 0.314, z = 8.856 }, rot = { x = 0.000, y = 153.600, z = 0.000 }, level = 1, affix = { 1007, 1010 }, isElite = true },
	{ config_id = 10007, monster_id = 20010501, pos = { x = 0.963, y = 0.314, z = -6.544 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1007, 1010 }, isElite = true },
	{ config_id = 10008, monster_id = 20010501, pos = { x = 5.863, y = 0.314, z = -2.744 }, rot = { x = 0.000, y = 297.000, z = 0.000 }, level = 1, affix = { 1007, 1010 }, isElite = true },
	{ config_id = 10009, monster_id = 20010701, pos = { x = 6.763, y = 0.314, z = 6.056 }, rot = { x = 0.000, y = 249.100, z = 0.000 }, level = 1, affix = { 1007 }, isElite = true },
	{ config_id = 10010, monster_id = 20010501, pos = { x = -5.537, y = 0.314, z = 2.756 }, rot = { x = 0.000, y = 95.700, z = 0.000 }, level = 1, affix = { 1007, 1010 }, isElite = true },
	{ config_id = 10011, monster_id = 20010501, pos = { x = 8.363, y = 0.314, z = 6.956 }, rot = { x = 0.000, y = 228.800, z = 0.000 }, level = 1, affix = { 1007, 1010 }, isElite = true },
	{ config_id = 10012, monster_id = 20010501, pos = { x = 10.163, y = 0.215, z = -3.144 }, rot = { x = 0.000, y = 299.800, z = 0.000 }, level = 1, affix = { 1007, 1010 }, isElite = true },
	{ config_id = 10013, monster_id = 20010501, pos = { x = -9.637, y = 0.014, z = 2.656 }, rot = { x = 0.000, y = 95.700, z = 0.000 }, level = 1, affix = { 1007, 1010 }, isElite = true },
	{ config_id = 10014, monster_id = 20010601, pos = { x = -1.937, y = 0.014, z = -7.444 }, rot = { x = 0.000, y = 325.600, z = 0.000 }, level = 1, affix = { 1007 }, isElite = true },
	{ config_id = 10015, monster_id = 20010701, pos = { x = -0.637, y = 0.014, z = 10.256 }, rot = { x = 0.000, y = 183.300, z = 0.000 }, level = 1, affix = { 1007 }, isElite = true },
	{ config_id = 10016, monster_id = 23030101, pos = { x = -0.437, y = 0.214, z = -9.444 }, rot = { x = 0.000, y = 4.100, z = 0.000 }, level = 1, affix = { 1007, 9002 }, isElite = true },
	{ config_id = 10017, monster_id = 21010901, pos = { x = 12.863, y = 0.014, z = -5.544 }, rot = { x = 0.000, y = 311.500, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 10018, monster_id = 21010901, pos = { x = -11.637, y = 0.014, z = -5.144 }, rot = { x = 0.000, y = 41.900, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 10019, monster_id = 21010901, pos = { x = 0.463, y = 0.014, z = 13.156 }, rot = { x = 0.000, y = 174.500, z = 0.000 }, level = 1, pose_id = 32 }
}
...
-- 装置
gadgets = {
	{ config_id = 10020, gadget_id = 70900205, pos = { x = 9.863, y = -1.302, z = -3.044 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_10021(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 160, 240406010, 19, 80, 10) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge")
		return -1
	end
	
	-- 删除指定group： 240406011 ；指定config：11001；物件身上指定option：7；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 240406011, 11001, 7) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : del_work_options_by_group_configId")
		return -1
	end
	
	-- 改变指定group组240406011中， configid为11001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 240406011, 11001, GadgetState.GearStop) then
...
function action_EVENT_CHALLENGE_SUCCESS_10027(context, evt)
	-- 改变指定group组240406015中， configid为15001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 240406015, 15001, GadgetState.GearStop) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
...
function action_EVENT_CHALLENGE_FAIL_10028(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 240406010, suite = 2 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
			return -1
		end
	
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 240406011, 11001, {7}) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_wok_options_by_configid")
		return -1
	end
	
	-- 改变指定group组240406011中， configid为11001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 240406011, 11001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
...
function condition_EVENT_ANY_MONSTER_DIE_10029(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 240406010) ~= 0 then
		return false
	end
