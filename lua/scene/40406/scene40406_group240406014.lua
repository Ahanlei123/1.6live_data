...
-- 区域
regions = {
	{ config_id = 14001, shape = RegionShape.SPHERE, radius = 5, pos = { x = -0.337, y = 0.319, z = 23.656 } },
	{ config_id = 14002, shape = RegionShape.SPHERE, radius = 5, pos = { x = 0.063, y = 0.319, z = 21.956 } }
}
...
function action_EVENT_ENTER_REGION_14002(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 240406015, 15001, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
