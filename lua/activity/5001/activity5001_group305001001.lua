...
-- 变量
variables = {
	{ name = "Water", value = 100, no_refresh = false },
	{ name = "Fire", value = 100, no_refresh = false },
	{ name = "Electric", value = 100, no_refresh = false },
	{ name = "Ice", value = 100, no_refresh = false },
	{ name = "Wind", value = 0, no_refresh = false },
	{ name = "Rock", value = 0, no_refresh = false },
	{ name = "Grass", value = 0, no_refresh = false },
	{ name = "timer_extra", value = 0, no_refresh = false },
	{ name = "timer_counter", value = 1, no_refresh = false },
	{ name = "stage_counter", value = 0, no_refresh = false },
	{ name = "elem_counter", value = 0, no_refresh = false },
	{ name = "stage_bonus_suite", value = 0, no_refresh = false }
}
