...
-- 装置
gadgets = {
	{ config_id = 112001, gadget_id = 70950020, pos = { x = 1359.299, y = 200.505, z = 186.060 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 15, persistent = true, area_id = 5 },
	{ config_id = 112002, gadget_id = 70950021, pos = { x = 1359.299, y = 200.505, z = 186.060 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 15, persistent = true, autopick = true, area_id = 5 }
}
...
-- 触发器
triggers = {
	{ config_id = 1112003, name = "SEAL_BATTLE_PROGRESS_DECREASE_112003", event = EventType.EVENT_SEAL_BATTLE_PROGRESS_DECREASE, source = "", condition = "condition_EVENT_SEAL_BATTLE_PROGRESS_DECREASE_112003", action = "action_EVENT_SEAL_BATTLE_PROGRESS_DECREASE_112003", trigger_count = 0 },
	{ config_id = 1112004, name = "SEAL_BATTLE_END_112004", event = EventType.EVENT_SEAL_BATTLE_END, source = "", condition = "condition_EVENT_SEAL_BATTLE_END_112004", action = "action_EVENT_SEAL_BATTLE_END_112004", trigger_count = 0 },
	{ config_id = 1112005, name = "SELECT_DIFFICULTY_112005", event = EventType.EVENT_SELECT_DIFFICULTY, source = "", condition = "condition_EVENT_SELECT_DIFFICULTY_112005", action = "action_EVENT_SELECT_DIFFICULTY_112005", trigger_count = 0 },
	{ config_id = 1112006, name = "GENERAL_REWARD_DIE_112006", event = EventType.EVENT_GENERAL_REWARD_DIE, source = "", condition = "condition_EVENT_GENERAL_REWARD_DIE_112006", action = "action_EVENT_GENERAL_REWARD_DIE_112006" }
}
...
suites = {
	{
		...
		gadgets = { 112001 },
		regions = { },
		triggers = { "SEAL_BATTLE_PROGRESS_DECREASE_112003", "SEAL_BATTLE_END_112004", "SELECT_DIFFICULTY_112005", "GENERAL_REWARD_DIE_112006" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_SEAL_BATTLE_PROGRESS_DECREASE_112003(context, evt)
	-- 判断变量"isShow"为0
...
-- 触发操作
function action_EVENT_SEAL_BATTLE_PROGRESS_DECREASE_112003(context, evt)
...
-- 触发条件
function condition_EVENT_SEAL_BATTLE_END_112004(context, evt)
...
-- 触发操作
function action_EVENT_SEAL_BATTLE_END_112004(context, evt)
...
-- 触发条件
function condition_EVENT_SELECT_DIFFICULTY_112005(context, evt)
	if 112001 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_SELECT_DIFFICULTY_112005(context, evt)
...
-- 触发条件
function condition_EVENT_GENERAL_REWARD_DIE_112006(context, evt)
...
-- 触发操作
function action_EVENT_GENERAL_REWARD_DIE_112006(context, evt)
