...
-- 怪物
monsters = {
	{ config_id = 33, monster_id = 21010201, pos = { x = 1.713, y = 0.072, z = 0.095 }, rot = { x = 0.000, y = 214.664, z = 0.000 }, level = 1, drop_tag = "丘丘人", disableWander = true, pose_id = 9010, area_id = 1 },
	{ config_id = 34, monster_id = 21010201, pos = { x = 2.725, y = 0.139, z = 1.447 }, rot = { x = 0.000, y = 214.664, z = 0.000 }, level = 1, drop_tag = "丘丘人", disableWander = true, pose_id = 9003, area_id = 1 },
	...
	{ config_id = 6003, monster_id = 21020101, pos = { x = 1.832, y = 0.057, z = 3.719 }, rot = { x = 0.000, y = 217.247, z = 0.000 }, level = 1, drop_tag = "丘丘暴徒", disableWander = true, pose_id = 401, area_id = 1 }
}
...
-- 装置
gadgets = {
	{ config_id = 7, gadget_id = 70300089, pos = { x = 0.659, y = -0.139, z = -1.270 }, rot = { x = 0.000, y = 305.453, z = 0.000 }, level = 1, area_id = 1 },
	{ config_id = 8, gadget_id = 70300089, pos = { x = -1.090, y = -0.074, z = 0.187 }, rot = { x = 0.000, y = 305.453, z = 0.000 }, level = 1, area_id = 1 }
}

-- 区域
regions = {
	{ config_id = 26, shape = RegionShape.SPHERE, radius = 50, pos = { x = 0.057, y = 0.003, z = 0.089 }, area_id = 1 }
}
