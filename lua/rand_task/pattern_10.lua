...
-- 怪物
monsters = {
	{ config_id = 10001, monster_id = 21011201, pos = { x = 1.713, y = 0.199, z = 0.095 }, rot = { x = 0.000, y = 10.589, z = 0.000 }, level = 1, drop_tag = "丘丘人", disableWander = true, pose_id = 9003, area_id = 1 },
	{ config_id = 10002, monster_id = 21011201, pos = { x = 2.725, y = 0.474, z = 1.447 }, rot = { x = 0.000, y = 214.664, z = 0.000 }, level = 1, drop_tag = "丘丘人", disableWander = true, pose_id = 9003, area_id = 1 },
	{ config_id = 10003, monster_id = 21011201, pos = { x = -0.520, y = 0.212, z = 1.317 }, rot = { x = 0.000, y = 47.095, z = 0.000 }, level = 1, drop_tag = "丘丘人", disableWander = true, pose_id = 9003, area_id = 1 },
	...
	{ config_id = 10005, monster_id = 21020301, pos = { x = 0.263, y = 0.525, z = 3.626 }, rot = { x = 0.000, y = 170.966, z = 0.000 }, level = 1, drop_tag = "丘丘暴徒", disableWander = true, pose_id = 401, area_id = 1 },
