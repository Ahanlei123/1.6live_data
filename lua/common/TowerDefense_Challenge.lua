...
function LF_Init_Challenge_Group()
	...
	table.insert(variables, { name = "wave_ptr", value = 0})
	table.insert(variables, { name = "special_challenge", value = 0})
	table.insert(variables, { name = "left_monsters", value = 0})
	table.insert(variables, { name = "max_escapable_monsters", value = 10})
	table.insert(variables, { name = "escaped_monsters", value = 0})
	table.insert(variables, { name = "route_guide_points_index", value = 1,no_refresh = true})
	--怪物对地脉镇石造成额外伤害
	table.insert(variables, { name = "monster_double_damage", value = 0})
	--挑战逃出的怪物不超过一个
	table.insert(variables, { name = "challenge_8", value = 0})
	table.insert(variables, { name = "challenge_10", value = 0})
	table.insert(variables, { name = "challenge_11", value = 0})
	table.insert(variables, { name = "GM_Ignore_Monster_Escape", value = 0})
	table.insert(variables, { name = "challenge_65", value = 0})
	table.insert(variables, { name = "challenge_66", value = 0})
	table.insert(variables, { name = "challenge_67", value = 0})
	table.insert(variables, { name = "challenge_68", value = 0})
	table.insert(variables, { name = "challenge_69", value = 0})
	table.insert(variables, { name = "challenge_70", value = 0})
	table.insert(variables, { name = "challenge_71", value = 0})
	table.insert(variables, { name = "challenge_72", value = 0})
	table.insert(variables, { name = "challenge_73", value = 0})
	table.insert(variables, { name = "challenge_74", value = 0})
	table.insert(variables, { name = "challenge_75", value = 0})
	table.insert(variables, { name = "challenge_76", value = 0})
end
--------------------------------------
