...
function LF_Init_Monster_Group()
	...
	table.insert(variables, { name = "tide_ptr", value = 0})
	table.insert(variables, { name = "challenge_group", value = 0})
	...
	table.insert(variables, { name = "left_monsters", value = leftMonsters})
	table.insert(variables, { name = "monster_tide_index", value = 1})
	table.insert(variables, { name = "extra_monster_65", value = 0})
	table.insert(variables, { name = "extra_monster_66", value = 0})
	table.insert(variables, { name = "extra_monster_67", value = 0})
	table.insert(variables, { name = "extra_monster_68", value = 0})
	table.insert(variables, { name = "extra_monster_69", value = 0})
	table.insert(variables, { name = "extra_monster_70", value = 0})
	table.insert(variables, { name = "buff_monster_4112", value = 0})
	table.insert(variables, { name = "buff_monster_4113", value = 0})
	table.insert(variables, { name = "monster_kill_count", value = 0})
