...
local Var = {
	[1] = { name = "in_battle", value = 0, no_refresh = true },
	[2] = { name = "BombTypeA", value = 0, no_refresh = false },
	[3] = { name = "BombTypeB", value = 0, no_refresh = false },
	[4] = { name = "BombTypeC", value = 0, no_refresh = false },
	[5] = { name = "wave", value = 0, no_refresh = false }
}
