...
function LF_Initialize_Trap()
	table.insert(variables,{ name = "hasDiscount", value = 0 })
	table.insert(variables,{ name = "hasColdDownDiscount", value = 0 })
	...
	for i=1,#wind_field do
		table.insert(variables,{ name = tostring(wind_field[i].operator_id).."wind", value = 0 })
	...
	for i=1,#light_bridge do
		table.insert(variables,{ name = tostring(light_bridge[i].operator_id).."bridge", value = 0 })
