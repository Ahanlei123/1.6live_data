...
function LF_Initialize_Variable()
    local var = { name = "CurrentFloorArrayIndex", value = 1, no_refresh = true }
    variables[var.name] = var
    var = { name = "CurrentPhasePlayIndex", value = 1, no_refresh = true }
    variables[var.name] = var
    var = { name = "CurrentFlowerPathIndex", value = 1, no_refresh = true }
    variables[var.name] = var
    var = { name = "ArrayPathStep", value = 1, no_refresh = true }
    variables[var.name] = var
    var = { name = "GM_CheckConfigIDGadgetState", value = 0, no_refresh = true }
    variables[var.name] = var
